  ...
  <div class="cube-upload-file" @click="clickHandler">
    <slot>
      <div class="cube-upload-file-def" >
      	<img :src="file.url" style="width: 100%; height: 100%; position: absolute; left: 0;top: 0;object-fit: cover;" />
        <i class="cubeic-wrong iconfont icon-shanchu" @click.stop="removeFile"></i>
        <div class="cube-upload-file-state" :class="fileStatusCls">
          <i class="cube-upload-file-status iconfont icon-queren" :class="statusCls"></i>
