...
public class BillNOUtils {
	...
	@Bizlet("")
	public static Long getColumnValue(String entityName, String column) {
		...
		DataObject[] result = com.eos.foundation.database.DatabaseUtil
				.queryEntitiesByCriteriaEntity("saas", cond);
	...
	@Bizlet("")
	public static String getColumnMaxDateValue(String entityName, String maxColumn) {
	...
	@Bizlet("")
	public static String getColumnMaxStringValue(String entityName, String maxColumn, String column, String columnValue, Integer n) {
