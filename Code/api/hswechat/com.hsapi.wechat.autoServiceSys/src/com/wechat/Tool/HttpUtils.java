...
public class HttpUtils {
	...
	@Bizlet("")
	public static String sendPostDataObjectArray(String urlParam, Map params,int orgid) {
		String cardTimesList=DataObjectConvertUtil.convertDataObjectsToJsonString((DataObject[]) params.get("cardTimesList"));
		String itemList=DataObjectConvertUtil.convertDataObjectsToJsonString((DataObject[]) params.get("itemList"));
		String aa = "{\"cardTimesList\":"+cardTimesList+",\"itemList\":"+itemList+",\"orgid\":"+orgid+"}";
		return sendPostByJson(urlParam, aa);
	}
