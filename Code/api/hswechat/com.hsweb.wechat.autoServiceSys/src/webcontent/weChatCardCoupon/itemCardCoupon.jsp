...
<body>
		...
		<table style="width: 100%; ">						
			<tr>
				<td style="font-size: 12px;">
					...
					<a class="nui-button" id="deleteCoupon" onclick="deleteCoupon()" plain="true" ><span class="fa fa-remove fa-lg"></span>&nbsp;删除</a>
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="nui-fit" >
		<div id="cardCouponData" class="nui-datagrid" style="height:100%;" allowResize="true"
	        dataField="wxbCouponData" pageSize="12" onrowclick="rowclick" showPageInfo="true" allowCellSelect="false" multiSelect="false">
            <div property="columns">
            	...
            	<div field="distributePeopleNumber" headerAlign="center" align="center" width="65" renderer="onCouponNumber" >已派发优惠劵数量</div>
            	<div field="sharePeopleNumber" headerAlign="center" align="center" width="65" renderer="onCouponNumber" >分享领用优惠劵数量</div>
