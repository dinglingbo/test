...
<%	
		...
		String couponArrayString=request.getParameter("couponArrayString");
    	System.out.println("openid:"+getOpenid);
    	System.out.println("couponArrayString:"+couponArrayString);
...
<body>
	...
	<script type="text/javascript">
    	...
    	$(function(){
    		...
    		var couponArrayString="<%=couponArrayString %>";
    		//window.location.href="http://18u3m92012.imwork.net/couponUse?couponArrayString="+couponArrayString+"&openid="+openid;
    		window.location.href="http://tomato.harsonserver.com/app/test-chedaoWeixin/couponUse?couponArrayString="+couponArrayString+"&openid="+openid;
    	});
    </script>
</body>
</html>