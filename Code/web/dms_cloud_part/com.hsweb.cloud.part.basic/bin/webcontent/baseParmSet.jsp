...
<head>
    <title>自定义分类</title>
    <script src="<%=webPath + contextPath%>/basic/js/baseParamSet.js?v=1.0.17"></script>
    <style>
        ...
        <div style="width:100%; height:calc(100% - 2px);">
                <div style="float:left;height:100%;width:105px;overflow: scroll;" class="test-1">
                    ...
                    <div id="mainTabs" class="nui-tabs" name="mainTabs" activeIndex="0" style="height:100%;"
                        ...
                        <div title="销售类型定义" id="sellOrderTypeClass" name="sellOrderTypeClass" url=""></div>
                        <div title="厂牌定义" id="compBrandClass" name="compBrandClass" url=""></div>
                ...
                <div style="float:right;height:100%;width:calc(100% - 105px);">
                        <div class="nui-toolbar">
                                ...
                                <span id="explain" >(说明：辅助属性1代表销售类型返点率)</span>
                            </div>
                    <div class="nui-fit">
                            <div id="dgGrid" class="nui-datagrid" style="width:100%;height:100%;" dataField="data" sortMode="client"
                                ...
                                <div property="columns">
                                    ...
                                    <div field="property1" name="property1"allowSort="true" headerAlign="center" header="辅助属性1" visible="true">
                                        <input property="editor" class="nui-textbox" />
                                    </div>
                                    <div field="property2" name="property2"allowSort="true" headerAlign="center" header="辅助属性2" visible="true">
                                        <input property="editor" class="nui-textbox" />
                                    </div>
                                    <div field="property3" name="property3"allowSort="true" headerAlign="center" header="辅助属性3" visible="true">
                                        <input property="editor" class="nui-textbox" />
                                    </div>
