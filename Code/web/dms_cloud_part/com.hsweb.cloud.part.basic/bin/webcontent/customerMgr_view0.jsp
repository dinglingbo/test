...
<script src="<%=webPath + contextPath%>/basic/js/customerMgr.js?v=1.0.34"></script>
<style type="text/css">
.table-label {
	text-align: right;
	width: 70px;
    ...
    <table style="width:100%;">
        <tr>
            <td style="white-space:nowrap;">
                ...
                <label style="font-family:Verdana;">客户ID：</label>
                <input class="nui-textbox" width="50" id="id"/>
    ...
    <table style="width:100%;">
        <tr>
            <td style="width:100%;">
                ...
                <span class="separator"></span>
                <!-- <a class="nui-button" iconCls="" plain="true" onclick="syncRebateDeduct"><span class="fa fa-refresh fa-lg"></span>&nbsp;更新返利及提成数据</a> -->
            </td>
        </tr>
    </table>
</div>
    ...
    <div id="datagrid1" class="nui-datagrid" allowResize="true" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="财务信息" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="settTypeId" width="80" headerAlign="center">结算方式</div>
            ...
            <div header="其他信息" headerAlign="center">
                <div property="columns">
                    <div field="empName" width="80" headerAlign="center">负责员工 </div>
                    ...
                    <div field="id" width="100" headerAlign="center">客户ID</div>
