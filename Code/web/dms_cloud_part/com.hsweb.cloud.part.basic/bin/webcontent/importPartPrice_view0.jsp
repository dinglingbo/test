...
<script src="<%=webPath + contextPath%>/basic/js/importPartPrice.js?v=1.0.1"></script>
<style type="text/css">
/*.a-upload {
    padding: 4px 10px;
    height: 20px;
	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
	                ...
	                <a class="nui-button" plain="true" href="<%=request.getContextPath() %>/common/template/importPartPrice.xlsx"><span class="fa fa-arrow-down fa-lg"></span>下载模板</a>
