...
<script src="<%=webPath + contextPath%>/basic/js/importPart.js?v=1.0.7"></script>
<style type="text/css">
/*.a-upload {
    padding: 4px 10px;
    height: 20px;
	...
	<div class="nui-fit">
		<div id="mainGrid" class="nui-datagrid" dataField="data" url="" showPager="false"
			...
			<div property="columns">
				...
				<div field="品质" width="60px" summaryType="count" headerAlign="center" allowSort="true">
					*品质<input property="editor" class="nui-textbox"/></div>
                ...
                <div field="自定义分类" width="120px" headerAlign="center" allowSort="true">
                    自定义分类<input property="editor" class="nui-textbox"/></div>
                <div field="属性1" width="120px" headerAlign="center" allowSort="true">
                    属性1<input property="editor" class="nui-textbox"/></div>
                <div field="属性2" width="120px" headerAlign="center" allowSort="true">
                   属性2<input property="editor" class="nui-textbox"/></div>
