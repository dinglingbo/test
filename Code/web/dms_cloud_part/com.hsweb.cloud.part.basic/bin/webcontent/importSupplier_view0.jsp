...
<script src="<%=webPath + contextPath%>/basic/js/importSupplier.js?v=1.0.4"></script>
<style type="text/css">
/*.a-upload {
    padding: 4px 10px;
    height: 20px;
	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
					...
					<a class="nui-button" plain="true" href="<%=request.getContextPath() %>/common/template/importSupplier.xlsx"><span class="fa fa-arrow-down fa-lg"></span>下载模板</a>
				</td>
	        </tr>
	    </table>
	</div>
	<div class="nui-fit">
		<div id="mainGrid" class="nui-datagrid" dataField="data" url="" showPager="false"
			...
			<div property="columns">
                ...
                <div field="返点比例" width="60px" headerAlign="center" allowSort="true">
                    返点比例<input property="editor" class="nui-textbox"/></div>
                <div field="负责员工" width="60px" headerAlign="center" allowSort="true">
                    负责员工<input property="editor" class="nui-textbox"/></div>
			</div>
		</div>
	</div>
