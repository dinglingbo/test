...
<script src="<%=webPath + contextPath%>/basic/js/initQCRPBillImport.js?v=2.0.0"></script>
<style type="text/css">
/*.a-upload {
    padding: 4px 10px;
    height: 20px;
	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
	                ...
	                <a class="nui-button" plain="true" href="<%=request.getContextPath() %>/common/template/initQCRPBillImport.xlsx"><span class="fa fa-arrow-down fa-lg"></span>下载模板</a>
				</td>
	        </tr>
	    </table>
	</div>
		...
		<div id="mainGrid" class="nui-datagrid" dataField="data" url="" showPager="false"
			...
			<div property="columns">
				...
				<div field="应付" width="80px" headerAlign="center" allowSort="true">
					应付</div>
				<div field="备注" width="80px" headerAlign="center" allowSort="true">
					备注</div>
			</div>
		</div>
	</div>
