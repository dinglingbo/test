...
<head>
<title>期初应收应付</title>
<script src="<%=webPath + contextPath%>/basic/js/initQCRPBill.js?v=2.0.3"></script>
<style type="text/css">
.title {
  width: 60px;
  text-align: right;
            ...
            <div class="nui-fit">
                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="guestId" width="50" headerAlign="center" visible="false" header=""></div>
                        <div field="billDc" width="50" headerAlign="center" visible="false" header=""></div> -->
