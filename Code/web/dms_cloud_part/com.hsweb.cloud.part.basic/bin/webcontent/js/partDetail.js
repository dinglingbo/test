...
$(document).ready(function(v)
{
    ...
    var dictDefs ={"unit":"DDT20130703000016", "orgCarBrandId":"10444"};
    initDicts(dictDefs, function() {
    	getAllPartBrand(function(data)
	    {
	        ...
	        nui.get('partBrandId').setData(partBrandIdList);
...
function setData(data)
{
    ...
    if(data.orgBrandList){
    	nui.get("orgCarBrandId").setData(data.orgBrandList||[]);
    }
