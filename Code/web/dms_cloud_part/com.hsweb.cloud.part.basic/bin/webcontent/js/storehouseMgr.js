...
function onAddStoreDeptNode(){
    ...
    if(node){
	 ...
	 nui.open({
	        url: webPath+contextPath+"/com.hsweb.cloud.part.basic.storeKingDeptSet.flow?token=" + token,
	        title: "仓库部门设置",
	        ...
	        {
	        	var iframe = this.getIFrameEl();
				iframe.contentWindow.setData(cangStoreId);
	        },
	        ondestroy: function (action)
	        {
	        }
