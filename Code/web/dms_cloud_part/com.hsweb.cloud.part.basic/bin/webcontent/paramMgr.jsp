...
<head>
<title>参数设置</title>
    <script src="<%=webPath + contextPath%>/basic/js/paramMgr.js?v=1.1.2"></script>
	...
	<div id="basicInfoForm" class="form" contenteditable="false" >
        <table class="table" id="table1">
            ...
            <tr>
             ...
             <tr>
                <td class="tbtext">是否开启分级提成：</td>
                <td class="tbCtrl" >
                   <div id="isCommission" name="isCommission" 
                        class="nui-radiobuttonlist" value="" repeatItems="2" 
                        repeatDirection="" repeatLayout="table" 
                        textField="text" valueField="id" ></div>
                </td>
             ...
             <tr>
                <td class="tbtext">是否启用PC端访问控制：</td>
                <td class="tbCtrl" >
                   <div id="isLoginControl" name="isLoginControl" 
                        class="nui-radiobuttonlist" value="" repeatItems="2" 
                        repeatDirection="" repeatLayout="table" 
                        textField="text" valueField="id" ></div>
                </td>
