...
<script src="<%=webPath + contextPath%>/basic/js/partBrandMgr.js?v=1.2.2"></script>
...
<div class="nui-splitter"
    ...
    <div size="70%" showCollapseButton="false" style="border-right:0">
        <div class="nui-fit">
            <div class="nui-splitter"
                    id="splitter"
                    allowResize="false"
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td style="white-space:nowrap;">
                                    <label style="font-family:Verdana;">配件品质:</label>
