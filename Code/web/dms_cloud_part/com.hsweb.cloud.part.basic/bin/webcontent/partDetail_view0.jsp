...
<head>
<title>配件资料</title>
<script src="<%=webPath + contextPath%>/basic/js/partDetail.js?v=1.0.34"></script>
<style type="text/css">
.title {
	text-align: right;
...
<div class="nui-fit" id= "basicInfoForm"  style="width:100%;">
      ...
      <div class="vpanel_body vpanel_bodyww">
  			    ...
  			    <input class="nui-textbox" visible="false" name="name" id="name"/>
            ...
            <table class="tmargin">
            	<tr class="htr">
                    <td class=" right fwidtha required">厂牌:</td>
                    <td >
                ...
                <tr class="htr">  
                    <td class=" right fwidthb">属性1:</td>
                    <td ><input name="property1" class="nui-textbox" width="150px"/></td>
                    <td class=" right fwidthb">属性2:</td>
                    <td ><input name="property2" class="nui-textbox" width="150px"/></td>
                </tr>
				<tr class="htr">
