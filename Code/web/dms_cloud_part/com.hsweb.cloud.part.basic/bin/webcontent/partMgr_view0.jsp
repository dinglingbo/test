...
<head>
    <title>配件管理</title>
    <script src="<%=webPath + contextPath%>/basic/js/partMgr.js?v=1.0.78"></script>
    <style type="text/css">
    </style>
</head>
...
<body>
    ...
    <input class="nui-combobox" visible="false" id="applyCarBrandId" />
	...
	<!--                     <label style="font-family:Verdana;">编码：</label>
                        ...
                        <input id="orgCarBrandId" name="orgCarBrandId" class="nui-combobox width1" textField="name" valueField="customid" emptyText="请选择..."
                            url="" allowInput="true" showNullItem="false" nullItemText="请选择..." />
	                    <label style="font-family:Verdana;">品牌：</label>
                        <input id="partBrandId" name="partBrandId" class="nui-combobox width1" textField="name" valueField="id" emptyText="请选择..."
                            url="" allowInput="true" showNullItem="false" nullItemText="请选择..." />
                        <label style="font-family:Verdana;">配件ID：</label>
                        <input class="nui-textbox" id="partId-search" emptyText="输入查询条件" width="120" onenter="onSearch()" />
                                    ...
                                    <div property="columns">
                                        <div header="基础信息" headerAlign="center">
                                            <div property="columns">
                                                ...
                                                <div allowSort="true" field="orgCarBrandId" width="70" headerAlign="center">厂牌</div>
...
<!--                                                 <div allowSort="true" field="nameEn" width="120" headerAlign="center" allowSort="true">英文名称</div> -->
                                                ...
                                                <div allowSort="true" field="id" width="50" headerAlign="center">配件ID</div>
                                            </div>
                                        </div>
                                    </div>
<!--                                 </div> -->
