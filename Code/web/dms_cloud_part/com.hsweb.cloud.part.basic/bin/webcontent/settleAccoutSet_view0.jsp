...
<head>
    ...
    <script src="<%=webPath + contextPath%>/basic/js/settleAccountSet.js?v=2.0.4"></script>
    <style type="text/css">
    body {
        margin: 0;
        padding: 0;
...
<body>
    ...
    <div id="mainGrid" class="nui-treegrid" style="width:100%;height:100%;" dataField="settleAccount"  url="" 
        ...
        <div property="columns">
            ...
            <div field="name" name="name" width="80"  headeralign="center" >账户名称</div>
            <div field="kingDeptCode" name="kingDeptCode" width="80"  headeralign="center" >金蝶部门编码</div>
            <div field="kingDeptName" name="kingDeptName" width="80"  headeralign="center" >金蝶部门名称</div>
