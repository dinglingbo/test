...
<head>
<title>仓库定义</title>
<script src="<%=webPath + contextPath%>/basic/js/storehouseMgr.js?v=1.0.9"></script>
<style type="text/css">
.table-label {
	text-align: right;
}
...
<div class="nui-splitter"
    ...
    <div size="400" showCollapseButton="false">
            ...
            <table style="width:100%;">
                <tr>
                    <td style="white-space:nowrap;">
                        ...
                        <a class="nui-button" plain="true" iconCls="" onclick="onAddStoreDeptNode()"><span class="fa fa-cog fa-lg"></span>&nbsp;设置仓库部门</a>
                        <a class="nui-button" plain="true" id="sys" iconCls="" enabled="false" onclick="sysCang()"><span class="fa fa-refresh fa-lg"></span>&nbsp;同步仓先生</a>
                    </td>
                </tr>
            </table>
        </div>
