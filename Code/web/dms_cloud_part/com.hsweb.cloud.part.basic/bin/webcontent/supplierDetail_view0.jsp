...
<head>
<title>供应商资料</title>
<script src="<%=webPath + contextPath%>/basic/js/supplierDetail.js?v=1.1.26"></script>
<style type="text/css">
.title {
	text-align: right;
                  ...
                  <div class="vpanel_body vpanel_bodyww">
                      ...
                      <table class="tmargin">
                          ...
                          <tr class="htr">
                              ...
                              <td class=" right fwidthb required">手机/电话:</td>
                          ...
                          <tr class="htr">
                          	  <td class=" right fwidtha required">负责员工:</td>
                              <td colspan="3">
                              	<input id="empName" name="empName" class="nui-combobox" textField="name" valueField="name"     
                              	  dataField="" onvaluechanged="onSelected"
                                  url="" valueFromSelect="true" allowinput="true" width="100%"
                                  nullitemtext="选择员工..." emptytext="选择员工" shownullitem="true">
                              	<input id="empId" name="empId" visible="false" width="100%" class="nui-textbox" >
                              </td>
                          </tr>
                          <tr class="htr">
