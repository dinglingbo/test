...
<head>
<title>供应商管理</title>
<script src="<%=webPath + contextPath%>/basic/js/supplierMgr.js?v1.1.20"></script>
<style type="text/css">
.table-label {
	text-align: right;
}
...
<!--                 <label style="font-family:Verdana;">供应商全称：</label>
                ...
                <input id="supplierType"
                       ...
                       showNullItem="true"
                       nullItemText="请选择..."/>
                <label style="font-family:Verdana;">供应商ID：</label>
        ...
        <div property="columns">
            ...
            <div header="其他信息" headerAlign="center">
                <div property="columns">
                    ...
                    <div field="id" width="100" headerAlign="center">供应商ID</div>
