...
<script src="<%=webPath + sysDomain%>/common/nui/xlsx.core.min.js?v=1.0.0"></script>
<script src="<%=webPath + cloudPartDomain%>/basic/js/initPartStockImport.js?v=1.0.0"></script>
<style type="text/css">
/*.a-upload {
    padding: 4px 10px;
    height: 20px;
	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
	                ...
	                <a class="nui-button" iconCls="" plain="true" onclick="close()" id="auditBtn"><span class="fa fa-close fa-lg"></span>&nbsp;关闭</a>
				</td>
	        </tr>
	    </table>
	</div>
