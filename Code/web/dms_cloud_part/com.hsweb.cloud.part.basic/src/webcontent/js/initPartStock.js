...
function open(){
    nui.open({
        targetWindow: window,
        url: webPath + cloudPartDomain + "/com.hsweb.cloud.part.basic.initPartStockSelect.flow",
...
function importPart(){
    ...
    nui.open({
        targetWindow: window,
        url: webPath + cloudPartDomain + "/com.hsweb.cloud.part.basic.initPartStockImport.flow",
        title: "库存导入", 
        width: 930, 
        height: 560,
        allowDrag:true,
