...
var leftGridUrl = baseUrl+"com.hsapi.cloud.part.baseDataCrud.crud.queryPartBrandList.biz.ext";
var rightGridUrl = baseUrl+"com.hsapi.cloud.part.baseDataCrud.crud.queryPartBrandList.biz.ext";
var bottomeGridUrl = baseUrl+"com.hsapi.cloud.part.baseDataCrud.crud.queryOrgPartBrandList.biz.ext";
var leftGrid = null;
var rightGrid = null;
var splitter = null;
var bottomGrid = null;
...
//        if(quality.orgid != currOrgid)
    ...
    nui.open({
        // targetWindow: window,
        url: webPath + contextPath + "/com.hsweb.cloud.part.basic.partQualityDetail.flow?token=" + token,
...
var updateIsDisabledUrl = baseUrl+"com.hsapi.cloud.part.baseDataCrud.crud.savePartBrand.biz.ext";
...
function addLocalBrand()
{
    nui.open({
        // targetWindow: window,
        url: webPath + contextPath + "/com.hsweb.cloud.part.basic.partBrandOrgDetail.flow?token=" + token,
...
var saveLocalBrandUrl = baseUrl + "com.hsapi.cloud.part.baseDataCrud.crud.saveOrgPartBrand.biz.ext";
