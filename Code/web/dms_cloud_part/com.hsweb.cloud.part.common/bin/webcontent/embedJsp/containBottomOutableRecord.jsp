...
<head>
<title>采购记录</title>
<script src="<%=webPath + contextPath%>/common/js/embed/containBottomOutableRecord.js?v=2.0.1"></script>
<style type="text/css">
.title {
  width: 90px;
  text-align: right;
...
<div class="nui-fit">
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div allowSort="true" field="enterDate"width="120" headerAlign="center" header="入库日期" dateFormat="yyyy-MM-dd HH:mm"></div>
            ...
            <div allowSort="true" datatype="float" field="enterQty" summaryType="sum" width="60" headerAlign="center" header="入库数量"></div>
            <div allowSort="true" datatype="float" field="enterPrice" width="60" headerAlign="center" header="入库单价"></div>
            <div allowSort="true" datatype="float" field="enterAmt" summaryType="sum" width="60" headerAlign="center" header="入库金额"></div>
            <div allowSort="true" datatype="float" field="outableQty" summaryType="sum" width="60" headerAlign="center" header="可出库数量"></div>
            <div field="orderMan" width="60" headerAlign="center" header="入库员"></div>
            ...
            <div allowSort="true" field="auditDate" headerAlign="center"width="120" header="审核日期" dateFormat="yyyy-MM-dd HH:mm"></div>
        </div>
    </div>
</div>
