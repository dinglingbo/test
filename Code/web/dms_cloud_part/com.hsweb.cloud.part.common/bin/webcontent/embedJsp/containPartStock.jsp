        ...
        <div class="nui-fit">
            <div id="storeStockGrid" class="nui-datagrid" style="width:100%;height:100%;"
                ...
                <div property="columns">
                    ...
                    <div allowSort="true" datatype="float" field="setCostPrice" visible="false" summaryType="sum" width="60" headerAlign="center" header="成本单价"></div>
                ...
                <div property="columns">
                    ...
                    <div header="库存批次" headerAlign="left">
                        <div property="columns">
                            ...
                            <div field="setCostPrice" width="55px" visible="false" headerAlign="center" allowSort="true" header="成本单价"></div>
