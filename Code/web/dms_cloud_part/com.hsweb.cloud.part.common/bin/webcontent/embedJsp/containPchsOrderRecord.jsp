...
<div class="nui-fit">
    <div id="pchsOrderRecordGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div field="manualCode" align="left" width="180px" headerAlign="center" allowSort="true" header="订单号"></div>
            ...
            <div field="setCostPrice" width="55px" headerAlign="center" visible="false" allowSort="true" header="成本单价"></div>
            <div field="setCostAmt" width="55px" headerAlign="center" visible="false" allowSort="true" header="成本金额"></div>
            ...
            <div field="serviceId" align="left" width="180px" headerAlign="center" allowSort="true" header="采购单号"></div>
