...
<head>
<title>销售记录</title>
<script src="<%=webPath + contextPath%>/common/js/embed/containSellOrderRecord.js?v=1.0.39"></script>
<style type="text/css">
.title {
  width: 90px;
  text-align: right;
...
<div class="nui-fit">
	<div  class="nui-splitter" style="width:100%;height:100%;" style="border:0;" handlerSize="0">
        <div size="130px" showCollapseButton="false">
        	...
        	<br>
        	<input class="nui-checkbox"  id="nowGuest" trueValue="1" falseValue="0" text="连锁当前客户" value="" oncheckedchanged="nowGuestChange()"/>
        	<br>
   		...
   		<div showCollapseButton="false">
		    <div id="sellOrderRecordGrid" class="nui-datagrid" style="width:100%;height:100%;"
		        ...
		        <div property="columns">
		            ...
		            <div allowSort="true" field="manualCode" width="180" summaryType="count" headerAlign="center" header="订单号"></div>
		            <div field="guestShortName" width="180" headerAlign="center" header="客户"></div>
		            ...
		            <div field="orderPrice" width="65px" headerAlign="center" allowSort="true" header="销售单价"></div>
		            <div field="orderAmt" width="65px" headerAlign="center" allowSort="true" header="销售金额"></div>
		            <div field="showPrice" width="65px" headerAlign="center" allowSort="true" header="开单单价"></div>
		            <div field="showAmt" width="65px" headerAlign="center" allowSort="true" header="开单金额"></div>
		            <div allowSort="true" field="serviceId" width="180" summaryType="count" headerAlign="center" header="销售单号"></div>
		            <div field="billTypeId" align="left" width="65px" headerAlign="center" allowSort="true" header="票据类型"></div>
		            <div field="settleTypeId" align="left" width="65px" headerAlign="center" allowSort="true" header="结算方式"></div>
