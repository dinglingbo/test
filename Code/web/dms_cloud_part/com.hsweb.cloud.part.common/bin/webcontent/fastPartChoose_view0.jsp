...
<head>
<title>快速录入</title>
<script src="<%=webPath + contextPath%>/common/js/fastPartChoose.js?v=1.0.9"></script>
<style type="text/css">
.table-label {
	text-align: right;
}
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td style="width:100%;">
                                ...
                                <input id="orgCarBrandId" visible="false" class="nui-combobox" textField="name" valueField="customid" />
                            ...
                            <div class="nui-fit">
                                <div id="morePartGrid" class="nui-datagrid" style="width:100%;height:100%;"
                                    ...
                                    <div property="columns">
                						...
                						<div field="orgCarBrandId" name="orgCarBrandId" width="60" headerAlign="center" header="厂牌"></div>
                                        ...
                                        <div allowSort="true" datatype="float" field="setCostPrice" summaryType="sum" width="60" headerAlign="center" header="成本单价"></div>
                                        <div allowSort="true" datatype="float" field="expEnterPrice" summaryType="sum" width="60" headerAlign="center" header="人进单价"></div>
                                        <div allowSort="true" datatype="float" field="storeId" summaryType="sum" width="60" headerAlign="center" header="仓库"></div>
