...
<head>
<title>采购记录</title>
<script src="<%=webPath + contextPath%>/common/js/embed/containBottomPchsRecord.js?v=2.0.1"></script>
<style type="text/css">
.title {
  width: 90px;
  text-align: right;
...
<div class="nui-fit">
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div allowSort="true"width="150"  field="auditDate" headerAlign="center" header="审核日期" dateFormat="yyyy-MM-dd HH:mm"></div>
        </div>
    </div>
</div>
