...
<head>
<title>采购车/销售车</title>
<script src="<%=webPath + cloudPartDomain%>/common/js/embed/containOrderCart.js?v=1.0.0"></script>
<style type="text/css">
.table-label {
	text-align: right;
}
...
<div class="nui-fit">
        <div id="cartGrid" class="nui-datagrid" style="width:100%;height:100%;"
                ...
                <div property="columns">
                        ...
                        <div field="createDate" width="80" dateFormat="yyyy-MM-dd H:mm:ss" headerAlign="center" allowSort="true">创建日期</div>
                </div>
        </div>
</div>
