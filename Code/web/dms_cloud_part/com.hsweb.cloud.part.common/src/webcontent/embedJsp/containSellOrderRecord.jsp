...
<head>
<title>销售记录</title>
<script src="<%=webPath + cloudPartDomain%>/common/js/embed/containSellOrderRecord.js?v=1.0.2"></script>
<style type="text/css">
.title {
  width: 90px;
  text-align: right;
...
<div class="nui-fit">
    <div id="sellOrderRecordGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div field="auditDate" allowSort="true" dateFormat="yyyy-MM-dd H:mm:ss" width="120px" header="出库日期" format="yyyy-MM-dd H:mm:ss" headerAlign="center" allowSort="true"></div>
