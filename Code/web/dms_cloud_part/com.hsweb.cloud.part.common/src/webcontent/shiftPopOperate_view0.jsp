...
<script src="<%=webPath + cloudPartDomain%>/common/js/shiftPopOperate.js?v=1.0.2"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
...
<div id="basicInfoForm" class="form">
    ...
    <table style="width: 100%" id="list_table">
        ...
        <tr>
            ...
            <td>
                <input id="receiveStoreShelf" name="receiveStoreShelf" class="nui-textbox" selectOnFocus="true" enabled="true" width="100%"/>
            </td>
        </tr>
        <tr style="display:none">
            ...
            <td>
                <input id="price" name="price" class="nui-textbox width1" onvaluechanged="calc('price')" vtype="float" selectOnFocus="true" enabled="false" width="100%"/>
            </td>
            <td class="title required">
                <label>金额：</label>
            </td>
            <td>
                <input id="amt" name="amt" class="nui-textbox" onvaluechanged="calc('amt')" vtype="float" selectOnFocus="true" enabled="false" width="100%"/>
            </td>
        </tr>
    </table>
</div>
