...
<script src="<%=webPath + contextPath%>/purchase/js/getPartInfoImoprt.js?v=1.0.22"></script>
<style type="text/css">
/*.a-upload {
    padding: 4px 10px;
    height: 20px;
	...
	<div class="nui-fit">
		<div id="mainGrid" class="nui-datagrid" dataField="data" url="" showPager="false"
			...
			<div property="columns">
				...
				<div field="品质" width="80px" summaryType="count" headerAlign="center" allowSort="true">
					品质</div>
				<div field="品牌" width="80px" summaryType="count" headerAlign="center" allowSort="true">
					品牌</div>
				<div field="厂牌" width="80px" summaryType="count" headerAlign="center" allowSort="true">
					厂牌</div>
