...
<title>预销售单受理</title>
    ...
    <script src="<%=webPath + contextPath%>/purchase/js/guestOrder/storeGuestOrder.js?v=1.0.13"></script>
</head>
<body>
<div class="nui-fit">
        	...
        	<div class="nui-toolbar" style="padding:2px;border-bottom:0;">
			    <table style="width:100%;">
			        <tr>
			            <td style="white-space:nowrap;">
        			        ...
        			        <a class="nui-button" iconCls="" plain="true" onclick="del()" visible=""  id="auditBtn"><span class="fa fa-remove fa-lg""></span>&nbsp;作废</a>
			 ...
			 <div id="mainGrid" class="nui-datagrid" style="width:100%;height:90%;"
		        ...
		        <div property="columns">
		            ...
		            <div field="serviceId" width="140px" headerAlign="center" allowSort="true" header="预售单号"></div>
