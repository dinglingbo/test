...
var rightGridUrl = baseUrl+"com.hsapi.cloud.part.invoicing.query.queryPjPchsRtnMainDetailList.biz.ext";
        ...
        getDictItems(dictIdList,function(data)
        {
          ...
          //      nui.get("settType").setData(settTypeIdList);
                ...
                getAllPartBrand(function(data)
        	    {
        	        ...
        	        getResBtnAuth("cloudPchsRtnQuery_set",function(data) {
		            	if(data != null) {
...
function onExport(){
	...
	if(detail && detail.length > 0){
		//多级表头类型
		setInitExportData( detail,rightGrid.columns,"采购退货明细表");
		//单级表头类型 与上二选一
