...
var rightGridUrl = baseUrl+"com.hsapi.cloud.part.invoicing.expense.getExpenseByServiceId.biz.ext";
...
$(document).ready(function(v)
{
	...
	initDicts(dictDefs, function(){
		...
		settleTypeIdList = nui.get("settleTypeId").getData();
		
		list = [
            {id:206,code:"1405",name:"运费"},
            {id:213,code:"1405",name:"采购木箱费"},
            {id:340,code:"1405",name:"代理报关费"},
            {id:341,code:"1405",name:"采购费"}
        ];
...
function getInComeExpenses(callback) {
	/*
	 * 入库任务里显示运费（206）、采购木箱费（204）、代理报关费（208），采购费（209）
	 * */
...
var saveUrl = baseUrl
        + "com.hsapi.cloud.part.invoicing.expense.saveExpense.biz.ext";
function save(){
        ...
        ondestroy : function(action) {
            if (action == 'ok') {
                ...
                var newRow={
            			...
            			billServiceId : code,
            			billMainId :codeId,
            			billTypeId :orderTypeId,
            			billTypeCode :orderTypeId,
            			settleTypeId :"020502",
            			fullName: guestName
            		};
        		mainGrid.addRow(newRow);
