...
<head>
<title>业务单选择</title>
<script src="<%=webPath + contextPath%>/purchase/js/packOut/packCheckSelect.js?v=1.0.0"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
  ...
  <div class="nui-fit">
      <div id="notPackGrid" class="nui-datagrid" style="width:100%;height:100%;"
          ...
          <div property="columns">
              ...
              <div allowSort="true" summaryType="count" field="serviceId" width="150" summaryType="count" headerAlign="center" header="盘点单号"></div>
