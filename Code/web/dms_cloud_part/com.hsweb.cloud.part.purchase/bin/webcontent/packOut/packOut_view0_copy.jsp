...
<head>
<title>打包发货</title>
<script src="<%=webPath + contextPath%>/purchase/js/packOut/packOut.js?v=1.1.5"></script>
<style type="text/css">
.title {
  width: 75px;
  text-align: right;
          ...
          <div title="销售列表" class="nui-panel"
                ...
                <div id="leftGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="orderMan" width="60" allowSort="true" headerAlign="center" header="销售员"></div>
                        <div field="serviceId" allowSort="true" headerAlign="center" width="170" header="订单号"></div>
                                  ...
                                  <tr>
                                      ...
                                      <td colspan="3">
                                          <input id="guestId"
	                                             ...
	                                             placeholder="请选择客户"
	                                             selectOnFocus="true" />
	                                      <a class="nui-button" enabled="false" iconCls="" plain="false" onclick="selectSupplier('guestId')" id="selectSupplierBtn"><span class="fa fa-check fa-lg"></span></a>
...
<!--                                           <input id="btnEdit1" width="15%" class="mini-buttonedit"  onbuttonclick="selectLogisticsSupplier('logisticsGuestId')"/> -->
                                      ...
                                      <td colspan="1">
                                          <input class="nui-textbox" id="" name="packPayAmt" width="100%" vtype="range:0,15000" enabled="true">
                                      </td>
...
<!--                                           <input id="btnEdit1" width="17%" class="mini-buttonedit"  onbuttonclick="selectLogisticsSupplier('transitLogisticsId')"/> -->
                                      ...
                                      <td colspan="1">
                                          <input name="settleTypeId" 
                                           ...
                                           selectOnFocus="true"
                                           showNullItem="false"
                                           onvaluechanged="onSettleTypeValueChanged"
                                           width="100%"/>
                                      </td>
                                      <td class="title required">
                                          <label>总包数：</label>
