...
<head>
<title>物流订单查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/packOut/packQuery.js?v=1.0.34"></script>
...
<div id="exportDiv" style="display:none">  
    <table id="tableExcel" width="100%" border="0" cellspacing="0" cellpadding="0">  
        <tr>  																
            ...
            <td colspan="1" align="center">打包单号</td>
            <td colspan="1" align="center">物流单号</td>
            <td colspan="1" align="center">物流公司</td>
            <td colspan="1" align="center">客户名称</td>
            <td colspan="1" align="center">发货员</td>
            <td colspan="1" align="center">付款方式</td>
            <td colspan="1" align="center">结算方式</td>
            <td colspan="1" align="center">打包日期</td>
            <td colspan="1" align="center">总包数</td>
            <td colspan="1" align="center">运费</td>
            <td colspan="1" align="center">代收货款</td>
            <td colspan="1" align="center">保价声明</td>
            <td colspan="1" align="center">物流备注</td>
            <td colspan="1" align="center">创建人</td>
            <td colspan="1" align="center">创建日期</td>
            <td colspan="1" align="center">发货日期</td>
            <td colspan="1" align="center">修改人</td>
            <td colspan="1" align="center">修改日期</td>
            <td colspan="1" align="center">销售单号</td>
            <td colspan="1" align="center">业务员</td>
            <td colspan="1" align="center">审核日期</td>
            <td colspan="1" align="center">单据备注</td>
        </tr>
...
<!--                     <li iconCls="" onclick="quickSearch(7)" id="type11">上年</li> -->
                ...
                <input id="billServiceId" width="120px" emptyText="销售单号" class="nui-textbox"/>
				<input id="guestName" width="120px" emptyText="客户名称" class="nui-textbox"/>
				<input id="logisticsName" width="120px" emptyText="物流公司" class="nui-textbox"/>
				<input id="packMan" width="80px" emptyText="发货员" class="nui-textbox"/>
