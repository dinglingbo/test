...
<head>
<title>业务单选择</title>
<script src="<%=webPath + contextPath%>/purchase/js/packOut/packSellOrderSelect.js?v=1.0.6"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
      ...
      <table style="width:100%;">
          <tr>
              <td style="white-space:nowrap;">
                  ...
                  <input id="billServiceId" width="120px" emptyText="订单号" class="nui-textbox"/>
  ...
  <div id="editFormSellOutDetail" style="display:none;">
      <div id="innerSellOutGrid" class="nui-datagrid" style="width:100%;height:150px;"
          ...
          <div property="columns">
              ...
              <div allowSort="true" field="comUnit" width="40" headerAlign="center" header="单位"></div>
