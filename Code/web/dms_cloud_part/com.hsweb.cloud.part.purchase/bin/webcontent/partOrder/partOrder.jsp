...
<title>订单受理</title>
    ...
    <script src="<%=webPath + contextPath%>/purchase/js/partOrder/partOrder.js?v=1.0.3"></script>
</head>
<body>
<div class="nui-fit">
        	...
        	<div class="nui-toolbar" style="padding:2px;border-bottom:0;">
			        ...
			        <tr>
			            <td style="white-space:nowrap;">
			                ...
			                <input class="nui-combobox" id ="status" name="status" value="" allowInput="true" showNullItem="false" 
		            		 valueFromSelect="true" nullitemtext="请选择..." emptyText="选择受理状态" data="" width="100px" data="statusList" dataField="statusList"
        			        ...
        			        <a class="nui-button" iconCls="" plain="true" onclick="del()" visible=""  id="auditBtn"><span class="fa fa-remove fa-lg""></span>&nbsp;拒绝</a>
			 ...
			 <div id="mainGrid" class="nui-datagrid" style="width:100%;height:90%;"
		        ...
		        <div property="columns">
		            ...
		            <div field="orgid" width="120" headerAlign="center" header="客户"></div>
		            <div field="serviceId" width="120px" headerAlign="center" allowSort="true" header="采购订单号"></div>
		            <div field="acceptStatus" width="40px" headerAlign="center" allowSort="true" header="状态"></div>
		            <div field="storeId" width="55px" headerAlign="center" allowSort="true" header="仓库" visible="false"></div>
		            <div field="orderMan" width="50px" headerAlign="center" allowSort="true" header="业务员"></div>
		            <div field="orderQty" width="50px" headerAlign="center" allowSort="true" header="订单数量"></div>
		            <div field="orderAmt" width="50px" headerAlign="center" allowSort="true" header="订单金额"></div>
		            <div field="auditDate" width="100px" headerAlign="center" allowSort="true" header="提交日期"  dateFormat="yyyy-MM-dd HH:mm"></div>
		            <div field="remark" width="120px" headerAlign="center" allowSort="true" header="备注"></div>  
		            <div field="acceptCode" width="120px" headerAlign="center" allowSort="true" header="销售订单号"></div>
		            <div field="acceptMan" width="80px" headerAlign="center" allowSort="true" header="受理人"></div>
		            <div field="acceptDate" width="80px" headerAlign="center" allowSort="true" header="受理日期" dateFormat="yyyy-MM-dd HH:mm"></div><!-- 
