...
<head>
<title>采购入库查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/purchaseEnter/purchaseEnterQuery.js?v=2.0.22"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
    ...
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="" headerAlign="center">
                <div property="columns">
                	<div allowSort="true" field="manualCode" width="170" summaryType="count" headerAlign="center" header="订单号" allowSort="true" dataType="string"></div>
                    <div field="guestFullName" width="180" headerAlign="center" header="供应商" allowSort="true" dataType="string"></div>
                    ...
                    <div allowSort="true" field="orderType" width="80" headerAlign="center" header="订单类型" allowSort="true" dataType="string"></div>
            ...
            <div header="数量单价" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" datatype="float" name="enterPrice" field="enterPrice" visible="false" width="60" headerAlign="center" header="采购单价"></div>
                    <div allowSort="true" datatype="float" name="enterAmt" field="enterAmt" visible="false" summaryType="sum" width="60" headerAlign="center" header="采购金额"></div>
                    <div allowSort="true" datatype="float" name="outableQty" field="outableQty" summaryType="sum" width="60" headerAlign="center" header="可出库数量"></div>
            ...
            <div header="采购成本价信息" headerAlign="center">
                <div property="columns">
                    ...
                    <div field="expenseAmt" width="90" headerAlign="center" summaryType="sum" header="分摊费用金额"></div>
                </div>
            </div>
            ...
            <div header="其他" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="serviceId" width="170" summaryType="count" headerAlign="center" header="采购单号" allowSort="true" dataType="string"></div>
...
<div id="advancedSearchWin" class="nui-window"
     title="高级查询" style="width:416px;height:500px;"
     showModal="true"
     allowResize="false"
     allowDrag="false">
