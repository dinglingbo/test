...
<!--                     <li iconCls="" onclick="quickSearch(16)" id="type16">已关闭</li> -->
            ...
            <td style="width:100%;">
                ...
                <a class="nui-button" iconCls="" plain="true" onclick="delOrder()" id="delBtn" visible="true"><span class="fa fa-remove fa-lg"></span>&nbsp;删除</a>
                <span class="separator"></span>
                  ...
                  <div class="fieldset-body">
                      ...
                      <div id="basicInfoForm" class="form" contenteditable="false">
                       ...
                       <!--   <input class="nui-hidden" name="storeId" id="storeId"/>-->
                         ...
                         textField="name" valueField="orgid" visible="false" />
                          <table style="width: 100%;">
                              <tr>
...
<!--                                       <input id="btnEdit1" width="8.2%" class="mini-buttonedit"  onbuttonclick="selectSupplier('guestId')"/> -->
                                  ...
                                  <td colspan="1">
                                  		<input name="orderMan"
                                             ...
                                             width="100%"
                                             valueFromSelect="true"
                                             onvaluechanged="onordermanchanged"
                                             nullItemText="请选择..."
                                            />
                    ...
                    <div id="rightGrid" class="nui-datagrid" 
                        ...
                        备注<input property="editor" class="nui-textbox"/>
                            ...
                            <div header="辅助信息" headerAlign="center">
                                <div property="columns">
                                    <div type="comboboxcolumn" field="storeId" width="70" headerAlign="center" allowSort="true" header="仓库" visible="false">
