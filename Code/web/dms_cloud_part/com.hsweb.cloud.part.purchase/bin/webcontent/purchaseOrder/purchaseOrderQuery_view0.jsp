...
<head>
<title>采购订单查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/purchaseOrder/purchaseOrderQuery.js?v=2.0.22"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
        ...
        <div property="columns">
            ...
            <div header="数量单价" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" field="detailRemark" width="150" headerAlign="center" header="备注" allowSort="true" dataType="string"></div>
                </div>
            </div>
