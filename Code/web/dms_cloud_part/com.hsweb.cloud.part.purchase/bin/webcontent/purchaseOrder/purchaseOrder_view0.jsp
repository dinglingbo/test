...
<head>
<title>采购订单</title>
<script src="<%=webPath + contextPath%>/purchase/js/purchaseOrder/purchaseOrder.js?v=1.1.14"></script>
<style type="text/css">
.title {
  width: 70px;
  text-align: right;
...
<div id="advancedMorePartWin" class="nui-window"
     ...
     <div class="nui-toolbar" >
        <table style="width:100%;">
            <tr>
                <td style="width:100%;">
                    <a class="nui-button" iconCls="" plain="true" onclick="addSelectPart" id="saveBtn1"><span class="fa fa-check fa-lg"></span>&nbsp;选入</a>
                    <a class="nui-button" iconCls="" plain="true" onclick="onPartClose" id="auditBtn1"><span class="fa fa-close fa-lg"></span>&nbsp;取消</a>
                </td>
            </tr>
        </table>
    </div>
