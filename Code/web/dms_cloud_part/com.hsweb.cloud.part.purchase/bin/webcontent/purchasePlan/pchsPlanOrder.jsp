...
<head>
<title>计划采购</title>
<script src="<%=webPath + contextPath%>/purchase/js/purchasePlan/pchsPlanOrder.js?v=1.1.0"></script>
<style type="text/css">
.title {
	width: 70px;
	text-align: right;
...
<div id="exportDiv" style="display:none">  
    <table id="tableExcel" width="100%" border="0" cellspacing="0" cellpadding="0">  
        ...
        <tr>  
            ...
            <td colspan="1" align="center">连锁库存</td>
            <td colspan="1" align="center">总部库存</td>
            <td colspan="1" align="center">门店库存</td>
            <td colspan="1" align="center">在途库存</td>
            ...
            <td colspan="1" align="center">规格/方向</td>
        </tr>
