...
<head>
<title>快速报价</title>
<script src="<%=webPath + contextPath%>/purchase/js/quickSearch.js?v=1.1.1"></script>
<style type="text/css">
.table-label {
	text-align: right;
}
			...
			<div class="nui-fit">
				<div id="partGrid" class="nui-datagrid" style="width:100%;height:100%;"
						...
						<div property="columns">
								...
								<div field="orgCarBrandId" width="80" headerAlign="center">厂牌</div>
				...
				<div size="80%" showCollapseButton="false">
					<div class="nui-fit">
						<div id="mainTabs" class="nui-tabs" name="mainTabs"
							...
							<div title="宝马中国" id="BMWStockTab" name="BMWStockTab" url="" visible="false">
							</div>
