    ...
    <table style="width:100%;">
        <tr>
            ...
            <td style="width:100%;">
                ...
                <a class="nui-button" iconCls="" plain="true" onclick="audit()" visible="true"  id="auditBtn"><span class="fa fa-check fa-lg"></span>&nbsp;提交</a>               
                ...
                <a class="nui-button" iconCls="" plain="true" onclick="unAudit()" id="unAuditBtn" visible="true"><span class="fa fa-mail-reply fa-lg"></span>&nbsp;返单</a>
                    ...
                    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
                        ...
                        <div property="columns">
                            ...
                            <div header="销退订单明细" headerAlign="center">
                                <div property="columns">
                                    <div field="operateBtn" name="operateBtn" width="30" headerAlign="center" header="操作"></div>
...
<!--                                         <input property="editor" class="nui-textbox" /> -->
                            ...
                            <div header="数量金额信息" headerAlign="center">
                                <div property="columns">
                                    ...
                                    <div field="showPrice" numberFormat="0.0000" width="50" headerAlign="center" header="单价">
                                      <input property="editor" vtype="float" class="nui-textbox" enabled="false"/>
                                    </div>
                                    <div field="showAmt" summaryType="sum" numberFormat="0.0000" width="55" headerAlign="center" header="金额">
                                      <input property="editor" vtype="float" class="nui-textbox" enabled="false"/>
                                    </div>
                        ...
                        备注<input property="editor" class="nui-textbox"/>
                            ...
                            <div header="辅助信息" headerAlign="center">
                                <div property="columns">
                                    <div visible="false" type="comboboxcolumn" field="storeId" width="60" headerAlign="center" allowSort="true">
                        仓库<input  property="editor" enabled="false" name="storehouse" dataField="storehouse" class="nui-combobox" valueField="id" textField="name" data="storehouse"
                                      url=""
