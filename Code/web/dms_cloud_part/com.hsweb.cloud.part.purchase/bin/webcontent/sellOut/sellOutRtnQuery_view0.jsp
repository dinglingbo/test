...
<head>
<title>销售退货查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/sellOut/sellOutRtnQuery.js?v=2.0.20"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
        ...
        <div property="columns">
            ...
            <div header="" headerAlign="center">
                <div property="columns">
                    ...
                    <div field="guestFullName" width="150" headerAlign="center" header="客户" allowSort="true" dataType="string"></div>
            ...
            <div header="数量单价" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" datatype="float" name="rtnPrice" field="rtnPrice" visible="true" width="60" headerAlign="center" header="退货单价"></div>
                    <div allowSort="true" datatype="float" name="rtnAmt" field="rtnAmt" visible="true" summaryType="sum" width="60" headerAlign="center" header="退货金额"></div>
                    ...
                    <div allowSort="true" datatype="float" field="expenseAmt" summaryType="sum" width="60" headerAlign="center" header="费用"></div>
...
<div id="exportDiv" style="display:none">  
    <table id="tableExcel" width="100%" border="0" cellspacing="0" cellpadding="0">  
        ...
        <tr>
        	 <td colspan="1" align="center" >销退单号</td>
        	 ...
        	 <td colspan="1" align="center" >可出库数量</td>
        	 ...
        	 <td colspan="1" align="center" >返点金额</td>
