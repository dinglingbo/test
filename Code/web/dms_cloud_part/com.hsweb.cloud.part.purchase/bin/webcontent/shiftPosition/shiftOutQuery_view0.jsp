...
<head>
<title>移仓出库查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/shiftPosition/shiftOutQuery.js?v=2.0.1"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
        ...
        <div property="columns">
            ...
            <div header="移仓信息" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" field="outDate"width="120" headerAlign="center" header="移仓日期" dateFormat="yyyy-MM-dd HH:mm"></div>
