...
<head>
<title>移仓单</title>
<script src="<%=webPath + contextPath%>/purchase/js/shiftPosition/shiftPositionOrder.js?v=1.1.16"></script>
<style type="text/css">
.title {
	width: 70px;
	text-align: right;
    ...
    <table style="width:100%;">
        <tr>
            ...
            <td style="width:100%;">
                ...
                <a class="nui-button" iconCls="" plain="true" onclick="onPrint()" id="printBtn"><span class="fa fa-print fa-lg"></span>&nbsp;打印移仓入库单</a>
                <a class="nui-button" iconCls="" plain="true" onclick="onPrint1()" id="printBtn"><span class="fa fa-print fa-lg"></span>&nbsp;打印移仓出库单</a>
           		<span id="status"></span>
            </td>
        </tr>
    </table>
...
<div class="nui-fit">
    <div class="nui-splitter"
        ...
        <div size="220" showCollapseButton="true">
          <div title="移仓列表" class="nui-panel"
                 showFooter="true"
                      ...
                      <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
                          ...
                          <div property="columns">
                              ...
                              <div header="配件信息" headerAlign="center">
                                  <div property="columns">
                                    <div field="operateBtn" name="operateBtn" width="20" headerAlign="center" header="操作"></div>
                              ...
                              <div header="数量信息" headerAlign="center">
                                  <div property="columns">
                                      ...
                                      <div field="remark" visible="true" width="80" headerAlign="center" allowSort="true" header="备注">
                                        <input property="editor" class="nui-textbox"/>
                                      </div>
                                      <div field="storeShelf" visible="true" width="80" headerAlign="center" allowSort="true" header="移出仓位">
                                        <input property="editor" class="nui-textbox"/>
                                      </div>
                                      <div field="receiveStoreShelf" visible="true" width="80" headerAlign="center" allowSort="true" header="移入仓位">
                                        <input property="editor" class="nui-textbox"/>
                                      </div>
                                  </div>
                              </div>
...
<div id="advancedMorePartWin" class="nui-window"
     title="配件选择" style="width:600px;height:350px;"
     showModal="true"
     allowResize="false"
     allowDrag="true">
     <div class="nui-toolbar" style="padding:2px;border-bottom:0;">
    ...
    <div class="nui-fit">
          <div id="morePartGrid" class="nui-datagrid" style="width:100%;height:95%;"
              ...
              <div property="columns">
                  <div type="indexcolumn">序号</div>
                  <div field="orgCarBrandId" name="orgCarBrandId" width="100" headerAlign="center" header="厂牌"></div>
