...
<head>
<title>移仓单明细</title>
<script src="<%=webPath + contextPath%>/purchase/js/shiftPosition/shiftPositionOrderQuery.js?v=1.0.2"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
    ...
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="createDate"  width="120"headerAlign="center" header="移仓日期" dateFormat="yyyy-MM-dd HH:mm"></div>
                    <div allowSort="true" field="serviceId" width="180" summaryType="count" headerAlign="center" header="移仓单号"></div>
                    ...
                    <div allowSort="true" field="storeId" width="100" headerAlign="center" header="移出仓库"></div>
                    <div allowSort="true" field="receiveStoreId" width="100" headerAlign="center" header="移入仓库"></div>
                </div>
            </div>
            ...
            <div header="其他" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="mainRemark" width="150" headerAlign="center" header="主备注"></div>
                    <div allowSort="true" field="detailRemark" width="100" headerAlign="center" header="明细备注"></div><!-- 
