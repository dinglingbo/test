...
<head>
<title>盘亏出库查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/stockCheckOut/stockCheckOutQuery.js?v=2.0.0"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
    ...
    <table style="width:100%;">
        <tr>
            <td style="white-space:nowrap;">
                ...
                <input id="serviceId" width="120px" emptyText="盘亏单号" class="nui-textbox"/>
    ...
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="serviceId" width="150" summaryType="count" headerAlign="center" header="盘亏单号"></div>
            ...
            <div header="销售信息" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" field="outUnitId" width="50" headerAlign="center" header="单位"></div>
                </div>
            </div>
