...
<head>
<title>盘点单</title>
<script src="<%=webPath + contextPath%>/purchase/js/stockCheck/stockCheck.js?v=1.1.20"></script>
<style type="text/css">
.title {
	width: 75px;
	text-align: right;
                          ...
                          <div id="basicInfoForm" class="form" contenteditable="false">
                              ...
                              <table style="width: 100%;">
                                  ...
                                  <tr>
                                      ...
                                      <td colspan="7">
                                          <input class="nui-textbox" enabled="true" id="remark" name="remark" width="100%">
                                      </td>
                                  </tr>
                              </table>
                          </div>
                      ...
                      <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
                          ...
                          <div property="columns">
                              ...
                              <div header="配件信息" headerAlign="center">
                                  <div property="columns">
                                    <div field="operateBtn" name="operateBtn" width="50" headerAlign="center" header="删除"></div>
                                      ...
                                      <div field="comPartName" visible="true" headerAlign="center" header="配件名称"></div>
                              ...
                              <div header="辅助信息" headerAlign="center">
                                  <div property="columns">
                                      <div field="remark" width="200" headerAlign="center" header="备注">
                                      	<input property="editor" class="nui-textbox" />
                                      </div>
                                      <div field="stockOutQty" summaryType="sum" numberFormat="0.00" width="50" headerAlign="center" header="缺货数量">
                                      </div>
                                      <div field="comOemCode" width="120" headerAlign="center" allowSort="true" header="OE码"></div>   
