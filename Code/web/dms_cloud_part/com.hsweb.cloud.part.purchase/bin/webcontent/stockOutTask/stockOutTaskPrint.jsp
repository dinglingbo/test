...
<!--  				    <td colspan="2" style="text-align: right" id="serviceId"  class="" >No:</td>  -->
            ...
            <div id="queryTable" style="height:auto;">
             ...
             <div>
				...
				<table>
				  ...
				  <tr> <td colspan="4" id="currCloudSellOrderPrintContent" ></td></tr>
				  <!-- <tr id="border2">
	...
	<script type="text/javascript">
    	...
    	function setDetailData(params,detailParms) {
    		...
    		document.getElementById("spstorename").innerHTML = "出库单";
						...
						for(var i = 0; i < data.length; i++ ){ 
							...
							tr.append(
								tds.replace("[index]",i+1 ||"")
									...
									.replace("[showPrice]",data[i].showPrice ||"")
									.replace("[showAmt]",data[i].showAmt ||"")
