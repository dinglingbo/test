...
<head>
<title>库存查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/stockQuery/partStoreStockQuery.js?v=2.2.40"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
            ...
            <td style="white-space:nowrap;">
              ...
              <input id="comOECode" width="120px" emptyText="OE码" class="nui-textbox"/>
                ...
                <input id="applyCarBrandId" name="applyCarBrandId" class="nui-combobox width1" textField="nameCn" valueField="id" emptyText="厂牌"
                            url="" allowInput="true" showNullItem="false" nullItemText="厂牌"  visible="false"
                           width="80px" />
    ...
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="数量金额" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" datatype="float" field="stockQty" summaryType="sum" width="80" headerAlign="center" header="库存数量"></div>
                    <div allowSort="true" datatype="float" name="expEnterPrice" field="expEnterPrice" width="100" headerAlign="center" visible="false" header="采购成本单价"></div>
                    <div allowSort="true" datatype="float" name="expEnterAmt" field="expEnterAmt" summaryType="sum" width="100" headerAlign="center" visible="false" header="采购成本金额"></div>
                    <div allowSort="true" datatype="float" name="costPrice" field="costPrice" width="100" headerAlign="center" visible="false" header="库存单价"></div>
                    <div allowSort="true" datatype="float" name="stockAmt" field="stockAmt" summaryType="sum" width="100" visible="false" headerAlign="center" header="库存金额"></div>
                    <div allowSort="true" datatype="float" name="noTaxCostPrice" field="noTaxCostPrice" width="100" headerAlign="center" visible="false" header="库存商品单价"></div>
                    <div allowSort="true" datatype="float" name="noTaxCostAmt" field="noTaxCostAmt" summaryType="sum" width="100" headerAlign="center" visible="false" header="库存商品金额"></div>
                </div>
            </div>
