        ...
        <div property="columns">
            ...
            <div header="库存信息" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" name="shelf" field="shelf" width="120" headerAlign="center" header="仓位">
            ...
            <div header="数量" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" name="upLimit" field="upLimit" width="95" headerAlign="center" header="库存上限" numberFormat="0.00"><input property="editor" vtype="float" class="nui-textbox"/></div>
                    <div allowSort="true" name="downLimit" field="downLimit" width="95" headerAlign="center" header="库存下限" numberFormat="0.00"><input property="editor" vtype="float" class="nui-textbox"/></div>
                    <div allowSort="true" name="upLimitWinter" field="upLimitWinter" width="95" visible="false" headerAlign="center" header="库存上限(冬季)" numberFormat="0.00"><input property="editor" vtype="float" class="nui-textbox"/></div>
                    <div allowSort="true" name="downLimitWinter" field="downLimitWinter" width="95" visible="false" headerAlign="center" header="库存下限(冬季)" numberFormat="0.00"><input property="editor" vtype="float" class="nui-textbox"/></div>
                    <div allowSort="true" name="minOrderQty" field="minOrderQty" width="75" headerAlign="center" header="最小起订量" numberFormat="0.00"><input property="editor" vtype="float" class="nui-textbox"/></div>
                    <div allowSort="true" name="minPackQty" field="minPackQty" width="75" headerAlign="center" header="最小包装量" numberFormat="0.00"><input property="editor" vtype="float" class="nui-textbox"/></div>
                </div>
            </div>
