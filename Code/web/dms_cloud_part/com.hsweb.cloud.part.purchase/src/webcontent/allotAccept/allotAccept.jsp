...
<head>
<title>调拨受理</title>
<script src="<%=webPath + contextPath%>/purchase/js/allotAccept/allotAccept.js?v=1.0.9"></script>
<style type="text/css">
.title {
  width: 70px;
  text-align: right;
...
<div class="nui-fit">
    <div class="nui-splitter"
        ...
        <div size="220" showCollapseButton="true">
          <div title="调拨受理列表" class="nui-panel"
                 showFooter="true"
        ...
        <div showCollapseButton="false">
             ...
             <div class="nui-fit">
                  <fieldset id="fd1" style="width:99.5%;height:100px;">
                      <legend><span>调拨受理信息</span></legend>
                  ...
                  <div class="nui-fit">
                      <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
                          ...
                          <div property="columns">
                             ...
                             <div header="库存信息" headerAlign="center" visible="false">
                                  <div property="columns">
                              ...
                              <div header="辅助信息" headerAlign="center">
                                  <div property="columns">
                                  	  <div field="stockOutQty" summaryType="sum" numberFormat="0.00" width="25" headerAlign="center" header="缺货数量"></div>
