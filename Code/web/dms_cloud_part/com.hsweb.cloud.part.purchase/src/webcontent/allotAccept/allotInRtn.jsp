        ...
        <tr>
            <td style="white-space:nowrap;">
                ...
                <ul id="popupMenuType" class="nui-menu" style="display:none;">
                  <li iconCls="" onclick="quickSearch(15)" id="type10">所有</li>
                  <span class="separator"></span>
                    ...
                    <span class="separator"></span>
                    <li iconCls="" onclick="quickSearch(9)" id="type9">待受理</li>
                    <li iconCls="" onclick="quickSearch(10)" id="type10">已受理</li>
                    <li iconCls="" onclick="quickSearch(11)" id="type11">已拒绝</li>
                    <span class="separator"></span>
                    <li iconCls="" onclick="quickSearch(12)" id="type12">未出库</li>
                    <li iconCls="" onclick="quickSearch(13)" id="type13">部分出库</li>
                    <li iconCls="" onclick="quickSearch(14)" id="type14">全部出库</li>
                </ul>
                ...
                <div id="leftGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                      <div type="indexcolumn">序号</div>
                        <div field="status" width="60" headerAlign="center" header="受理状态"></div>
                        <div field="settleStatus" width="60" headerAlign="center" header="出库状态"></div>
        ...
        <div showCollapseButton="false">
             ...
             <div class="nui-fit">
                  <fieldset id="fd1" style="width:99.5%;height:100px;">
                      <legend><span>调入退回信息</span></legend>
