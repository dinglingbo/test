...
-->
<head>
<title>调入退回明细查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/allotAccept/allotInRtnQuery.js?v=2.0.19"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
...
<!--                     <div allowSort="true" datatype="float" summaryType="sum" field="applyQty" width="60" headerAlign="center" header="申请数量"></div> -->
                    <div allowSort="true" datatype="float" summaryType="sum" field="acceptQty" width="90" headerAlign="center" header="申请数量"></div>
