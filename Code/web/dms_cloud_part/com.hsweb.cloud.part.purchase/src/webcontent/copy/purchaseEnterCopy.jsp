...
<head>
<title>采购入库</title>
<script src="<%=webPath + contextPath%>/purchase/js/purchaseEnter/purchaseEnter.js?v=2.2.0"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
...
<div class="nui-fit">
    <div id="mainTabs" class="nui-tabs" name="mainTabs"
        ...
        <div title="采购入库" id="billmain" name="billmain" >
            <!--采购订单信息-->
            <%@include file="/purchase/purchaseEnter/purchaseEnterDetail.jsp" %>
        </div>
        <div title="待入库订单" id="notEnterOrderTab" name="notEnterOrderTab" url="" >
            <!--配件基本信息-->
            <%@include file="/purchase/purchaseEnter/notEnterOrderDetail.jsp" %>
          <!-- <div class="nui-fit">
