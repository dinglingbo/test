...
<head>
<title>销售出库</title>
<script src="<%=webPath + cloudPartDomain%>/purchase/copy/sellOutCopy.js?v=1.0.0"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
	        ...
	        <div title="销售出库列表" class="nui-panel"
                ...
                <div id="leftGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="serviceId" headerAlign="center" width="150" header="销售单号"></div>
              ...
              <div size="65%" showCollapseButton="false">
                 <div class="nui-fit">
                      ...
                      <div id="mainTabs" class="nui-tabs" name="mainTabs"
                           ...
                           plain="false" 
                           onactivechanged="">
                        <div title="销售出库信息" id="billmain" name="billmain" >
                          <div class="nui-fit">
                        ...
                        <div title="库存明细" name="purchaseAdvance" >
                          <div class="nui-fit">
