...
<head>
<title>物流订单查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/packOut/packQuery.js?v=1.0.72"></script>
    ...
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="数量金额" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" datatype="float" summaryType="sum" field="orderQty" width="60" headerAlign="center" header="总包数"></div>
