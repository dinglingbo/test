...
<head>
<title>业务单选择</title>
<script src="<%=webPath + contextPath%>/purchase/js/packOut/packShiftSelect.js?v=1.0.1"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
  ...
  <div class="nui-fit">
      <div id="notPackGrid" class="nui-datagrid" style="width:100%;height:100%;"
          ...
          <div property="columns">
              ...
              <div allowSort="true" summaryType="count" field="code" width="150" summaryType="count" headerAlign="center" header="移仓单号"></div>
              <div field="orderMan" width="60" headerAlign="center" header="业务员"></div>
              <div field="outAmt" width="60" headerAlign="center" summaryType="sum" header="金额"></div>
