...
<%
	...
	String fileAddr = "";
	if(auditSign == 0){
		fileAddr = request.getSession().getServletContext().getRealPath("") +"/purchase/iReport/unaudit/sellOrderReport.jasper";
	}else{
		fileAddr = request.getSession().getServletContext().getRealPath("") +"/purchase/iReport/audit/sellOrderReport.jasper";
	}
