...
<head>
<title>采购退货查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/purchaseEnter/purchaseRtnQuery.js?v=2.0.0"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
        ...
        <div property="columns">
            ...
            <div header="" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true"width="120" field="outDate" headerAlign="center" header="退货日期" dateFormat="yyyy-MM-dd HH:mm"></div>
