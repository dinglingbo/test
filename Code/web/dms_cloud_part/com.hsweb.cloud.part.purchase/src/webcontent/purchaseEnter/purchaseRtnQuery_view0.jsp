...
<head>
<title>采购退货查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/purchaseEnter/purchaseRtnQuery.js?v=2.0.1"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
    ...
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="serviceId" width="150" summaryType="count" headerAlign="center" header="采退单号" allowSort="true" dataType="string"></div>
