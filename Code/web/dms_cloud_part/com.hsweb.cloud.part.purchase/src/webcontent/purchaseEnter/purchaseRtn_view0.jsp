...
<head>
<title>采购退货</title>
<script src="<%=webPath + cloudPartDomain%>/purchase/js/purchaseEnter/purchaseRtn.js?v=1.1.0"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
                        ...
                        <div id="basicInfoForm" class="form" contenteditable="false">
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td>
                                        <input class="nui-textbox" width="100%" id="serviceId" name="serviceId" enabled="false" placeholder="新采购退货"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title required">
            ...
            <div class="nui-fit">
                <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div header="退货信息信息" headerAlign="center">
                            <div property="columns">
