...
<head>
<title>采购订单查询</title>
<script src="<%=webPath + contextPath%>/purchase/js/purchaseOrder/purchaseOrderQuery.js?v=2.0.1"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
        ...
        <div property="columns">
            ...
            <div header="订单信息" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" field="createDate" width="120"headerAlign="center" header="订货日期" dateFormat="yyyy-MM-dd HH:mm"></div>
