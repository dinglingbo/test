...
<head>
<title>采购入库</title>
<script src="<%=webPath + contextPath%>/purchase/js/purchaseOrderEnter/purchaseOrderEnter.js?v=1.0.60"></script>
<style type="text/css">
.title {
  width: 70px;
  text-align: right;
    ...
    <div class="nui-fit">
          <div id="morePartGrid" class="nui-datagrid" style="width:100%;height:95%;"
              ...
              <div property="columns">
                ...
                <div field="oemCode" name="oemCode" width="220" headerAlign="center" header="OEM码"></div>
