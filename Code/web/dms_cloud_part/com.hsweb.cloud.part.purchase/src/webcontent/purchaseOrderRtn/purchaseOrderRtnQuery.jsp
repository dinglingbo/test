...
<head>
<title>采购退货明细</title>
<script src="<%=webPath + contextPath%>/purchase/js/purchaseOrderRtn/purchaseOrderRtnQuery.js?v=1.0.2"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
    ...
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="退货信息" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="createDate" headerAlign="center"width="120" header="退货日期" dateFormat="yyyy-MM-dd HH:mm"></div>
            ...
            <div header="配件信息" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" field="comPartName" width="180"headerAlign="center" header="配件名称"></div>
                    <div allowSort="true" field="comOemCode" width="200"headerAlign="center" header="OEM码"></div>
