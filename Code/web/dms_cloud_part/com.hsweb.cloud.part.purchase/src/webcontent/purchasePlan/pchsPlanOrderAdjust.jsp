...
<body>
  	...
  	<div class="nui-fit">
        ...
        >
         <div property="columns">
            ...
            <div field="orderQty" name="orderQty" allowSort="true"  width="60" headerAlign="center" align="center" header="计划数量" datatype="float" summaryType="sum"></div>
            <div field="trueEnterQty" name="trueEnterQty" width="90px" headerAlign="center" allowSort="true" align="center" header="已下订单数量"></div>
            <div field="adjustQty" name="adjustQty" width="90px" headerAlign="center" allowSort="true" align="center" header="已调整数量"></div>
	...
	<script type="text/javascript">
    	...
    	var fmainId = 0;
    	var gridUrl = baseUrl + "/com.hsapi.cloud.part.invoicing.pchsplan.queryPjPchsPlanDetailList.biz.ext";
		...
		function loadData() {
	   	...
	   	function onOk(){
			...
			nui.mask({
   			...
   			nui.ajax({
				url : baseUrl + "com.hsapi.cloud.part.invoicing.pchsplan.adjustPchsPlan.biz.ext",
				type : "post",
				data : JSON.stringify({
					data : adjList,
					mainId: fmainId,
