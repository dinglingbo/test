...
<!--  				    <td colspan="2" style="text-align: right" id="serviceId"  class="" >No:</td>  -->
				  ...
				  <tr id="border1">
				    ...
				    <td style="font-size:8px;" id="createDate" align="left">计划采购日期:</td>	    
				  </tr>
				</table>
				<hr id="se"/>
				<table id="ybk" width="100%">
				  ...
				  <tr>
				    <td id="addr">地址:</td>
				    <td colspan="2" id="mainRemark">备注:</td>
				  </tr>
				</table>
        	</div> 
        	<hr id="se2"/>
	...
	<script type="text/javascript">
		...
		var MainUrl = baseUrl
				+ "com.hsapi.cloud.part.invoicing.pchsplan.queryPjPchsPlanMainList.biz.ext";
		var DetailUrl = baseUrl
				+ "com.hsapi.cloud.part.invoicing.pchsplan.queryPjPchsPlanDetailList.biz.ext";
    	...
    	function SetData(params,detailParms){
    		...
    		document.getElementById("spstorename").innerHTML = "计划采购单";
