  ...
  <div class="nui-fit">
      <div id="notSettleGrid" class="nui-datagrid" style="width:100%;height:100%;"
          ...
          <div property="columns">
              ...
              <div field="billStatusId" width="50" headerAlign="center" header="订单状态"></div>
              ...
              <div allowSort="true"width="120" field="auditDate" headerAlign="center" header="订单日期" dateFormat="yyyy-MM-dd HH:mm"></div>
  ...
  <div id="editFormPchsOrderDetail" style="display:none;">
      <div id="innerPchsOrderGrid" class="nui-datagrid" style="width:100%;height:150px;"
          ...
          <div property="columns">
              ...
              <div allowSort="true" datatype="float" field="orderAmt" summaryType="sum" width="60" headerAlign="center" header="订单金额"></div>
