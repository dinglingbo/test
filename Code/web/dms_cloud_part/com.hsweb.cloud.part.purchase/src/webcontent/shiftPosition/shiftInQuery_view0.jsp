...
<head>
<title>移仓入库查询</title>
<script src="<%=webPath + cloudPartDomain%>/purchase/js/shiftPosition/shiftInQuery.js?v=2.0.0"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
        ...
        <div property="columns">
            ...
            <div header="" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" field="enterDate" headerAlign="center" header="移仓日期" dateFormat="yyyy-MM-dd H:mm:ss"></div>
