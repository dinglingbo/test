...
<head>
<title>移仓单明细</title>
<script src="<%=webPath + contextPath%>/purchase/js/shiftPosition/shiftPositionOrderQuery.js?v=1.0.0"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
        ...
        <div property="columns">
            ...
            <div header="" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" field="serviceId" width="130" summaryType="count" headerAlign="center" header="移仓单号"></div>
                    ...
                    <div allowSort="true" field="receiveStoreId" width="80" headerAlign="center" header="移入仓库"></div>
                </div>
            </div>
