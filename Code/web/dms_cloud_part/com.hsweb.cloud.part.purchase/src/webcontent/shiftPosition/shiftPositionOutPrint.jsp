...
// 			});
    ...
    //		$('#dueAmt').text("客户欠款金额:"+dueAmt+"元");
		    ...
		    //   	$('#guestFullName').text("客户:"+formParms.guestFullName);
		       		...
		       		$('#storeName').text(formParms.receiveStoreId?"出库仓:"+storeHash[formParms.receiveStoreId].name :"出库仓:");
						...
						for(var i = 0; i < data.length; i++ ){ 
							...
							tr.append(
								tds.replace("[index]",i+1 ||"")
								    .replace("[storehouse]",data[i].receiveStoreId?storeHash[data[i].receiveStoreId].name :"")
