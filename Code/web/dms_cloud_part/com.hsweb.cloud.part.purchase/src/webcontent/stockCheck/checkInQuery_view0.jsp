...
<head>
<title>盘盈入库查询</title>
<script src="<%=webPath + cloudPartDomain%>/purchase/js/stockCheckIn/stockCheckInQuery.js?v=1.0.0"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
    ...
    <table style="width:100%;">
        <tr>
            <td style="white-space:nowrap;">
                ...
                <input id="serviceId" width="120px" emptyText="盘盈单号" class="nui-textbox"/>
                ...
                <a class="nui-button" iconCls="icon-search" plain="true" onclick="onSearch()"><span class="fa fa-search fa-lg"></span>&nbsp;查询</a>
                <span class="separator"></span>
