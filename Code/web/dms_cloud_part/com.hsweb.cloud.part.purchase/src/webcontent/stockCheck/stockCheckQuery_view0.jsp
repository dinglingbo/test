...
<head>
<title>盘点单明细</title>
<script src="<%=webPath + cloudPartDomain%>/purchase/js/stockCheck/stockCheckQuery.js?v=1.0.0"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
    ...
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="createDate" headerAlign="center" header="盘点日期" dateFormat="yyyy-MM-dd H:mm:ss"></div>
