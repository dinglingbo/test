...
<head>
    ...
    <script src="<%=webPath + contextPath%>/report/js/finance/accountDetail.js?v=1.0.10"></script>
    <style type="text/css">
    body {
        margin: 0;
        padding: 0;
...
<body>
    <div class="nui-toolbar" style="padding:2px;border-top:0;border-left:0;border-right:0;">
        ...
        <input id="elAuditor" emptyText="结算人" class="nui-textbox"/>
        <input id="elRpAccountId" emptyText="单号" class="nui-textbox"/>
		<input id="elRemark" emptyText="备注" class="nui-textbox"/>
    ...
    <div class="nui-fit">
        <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" 
            ...
            <div property="columns">
                ...
                <div field="billTypeId" name="billTypeId" width="50"  headeralign="center" >项目名称</div>
                <div field="charOffAmt" name="charOffAmt" width="60" summaryType="sum" headeralign="center" >结算金额</div>
                <div field="remark" name="remark" width="180"  headeralign="center" >结算备注</div>
                ...
                <div field="rpAccountId" name="rpAccountId" width="180"  headeralign="center" >单号</div>
