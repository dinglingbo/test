...
<head>
    ...
    <script src="<%=webPath + contextPath%>/report/js/finance/accountPDetail.js?v=1.0.10"></script>
    <style type="text/css">
    body {
        margin: 0;
        padding: 0;
...
<body>
    <div class="nui-toolbar" style="padding:2px;border-top:0;border-left:0;border-right:0;">
        ...
        <input id="accountId" width="150px" textField="name" valueField="id" emptyText="结算账户" class="nui-combobox" allowinput="true" valueFromSelect="true"/>
        ...
        <input id="isMain" width="100px" data="pList" visible="false" textField="text" valueField="id"  emptyText="是否主营业务" class="nui-combobox" allowinput="true" valueFromSelect="true"/>
