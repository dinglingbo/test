...
<head>
    <title>门店进销存明细</title>
    <script src="<%=webPath + contextPath%>/report/js/invoing/shopInvoingDetail.js?v=1.0.14"></script>
        ...
        <tr>
            <td style=" width:45%;">
               ...
               <span class="separator"></span>
                ...
                <input class="nui-textbox" width="100px" id="morePartId" emptyText="内码"  selectOnFocus="true" name="morePartID" visible="false"/>
...
<!--                 <div allowSort="true" field="partId" width="100" headerAlign="center" header="配件内码"></div> -->
                ...
                <div allowSort="true" field="orgCarBrandId" width="60" headerAlign="center" header="厂牌" allowSort="true" dataType="string"></div>
   				...
   				<div allowSort="false" field="applyCarModel" width="60" name="applyCarModel" headerAlign="center" header="品牌车型"></div>
