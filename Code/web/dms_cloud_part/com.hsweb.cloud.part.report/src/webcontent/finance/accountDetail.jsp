...
<head>
    ...
    <script src="<%=webPath + cloudPartDomain%>/report/js/finance/accountDetail.js?v=1.0.0"></script>
    <style type="text/css">
    body {
        margin: 0;
        padding: 0;
    ...
    <div class="nui-fit">
        <div id="mainGrid" class="nui-datagrid" style="width:900px;height:100%;" 
            ...
            <div property="columns">
                ...
                <div field="settAccountId" name="code" width="80" summaryType="count"  headeralign="center" >账户编码</div>
                ...
                <div field="auditDate" name="auditDate" width="100" dateFormat="yyyy-MM-dd H:mm:ss" headeralign="center" >结算日期</div>
