...
<head>
    ...
    <script src="<%=webPath + contextPath%>/report/js/finance/hqAccountRDetail.js?v=1.0.12"></script>
    <style type="text/css">
    body {
        margin: 0;
        padding: 0;
...
<body>
    ...
    <div class="nui-fit">
        <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" 
             ondrawcell="onDrawCell" showPager="true"  dataField="list"   url="" sortMode="client"  onshowrowdetail="onShowRowDetail"
            ...
            <div property="columns">
               ...
               <div field="rAmt" name="rAmt" width="50" summaryType="sum" headeralign="center" >应收金额</div>
                ...
                <div field="auditDate" name="auditDate" width="120" dateFormat="yyyy-MM-dd HH:mm" headeralign="center" >收款日期</div>
...
<div id="editFormtDetail" style="display:none;">
    <div id="innerGrid" class="nui-datagrid" style="width:100%;height:150px"
      ...
      <div property="columns">
        ...
        <div field="isPrimaryBusiness" name="name" width="100"  headeralign="center" >是否主营业务</div>
        <div field="shortName" name="name" width="120"  headeralign="center" >客户简称</div>
        <div field="charOffAmt" name="charOffAmt" width="60" summaryType="sum" headeralign="center" >收款金额</div>
        <div field="auditor" name="auditor" width="60"  headeralign="center" >收款人</div>
        <div field="remark" name="remark" width="100"  headeralign="center" >备注</div>
        <div field="auditDate" name="auditDate" width="120" dateFormat="yyyy-MM-dd HH:mm" headeralign="center" >收款日期</div>
        <div field="fullName" name="name" width="180"  headeralign="center" >客户全称</div>
