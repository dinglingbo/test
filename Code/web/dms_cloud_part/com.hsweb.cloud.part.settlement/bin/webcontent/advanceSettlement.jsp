...
<head>
	<title>预收账款管理</title>
	<script src="<%=webPath + contextPath%>/settlement/js/advanceSettlement.js?v=1.0.25"></script>
					...
					<table style="width: 100%;">
						<tr>
							<td style="white-space: nowrap;">
		                       ...
		                       emptyText="请选择往来单位..." allowInput="false"
		                       onbuttonclick="selectSupplier('searchGuestId')" selectOnFocus="true" />
								...
								<span class="separator"></span>
		 						...
		 						<a class="nui-button" iconCls="" plain="true" onclick="onRefund()" id="refundBtn">
									<span class="fa fa-exchange fa-lg"></span>&nbsp;退款</a>
						...
						<div title="应收结算" name="rRightTab">
							<div class="nui-fit">
								<div id="rRightGrid" class="nui-datagrid" style="width: 100%; height: 100%;" showPager="true" dataField="detailList" idField="detailId"
								 ...
								 pageSize="50" sizeList="[50,100,200]" onshowrowdetail="onShowRowDetail" oncellclick="onRGridbeforeselect" onheadercellclick="onRGridheadercellclick"
								 oncellcommitedit="onCellCommitEdit" showSummaryRow="true" selectOnLoad="true" onselectionchanged="onrRightGridSelectionChanged">
									<div property="columns">
										...
										<div allowSort="true" field="orgCarBrandId" name="orgCarBrandId" width="100" headerAlign="center" header="厂牌"></div>
