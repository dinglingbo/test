...
<head>
<title>业务单选择</title>
<script src="<%=webPath + contextPath%>/settlement/js/billServiceSelect.js?v=1.0.74"></script>
<style type="text/css">
.title {
  width: 60px;
  text-align: right;
      ...
      <table style="width:100%;">
          <tr>
              <td style="white-space:nowrap;">
                  ...
                  <input class="nui-datepicker" id="sBillAuditDate" allowInput="true" width="100px" format="yyyy-MM-dd" showTime="false" showOkButton="false" showClearButton="false"/>
                  <label style="font-family:Verdana;">至</label>
                  <input class="nui-datepicker" id="eBillAuditDate" allowInput="true" width="100px" format="yyyy-MM-dd" showTime="false" showOkButton="false" showClearButton="false"/>
  ...
  <div class="nui-fit">
      <div id="notStatementGrid" class="nui-datagrid" style="width:100%;height:100%;"
          ...
          <div property="columns">
              ...
              <div field="fullName" width="150" headerAlign="center" header="往来单位名称" summaryType="count"></div>
              ...
              <div allowSort="true" summaryType="count" field="code" width="170" headerAlign="center" header="订单号"></div>
              <div allowSort="true" summaryType="count" field="serviceId" width="170" headerAlign="center" header="业务单号"></div>
              <div field="settleFullName" width="150" headerAlign="center" header="结算单位名称"></div>
