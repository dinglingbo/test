...
<head>
<title>月结对账</title>
<script src="<%=webPath + contextPath%>/settlement/js/billStatement.js?v=1.1.17"></script>
<style type="text/css">
.title {
  width: 85px;
  text-align: right;
                  ...
                  <fieldset id="fd1" style="width:99.5%;height:150px;">
                      ...
                      <div class="fieldset-body">
                          <div id="basicInfoForm" class="form" contenteditable="false">
                              ...
                              <input name="businessTypeId" id="businessTypeId" class="nui-combobox" visible="false"/>
                                  ...
                                  <tr>
                                      ...
                                      <td colspan="1">
                                           <input name="balaType" visible=""
			                                 ...
			                                 data="balaTypeList"
			                                 width="100%"
			                                 onvaluechanged="onBalaTypeValueChange"/>
                                      </td>
                                  	 <td class="title">
                                          <label>开票登记：</label>
                                      </td>
                  ...
                  <div class="nui-fit">
                      <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
                          ...
                          <div property="columns">
                              ...
                              <div field="expenseTypeCode" name="expenseTypeCode" width="60" headerAlign="center" header="费用项目" visible="false"></div>
                              ...
                              <div field="billTypeId" name="billTypeId" width="60" headerAlign="center" header="票据类型" visible="false"></div>
                              <div allowSort="true" field="billDate" headerAlign="center" header="审核日期" dateFormat="yyyy-MM-dd HH:mm"></div>
                              <div field="logisticsNo" name="logisticsNo" visible="false" width="120" headerAlign="center" header="物流单号"></div>
...
<div id="advancedSearchWin" class="nui-window"
    ...
    <div id="advancedSearchForm" class="form">
        <table style="width:100%;">
            ...
            <tr>
                <td class="title">对账类型:</td>
                <td colspan="3">
                	<input name="elBalaType" id="elBalaType" class="nui-combobox"
			               textField="name" valueField="id" enabled="true"
			               valuefromselect="true" allowInput="true" selectOnFocus="true"
			               showNullItem="false" data="balaTypeList" width="100%" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <textarea class="nui-textbox"  width="100%" id="billServiceId" name="billServiceId"></textarea>
                </td>
            </tr>
        </table>
