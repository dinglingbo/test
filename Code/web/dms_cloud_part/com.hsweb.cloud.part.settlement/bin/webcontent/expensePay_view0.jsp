...
<head>
<title>费用支出单</title>
<script src="<%=webPath + contextPath%>/settlement/js/expensePay.js?v=2.0.24"></script>
<style type="text/css">
.title {
  width: 60px;
  text-align: right;
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="white-space:nowrap;">
                            ...
                            <a class="nui-button" iconCls="" plain="true" onclick="doPrint()" id="doPrint" visible="false"><span class="fa fa-print fa-lg"></span>&nbsp;打印</a>
							<span class="separator"></span>
            ...
            <div class="nui-fit">
                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="guestName" summaryType="count" width="100" headerAlign="center" header="往来单位名称"></div>
                        ...
                        <div field="rpAccountId" width="90" headerAlign="center" header="单号"></div>
