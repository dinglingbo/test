...
<head>
<title>内部转账单</title>
<script src="<%=webPath + contextPath%>/settlement/js/internalTransfer.js?v=2.0.8"></script>
<style type="text/css">
.title {
  width: 60px;
  text-align: right;
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="white-space:nowrap;">
							...
							<input id="raccountId" width="150px" textField="name" valueField="id" emptyText="收款账户" class="nui-combobox" allowinput="true" valueFromSelect="true"/>
							<input id="paccountId" width="150px" textField="name" valueField="id" emptyText="付款账户" class="nui-combobox" allowinput="true" valueFromSelect="true"/>
                ...
                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="toSettAccountId" type="comboboxcolumn" width="100" headerAlign="center" header="收款账户">
                            ...
                            valueField="id" textField="name" onvaluechanged="onRAccountChange" url="" emptyText=""  vtype="required"/> 
                        </div>
                        ...
                        <div field="settAccountId" type="comboboxcolumn" width="100" headerAlign="center" header="付款账户">
                            <input  property="editor" enabled="true" id="balaAccountList" name="list" data="accountList" class="nui-combobox" 
                            valueFromSelect="true" allowInput="true"
                            valueField="id" textField="name" onvaluechanged="onPAccountChange" url="" emptyText=""  vtype="required"/> 
                        </div>
