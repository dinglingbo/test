...
<div class="nui-fit">
    <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div field="sellPrice" numberFormat="0.0000" width="90" headerAlign="center" header="单价"></div>
            <div field="trueSellPrice" numberFormat="0.0000" width="90" headerAlign="center" header="实际价格"></div>
            <div field="sellAmt" numberFormat="0.0000" width="90" headerAlign="center" header="金额"> </div>
            <div field="trueSellAmt" numberFormat="0.0000" width="90" headerAlign="center" header="实际金额"> </div>
...
function initGridData(data) {
	...
	if (data && data.length > 0) {
		for (var i = 0; i < data.length; i++) {
			...
			var sellPrice = part.sellPrice || 0;
			var sellAmt = part.sellAmt || 0;
			...
			var row = {
				...
				sellPrice : sellPrice,
				sellAmt  : sellAmt,
				trueSellPrice:part.trueSellPrice,
				trueSellAmt: part.trueSellAmt,
				showPartId : partId,
