...
<head>
<title>应收应付结算</title>
<script src="<%=webPath + contextPath%>/settlement/js/rpAccountSettle.js?v=2.4.32"></script>
<style type="text/css">
.title {
    width: 90px;
    text-align: right;
    ...
    <table style="width:100%;">
        <tr>
            <td style="white-space:nowrap;">
                ...
                <input id="serviceId" width="150px" emptyText="业务单号" class="nui-textbox"/>
                ...
                <input id="guestName" width="120px" emptyText="往来单位名称" onEnter="onSearch()" class="nui-textbox" visible="false"/> 
...
<div class="nui-fit">
    ...
    <div id="mainTabs" class="nui-tabs" name="mainTabs"
         ...
         plain="false" 
         onactivechanged="">
        <div title="综合结算" id="rpRightTab" name="rpRightTab" visible="false" >
            <div class="nui-fit">
        ...
        <div title="应收结算" name="rRightTab" >
          <div class="nui-fit">
                <div id="rRightGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        <div type="indexcolumn">序号</div>
                        <div type="checkcolumn" name="check" width="20"></div>
                        <div type="expandcolumn" width="20" >#</div>
                        <div field="guestName" width="150" headerAlign="center" header="结算单位"></div>
                        <div allowSort="true" summaryType="count" field="billServiceId" width="150" summaryType="count" headerAlign="center" header="业务单号"></div>
                        <div field="billTypeId" width="80" headerAlign="center" header="收支项目"></div>
                        <div field="remark" width="130" headerAlign="center" header="财务备注"></div>
                        <div field="rpAmt" width="60" headerAlign="center" align="right" summaryType="sum" numberFormat="0.00" header="应收金额"></div>
...
<div id="editFormExpenseDetail" style="display:none;">
    <div id="innerExpenseGrid" class="nui-datagrid" style="width:100%;height:150px"
       showPager="false"
       dataField="detailList"
       idField="id"
       showSummaryRow="true"
      ...
      <div property="columns">
          ...
          <!-- <div type="checkcolumn" width="20"></div>
          <div type="expandcolumn" width="20" >#</div> -->
          <div field="expenseTypeCode" width="60" headerAlign="center" header="费用类型"></div>
          <div field="rpAmt" width="60" headerAlign="center" summaryType="sum" header="金额"></div>
            ...
            <table class="tmargin">
                ...
                <tr>
                    ...
                    <td id="rpRemark" style="text-align:left;" width="500px">
                        <input id="rpTextRemark" width="100%" height="130px" emptyText="" class="nui-textArea"/>
                    </td>
                </tr>
            </table>
