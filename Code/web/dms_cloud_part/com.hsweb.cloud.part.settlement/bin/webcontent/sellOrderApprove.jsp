...
<head>
<title>销售订单审核</title>
<script src="<%=webPath + contextPath%>/settlement/js/sellOrderApprove.js?v=1.0.11"></script>
<style type="text/css">
.title {
  width: 60px;
  text-align: right;
      ...
      <table style="width:100%;">
          <tr>
              <td style="white-space:nowrap;">
                  ...
                  <input id="billServiceMan" width="60px" emptyText="业务员" class="nui-textbox"/>
				  ...
				  <a class="nui-button" iconCls="" plain="true" onclick="onExport()" id="exportBtn">
				  	<span class="fa fa-level-up fa-lg"></span>&nbsp;导出
				  </a>
                  ...
                  <input class="nui-combobox" name="businessTypeId" id="businessTypeId" 
                       emptyText="销售类型" data="" width="60px" visible="false" />
              </td>
          </tr>
      </table>
  </div>
