...
<script src="<%=webPath + contextPath%>/settlement/js/hqRpAccountSettle.js?v=2.3.109"></script>
<style type="text/css">
.title {
    width: 90px;
    text-align: right;
            ...
            <div class="nui-fit">
                <div id="rpRightGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="orgName" width="150" headerAlign="center" header="公司名称"></div>
...
<div id="settleWin" class="nui-window"
    ...
    <div id="settleSearchForm" class="form">
        ...
        <div style="text-align:center;padding:10px;">
            <a class="nui-button" onclick="settle()" style="width:60px;margin-right:20px;">确定</a>
