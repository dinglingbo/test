...
<title>未对账业务单</title>
    ...
    <script src="<%=webPath + contextPath%>/settlement/js/noBalaRpaAccountSettle.js?v=1.0.50"></script>
</head>
<body>
<div class="nui-fit">
        	...
        	<div class="nui-toolbar" style="padding:2px;border-bottom:0;">
			 ...
			 <div id="mainGrid" class="nui-datagrid" style="width:100%;height:90%;"
		        ...
		        <div property="columns">
		            ...
		            <div field="sellOutAmt" width="55px" headerAlign="center" allowSort="true" header="采购退货金额"summaryType="sum"datatype="float" numberFormat="0.00" visible=""></div>
		            <div field="purchaseRtnAmt" width="55px" headerAlign="center" allowSort="true" header="销售出库金额"summaryType="sum"datatype="float" numberFormat="0.00" visible=""></div>
		            ...
		            <div field="allotAcceptAmt" width="55px" headerAlign="center" allowSort="true" header="调入退货金额"summaryType="sum"datatype="float" numberFormat="0.00" visible=""></div>
		            <div field="allotOutRtnAmt" width="55px" headerAlign="center" allowSort="true" header="调拨出库金额"summaryType="sum"datatype="float" numberFormat="0.00" visible=""></div>  
		            <div field="allotInRtnAmt" width="55px" headerAlign="center" allowSort="true" header="调出退货金额"summaryType="sum"datatype="float" numberFormat="0.00" visible=""></div>    
