...
<head>
<title>其他应收单</title>
<script src="<%=webPath + cloudPartDomain%>/settlement/js/othersRBill.js?v=1.0.0"></script>
<style type="text/css">
.title {
  width: 60px;
  text-align: right;
                ...
                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="billTypeId" type="comboboxcolumn" width="100" headerAlign="center" header="收支项目">
                            <input  property="editor" enabled="true" id="billTypeList" name="list" data="Rlist"  class="nui-combobox" valueField="id" textField="name" url="" emptyText="" /> 
                        </div>
