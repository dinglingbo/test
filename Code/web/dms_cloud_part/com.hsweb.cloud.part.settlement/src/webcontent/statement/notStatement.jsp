    ...
    <table style="width:100%;">
        <tr>
            <td style="white-space:nowrap;">
                ...
                <span class="separator"></span>
                <a class="nui-button" iconCls="" plain="true" onclick="addStatement()"><span class="fa fa-check fa-lg"></span>&nbsp;生成对账单</a>
                <a class="nui-button" iconCls="" plain="true" onclick="addToStatement()"><span class="fa fa-mail-reply fa-lg"></span>&nbsp;添加到已有对账单</a>
