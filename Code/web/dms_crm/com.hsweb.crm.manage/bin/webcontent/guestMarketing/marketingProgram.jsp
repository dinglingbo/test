...
<body>
 ...
 <div class="nui-toolbar" style="padding:0px;">
    <table style="width:100%;">
        <tr>
            <td style="width:100%;">
                <a class="nui-button" iconCls="" plain="true" onclick="onOk"><span class="fa fa-toggle-right fa-lg"></span>&nbsp;推送</a>
 ...
 <div class="nui-toolbar" style="padding:0px;border-bottom:0;">
   ...
   <div class="nui-fit">
    ...
    <div property="columns">
      ...
      <div field="" name="" width="80" headerAlign="center" header="类别"></div>
      <div field="" name="" width="80" headerAlign="center" header="字数"></div>
      <div field="" name="" width="80" headerAlign="center" header="短信内容"></div>
      <div field="" name="" width="80" headerAlign="center" header="短信来源"></div>
      <div field="" name="" width="80" headerAlign="center" header="创建人"></div>
      <div field="" name="" width="80" headerAlign="center" header="创建日期"></div>
    </div>
  </div>
...
<script type="text/javascript">
   nui.parse();
    ...
    function check(e) {
        $('.m').find('.check').removeClass('weui-icon-checked');
...
$(data.rows).each(function(k,v) {
  ...
  '<div class="quan-item quan-d-item quan-item-acoupon m">\n' +
  ...
  '</div><span id="check" class="check"></span></div></div>';
});
