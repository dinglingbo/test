...
<body>
    ...
    <div class="nui-fit" id="form1" >
        ...
        valueField="customid" textField="name" value="011401" enabled="false" visible="false">
        <table class="tmargin" style="width:100%;padding:0px 20px 0px 0px;line-height:30px;" >
            <tr class="htr">
