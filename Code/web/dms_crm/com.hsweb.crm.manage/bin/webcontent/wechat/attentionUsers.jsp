...
<body>
 ...
 <div class="nui-fit">
    ...
    <div property="columns">
        ...
        <div field="" name="" width="80" headerAlign="center" header="分销商类型"></div>
        <div field="" name="" width="80" headerAlign="center" header="客户名称"></div>
        <div field="" name="" width="80" headerAlign="center" header="手机"></div>
        <div field="" name="" width="80" headerAlign="center" header="上级分销商"></div>
        <div field="" name="" width="80" headerAlign="center" header="等级"></div>
        <div field="" name="" width="80" headerAlign="center" header="分享统计" dateFormat="yyyy-MM-dd HH:mm"></div>
        <div field="" name="" width="80" headerAlign="center" header="关注时间" dateFormat="yyyy-MM-dd HH:mm"></div>
        <div field="" name="" width="80" headerAlign="center" header="取消关注时间" dateFormat="yyyy-MM-dd HH:mm"></div>
        ...
        <div field="" name="" width="80" headerAlign="center" header="积分" ></div>
    </div>
</div>
