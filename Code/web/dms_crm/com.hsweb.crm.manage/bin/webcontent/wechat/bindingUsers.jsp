...
<body>
 ...
 <div class="nui-fit">
    ...
    <div property="columns">
        ...
        <div field="" name="" width="80" headerAlign="center" header="最近位置分析"></div>
        <div field="" name="" width="80" headerAlign="center" header="绑定时间" dateFormat="yyyy-MM-dd HH:mm"></div>
        <div field="" name="" width="80" headerAlign="center" header="最近使用" dateFormat="yyyy-MM-dd HH:mm"></div>
    </div>
</div>
