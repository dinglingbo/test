...
<body>
 ...
 <div class="nui-fit">
    ...
    <div property="columns">
        ...
        <div field="" name="" width="80" headerAlign="center" header="单据时间" dateFormat="yyyy-MM-dd HH:mm"></div>
        ...
        <div field="" name="" width="80" headerAlign="center" header="单号"></div>
        <div field="" name="" width="80" headerAlign="center" header="单据类型"></div>
