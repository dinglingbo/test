...
<body>
        ...
        <table style="width:100%;">
            <tr>
                <td>
                   ...
                   <label>城市：</label>
                   <input class="nui-textbox" name="" id="" enabled="true"/>
                   <div id="" name="" class="nui-checkbox" readOnly="false" text="一级" ></div>
                   <div id="" name="" class="nui-checkbox" readOnly="false" text="二级" ></div>
   ...
   <div class="nui-fit">
    ...
    <div property="columns">
        ...
        <div field="" name="" width="80" headerAlign="center" header="ID"></div>
        <div field="" name="" width="80" headerAlign="center" header="微信ID"></div>
        <div field="" name="" width="80" headerAlign="center" header="昵称"></div>
        <div field="" name="" width="80" headerAlign="center" header="性别"></div>
        <div field="" name="" width="80" headerAlign="center" header="省份"></div>
        <div field="" name="" width="80" headerAlign="center" header="城市"></div>
