  ...
  <div class="nui-toolbar" style="padding:2px;border-bottom: 0" id="queryForm">
   ...
   <div class="nui-fit">
    ...
    <div property="columns">
      ...
      <div field="" name="" width="80" headerAlign="center" header="订单类型"></div>
      <div field="" name="" width="80" headerAlign="center" header="订单号"></div>
      <div field="" name="" width="80" headerAlign="center" header="积分"></div>
      <div field="" name="" width="80" headerAlign="center" header="记录时间" dateFormat="yyyy-MM-dd HH:mm"></div>
      <div field="" name="" width="80" headerAlign="center" header="是否审核" ></div>
    </div>
  </div>
