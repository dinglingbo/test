...
<body>
 <div class="nui-toolbar" style="padding:0px;border-bottom:0;">
    <table style="width:100%;">
        <tr>
            <td style="width:100%;">
        <a class="nui-button"  plain="true" onclick="" id="add" enabled="true"><span class="fa fa-check fa-lg"></span>&nbsp;确定</a>
...
<div class="nui-fit">
    <table style="width:100%;">
        <tr>
            ...
            <td style=""><input class="nui-textbox" name="guestName" style="width: 100%"></td>
        ...
        <tr>
            ...
            <td colspan="3" style=""><input class="nui-textbox" name="carModel" style="width: 100%"></td>
        </tr>
    </table>
