  ...
  <div class="nui-toolbar" style="padding:2px;border-bottom: 0" id="queryForm">
   ...
   <div class="nui-fit">
    ...
    <div property="columns">
      ...
      <div field="" name="" width="80" headerAlign="center" header="意向级别"></div>
      <div field="" name="" width="80" headerAlign="center" header="回访时间" dateFormat="yyyy-MM-dd HH:mm"></div>
      <div field="" name="" width="80" headerAlign="center" header="计划回访时间" dateFormat="yyyy-MM-dd HH:mm"></div>
      <div field="" name="" width="80" headerAlign="center" header="回访内容"></div>
      <div field="" name="" width="80" headerAlign="center" header="计划回访内容"></div>
      <div field="" name="" width="80" headerAlign="center" header="客户反馈"></div>
    </div>
  </div>
