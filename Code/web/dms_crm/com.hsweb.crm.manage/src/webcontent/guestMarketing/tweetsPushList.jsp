  ...
  <div class="nui-toolbar" style="padding:2px;border-bottom: 0" id="queryForm">
   ...
   <div class="nui-fit">
    ...
    <div property="columns">
      ...
      <div field="" name="" width="80" headerAlign="center" header="推送标题"></div>
      <div field="" name="" width="80" headerAlign="center" header="推送人"></div>
      <div field="" name="" width="80" headerAlign="center" header="类型"></div>
      <div field="" name="" width="80" headerAlign="center" header="用户类型"></div>
