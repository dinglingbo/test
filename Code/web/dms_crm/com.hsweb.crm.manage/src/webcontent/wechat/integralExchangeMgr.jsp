  ...
  <div class="nui-toolbar" style="padding:2px;border-bottom:0;" id="queryForm">
    <table style="width:100%;">
      <tr>
        <td>
         ...
         <li class="separator"></li>
         <a class="nui-button" iconCls="" plain="true" onclick="" id=""><span class="fa fa-check fa-lg"></span>&nbsp;审核通过</a>
         <a class="nui-button" iconCls="" plain="true" onclick="" id=""><span class="fa fa-times fa-lg"></span>&nbsp;审核不通过</a>
   ...
   <div class="nui-fit">
    ...
    <div property="columns">
      ...
      <div field="" name="" width="80" headerAlign="center" header="分销商级别"></div>
      <div field="" name="" width="80" headerAlign="center" header="分销商组别"></div>
      <div field="" name="" width="80" headerAlign="center" header="联系人"></div>
      <div field="" name="" width="80" headerAlign="center" header="手机"></div>
      <div field="" name="" width="80" headerAlign="center" header="兑换积分"></div>
      <div field="" name="" width="80" headerAlign="center" header="兑换RMB"></div>
      <div field="" name="" width="80" headerAlign="center" header="申请时间" dateFormat="yyyy-MM-dd HH:mm"></div>
      <div field="" name="" width="80" headerAlign="center" header="操作时间" dateFormat="yyyy-MM-dd HH:mm"></div>
