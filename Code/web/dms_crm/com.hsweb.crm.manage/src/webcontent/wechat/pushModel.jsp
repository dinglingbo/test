...
<body>
 ...
 <div class="nui-fit">
    ...
    <div property="columns">
        ...
        <div field="" name="" width="80" headerAlign="center" header="模板名称"></div>
        <div field="" name="" width="80" headerAlign="center" header="模板编号"></div>
        <div field="" name="" width="80" headerAlign="center" header="模板说明"></div>
        <div field="" name="" width="80" headerAlign="center" header="提醒对象"></div>
        <div field="" name="" width="80" headerAlign="center" header="更新时间" dateFormat="yyyy-MM-dd HH:mm"></div>
