...
<body>
  ...
  <div class="nui-fit">
    <div id="business" dataField="list" class="nui-datagrid" style="width: 100%; height: 100%;" multiSelect="false"
      ...
      <div property="columns">
        ...
        <div field="" headerAlign="center" allowSort="true" width="150px">代办项目名称</div>
        <div field="" headerAlign="center" allowSort="true" width="150px">拼音码</div>
        <div field="" headerAlign="center" allowSort="true" width="150px">代办金额</div>
  ...
  <script type="text/javascript">
    ...
    function edit(e) {
      ...
      nui.open({
        url: webPath + contextPath + '/page/car/daibanxiangmu_det.jsp',
        title: tit,
        width: 400,
        height: 210,
        onload: function () {
