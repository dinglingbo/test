...
<body>
    ...
    <table class="table" id="table1">
        <tr>  
            <td class="tbtext">套餐名称<input  class="nui-textbox tabwidth" /></td> 
            <td class="tbCtrl" ></td>
            <td class="tbtext">有效期 <input  class="nui-combobox tabwidth" />月</td> 
            <td class="tbCtrl"></td>
            <td class="tbtext">售价 <span style="color: red;">0</span>元</td> 
