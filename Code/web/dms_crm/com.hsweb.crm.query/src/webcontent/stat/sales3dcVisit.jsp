...
-->
<head>
<title>售后3dc回访统计</title>
    <meta http-equiv="content-type" content="text/html; charset=UTF-8" />
    <%@include file="/common/sysCommon.jsp" %>
    <script src="<%=crmDomain%>/query/stat/js/sales3dcVisit.js?v=1.0" type="text/javascript"></script> 
</head>
<body>
        ...
        <div id="dgGrid" class="nui-datagrid" style="width:100%;height:100%;"
            ...
            <div property="columns">
                ...
                <div headerAlign="center"><strong>合计</strong>
                    <div property="columns">
                        <div field="name" width="30" headerAlign="center" summaryType="sum" allowSort=false>结算车次</div>
