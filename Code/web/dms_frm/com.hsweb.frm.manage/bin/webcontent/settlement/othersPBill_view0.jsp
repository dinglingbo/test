                ...
                <table style="width:100%;">
                    <tr>
                        <td >
                            ...
                            <label >审核状态：</label>
                            <input class="nui-combobox" id="auditSign" name="auditSign" value="0" nullitemtext="请选择..." emptyText="审核状态" onvalidation="refresh()" data="auditSignList" width="70px" />
            ...
            <div class="nui-fit">
                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="guestName" name="guestName" summaryType="count" width="150" headerAlign="center" header="往来单位名称"></div>
                        <div field="carNo" name="carNo"  summaryType="count" width="100" headerAlign="center" header="车牌号"></div>
                        ...
                        <div field="billTypeCode" headerAlign="center" width="150" visible="false" header="收支项目编码"></div>
                        <div field="rpAmt" width="70" summaryType="sum" headerAlign="center" header="应付">
                          <input property="editor" vtype="float" class="nui-textbox"/>
                        </div>
                        <div field="remark" width="150" headerAlign="center" header="备注">
                            <input property="editor" class="nui-textbox"/>
                        </div>
                        <div field="auditSign" width="80" headerAlign="center" header="是否审核"></div>
                        <div field="auditor" name="auditor"  width="80" headerAlign="center" header="审核人"></div>
                        <div allowSort="true" field="auditDate" width="150" headerAlign="center" header="审核日期" dateFormat="yyyy-MM-dd HH:mm"></div>
                        <div field="settleStatus" width="80" headerAlign="center" header="结算状态"></div>
                        <div field="rpBillId" width="150" headerAlign="center" header="应付单单号"></div>
                        <div allowSort="true" field="createDate" width="150" headerAlign="center" visible="false" dateFormat="yyyy-MM-dd HH:mm"></div>
