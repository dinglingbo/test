...
<head>
<title>其他应收单</title>
<script src="<%=webPath + contextPath%>/manage/settlement/js/othersRBill.js?v=2.0.6"></script>
            ...
            <div class="nui-fit">
                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="carNo" name="carNo" summaryType="count" width="100" heaerAlign="center" header="车牌号"></div>
                        ...
                        <div field="billTypeCode" headerAlign="center" width="100"  visible="false" header="收支项目编码"></div>
                        <div field="rpAmt" width="70" summaryType="sum" headerAlign="center" header="应收">
