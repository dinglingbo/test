...
<head>
<title>内部转账单</title>
<script src="<%=webPath + contextPath%>/frm/js/settle/internalTransfer.js?v=1.0.2"></script>
<style type="text/css">
.title {
  width: 60px;
  text-align: right;
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="white-space:nowrap;">
                            ...
                            <input class="nui-combobox" id="postStatus" name="postStatus" value="0" nullitemtext="请选择..." emptyText="审核状态" data="auditSignList" width="70px" />
            ...
            <div class="nui-fit">
                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="toAccountCode" headerAlign="center"   header="" visible="false"></div><!--  visible="false"-->
                        <div field="toSettAccountName" headerAlign="center"  header="" visible="false"></div><!--  visible="false"-->
                        ...
                        <div field="settAccountCode" headerAlign="center"  visible="false" header=""></div><!--  visible="false"-->
                        ...
                        <div field="itemTypeCode" headerAlign="center" header="费用科目编码" visible="false"></div><!--  -->
