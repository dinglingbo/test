...
<script
	src="<%=webPath + sysDomain%>/frm/js/arap/advanceInReceive.js?v=1.0"
							...
							<div header="订单信息" headerAlign="center">
								<div property="columns" width="10">
									...
									<div field="recordDate" allowSort="true" headerAlign="center"
										dateFormat="yyyy-MM-dd HH:mm:ss" width="70">销售顾问</div>
									<div field="recorder" allowSort="true" headerAlign="center"
										width="70">订车日期</div>
									<div field="recordDate" allowSort="true" headerAlign="center"
										dateFormat="yyyy-MM-dd HH:mm:ss" width="70">预交车日期</div>
							...
							<div header="车型信息" headerAlign="center">
								<div property="columns" width="10">
									...
									<div field="recorder" allowSort="true" headerAlign="center"
										width="70">品牌</div>
									<div field="recordDate" allowSort="true" headerAlign="center"
										dateFormat="yyyy-MM-dd HH:mm:ss" width="70">类别</div>
									<div field="recorder" allowSort="true" headerAlign="center"
										width="70">规格</div>
									<div field="recordDate" allowSort="true" headerAlign="center"
										dateFormat="yyyy-MM-dd HH:mm:ss" width="70">外观颜色</div>
									<div field="recordDate" allowSort="true" headerAlign="center"
										dateFormat="yyyy-MM-dd HH:mm:ss" width="70">内饰颜色</div>
									<div field="recordDate" allowSort="true" headerAlign="center"
										dateFormat="yyyy-MM-dd HH:mm:ss" width="70">配置</div>
