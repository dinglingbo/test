...
-->
		...
		<body>
			...
			<div class="nui-fit">
					...
					<table style="width: 100%;">
						<tr>
							<td style="white-space: nowrap;">
								<a class="nui-button" plain="true" iconCls="" onclick="addGuest()" id="addGuestBtn">
									<span class="fa fa-plus fa-lg"></span>&nbsp;新 增</a>
								<a class="nui-button" plain="true" iconCls="" onclick="deleteGuest()" id="deleteGuestBtn">
									<span class="fa fa-remove fa-lg"></span>&nbsp;删除</a>
								<a class="nui-button" iconCls="" plain="true" onclick="save()" id="saveBtn">
									<span class="fa fa-save fa-lg"></span>&nbsp;保存</a>
								<a class="nui-button" iconCls="" plain="true" onclick="audit()" id="auditBtn">
									<span class="fa fa-check fa-lg"></span>&nbsp;审核</a>
								...
								<input class="nui-datepicker" id="beginDate" allowInput="false" width="100px" format="yyyy-MM-dd"
								 showTime="false" showOkButton="false" showClearButton="false" />
								...
								<input class="nui-combobox" id="postStatus" name="postStatus" value="0" nullitemtext="请选择..." emptyText="审核状态"
								 data="auditSignList" width="70px" />
								<span class="separator"></span>
								<a class="nui-button" iconCls="" plain="true" onclick="refresh()">
				...
				<div class="nui-fit">
					<div id="mainGrid" class="nui-datagrid" style="width: 100%; height: 100%;" showPager="true" dataField="detailList" ondrawcell="onDrawCell"
					 idField="id" showSummaryRow="true" allowCellSelect="true" allowCellEdit="true" oncellcommitedit="onCellCommitEdit" showModified="false"
					 multiSelect="true" oncellbeginedit="OnrpMainGridCellBeginEdit" pageSize="1000" sizeList="[500,1000,2000]" url="">
						<div property="columns">
							...
							<div field="settAccountId" type="comboboxcolumn" width="100" headerAlign="center" header="结算账户">
								<input property="editor" enabled="true" id="balaAccountList" name="list" data="accountList" class="nui-combobox" valueField="id"
								 textField="name" onvaluechanged="onAccountValueChanged" url="" emptyText="" vtype="required" />
							</div>
							...
							<div field="settAccountName" type="comboboxcolumn" width="100" headerAlign="center" header="费用科目">
								<input property="editor" enabled="true" id="billTypeList" name="list" data="IClist" dataField="list" class="nui-combobox"
								 valueField="id" onvaluechanged="onbillTypeChange" textField="name" url="" emptyText="" vtype="required" />
							</div>
							<div field="billTypeCode" headerAlign="center" visible="false" header="费用科目编码"></div>
							<div field="rpAmt" width="60" summaryType="sum" headerAlign="center" header="支出金额">
