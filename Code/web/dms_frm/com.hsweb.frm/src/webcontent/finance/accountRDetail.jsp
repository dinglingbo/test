    ...
    <div class="nui-fit">
        <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" 
            ...
            <div property="columns">
                ...
                <div field="shortName" name="shortName" width="100"  headeralign="center" allowsort="true">客户名称</div>
                <div field="carNo" name="carNo" width="100"  headeralign="center" allowsort="true">车牌号</div>
                <div field="charOffAmt" name="charOffAmt" width="80" summaryType="sum" headeralign="center" allowsort="true">收款金额</div>
                <div field="feeService" name="feeService" width="80" summaryType="sum" headeralign="center" allowsort="true" >手续费</div>
                <div field="trueInoutAmt" name="trueInoutAmt" width="80" summaryType="sum" headeralign="center" allowsort="true">实收金额 </div>
                <div field="remark" name="remark" width="120"  headeralign="center" allowsort="true">收款备注</div>
                <div field="auditor" name="auditor" width="80"  headeralign="center" allowsort="true">收款人</div>
                <div field="auditDate" name="auditDate" width="140" dateFormat="yyyy-MM-dd HH:mm" headeralign="center" allowsort="true">收款日期</div>
