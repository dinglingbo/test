...
var queryUrl = baseUrl
		+ "com.hsapi.frm.setting.queryFibInComeExpenses.biz.ext";
var mainGrid = null;
var disableEl = null;
...
var deleteUrl = baseUrl
		+ "com.hsapi.frm.setting.deleteFibInComeExpenses.biz.ext";
function deleteType(){
...
function showEditModal(row, newRow, type){
	...
	nui.open({
		url: "com.hsweb.frm.arap.fiInComeExpensesEdit.flow",
		title: title,
		width: "500px",
		height: "250px",
        allowDrag:true,
