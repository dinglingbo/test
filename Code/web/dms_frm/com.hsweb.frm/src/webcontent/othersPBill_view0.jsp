...
<head>
<title>其他应付单</title>
<script src="<%=webPath + contextPath%>/frm/js/settle/othersPBill.js?v=1.6.4"></script>
                ...
                <table style="width:100%;">
                    <tr>
                        <td style="white-space:nowrap;">
                            ...
                            <input class="nui-combobox" id="billStatus" name="billStatus" value="0" nullitemtext="请选择..." emptyText="审核状态" data="billStatus" width="70px" />
