...
<head>
<title>其他收入单</title>
<script src="<%=webPath + contextPath%>/frm/js/settle/othersReceive.js?v=1.0.3"></script>
<style type="text/css">
.title {
  width: 60px;
  text-align: right;
            ...
            <div class="nui-fit">
                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div allowSort="true" field="recordDate" width="60" headerAlign="center" visible="false" dateFormat="yyyy-MM-dd H:mm:ss"></div>
