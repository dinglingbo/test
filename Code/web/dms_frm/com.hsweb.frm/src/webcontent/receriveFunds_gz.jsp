...
<script src="<%=webPath + sysDomain%>/frm/js/arap/receive.js?v=1.0"
			...
			<div style="padding: 5px;">
				...
				<table>
					...
					<tr>
						...
						<td><input class="nui-datepicker width2M" enabled="false" name="recordDate"  format="yyyy-MM-dd HH:mm:ss"/></td>
