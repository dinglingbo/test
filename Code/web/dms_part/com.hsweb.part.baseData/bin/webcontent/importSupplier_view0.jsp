...
<script src="<%=webPath + contextPath%>/baseDataPart/js/importJs/importSupplier.js?v=1.0.11"></script>
<style type="text/css">
/*.a-upload {
    padding: 4px 10px;
    height: 20px;
	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
	                ...
	                <a style="text-decoration: none;color: #2779aa;" plain="true" href="<%=request.getContextPath() %>/repair/RepairBusiness/template/supplier.xlsx" download="供应商导入模板"><span class="fa fa-arrow-down fa-lg"></span>下载模板</a>
