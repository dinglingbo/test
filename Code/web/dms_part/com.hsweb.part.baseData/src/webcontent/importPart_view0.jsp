...
<script src="<%=webPath + contextPath%>/baseDataPart/js/importJs/importPart.js?v=1.0.4"></script>
<style type="text/css">
/*.a-upload {
    padding: 4px 10px;
    height: 20px;
	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
					...
					<a class="nui-button" plain="true" href="<%=request.getContextPath() %>/repair/RepairBusiness/template/importPart.xlsx"><span class="fa fa-arrow-down fa-lg"></span>下载模板</a>
				</td>
	        </tr>
	    </table>
	</div>
