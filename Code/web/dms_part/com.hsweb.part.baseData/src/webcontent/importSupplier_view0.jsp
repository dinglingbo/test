	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
	                ...
	                <a class="nui-button" plain="true" href="<%=request.getContextPath() %>/repair/RepairBusiness/template/supplier.xlsx" download="供应商导入模板"><span class="fa fa-arrow-down fa-lg"></span>下载模板</a>
