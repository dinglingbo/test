...
var saveStraUrl =baseUrl + "com.hsapi.part.baseDataCrud.crud.savePartMatching.biz.ext";
function onSaveNode(){
...
function selectPart(callback, checkcallback) {
    nui.open({
        ...
        onload : function() {
            ...
            iframe.contentWindow.setCloudPartData("partMatch",callback,checkcallback);
        },
...
var saveUnifyUrl = baseUrl + "com.hsapi.part.baseDataCrud.crud.savePartMatchIngDetail.biz.ext";
