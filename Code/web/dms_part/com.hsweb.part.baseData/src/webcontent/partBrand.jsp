...
-->
		...
		<head>
			...
			<style type="text/css">
				...
				.car_type_menu ul {
					width: 718px;
					height: 55px;
					background: url(../images/car_type_menu.png) no-repeat;
					margin: 0 auto;
				}
		...
		<body>
			<div class="popbox" id="popbox_1" id="carinfo">
			<div class="car_type">
				<div style="width: 860px; height: auto; overflow: hidden; margin: 0 auto;" class="carbandxz">
					<div style="margin-bottom: 10px;overflow: auto;">
						<div class="car_type_band">
							<div class="header">
