...
<head>
<title>配件管理</title>
<script src="<%=webPath + contextPath%>/baseDataPart/js/partMgr/partMgr.js?v=1.0.18"></script>
<style type="text/css">
</style>
</head>
<body>
                        ...
                        <div id="partGrid" class="nui-datagrid" style="width:100%;height:100%;"
                            ...
                            <div property="columns">
                                ...
                                <div header="" headerAlign="center">
                                    <div property="columns">
                                        <div allowSort="true" field="spec" width="100px" headerAlign="center" allowSort="true">规格</div>
