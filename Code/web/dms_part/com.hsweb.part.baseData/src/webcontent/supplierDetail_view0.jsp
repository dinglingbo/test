...
<head>
<title>供应商资料</title>
<script src="<%=webPath + contextPath%>/baseDataPart/js/supplierMgr/supplierDetail.js?v=1.1.6"></script>
<style type="text/css">
.title {
	text-align: right;
                  ...
                  <div class="vpanel_body vpanel_bodyww">
                      ...
                      <table class="tmargin">
                          <tr class="htr">
                              ...
                              <td ><input id="shortName" name="shortName" width="100%" class="nui-textbox" maxLength="20" ></td>
                          </tr>
                          <tr class="htr">
