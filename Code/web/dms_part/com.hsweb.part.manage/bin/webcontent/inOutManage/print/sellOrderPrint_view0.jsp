...
<%
	...
	String fileAddr = "";
	if(auditSign == 0){
		fileAddr = request.getSession().getServletContext().getRealPath("") +"/manage/inOutManage/iReport/unaudit/sellOrderReport.jasper";
	}else{
		fileAddr = request.getSession().getServletContext().getRealPath("") +"/manage/inOutManage/iReport/audit/sellOrderReport.jasper";
	}
	//String fileAddr = request.getSession().getServletContext().getRealPath("") +"/purchase/iReport/sellOrderReport.jasper";
