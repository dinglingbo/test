...
<head>
<title>盘亏出库查询</title>
<script src="<%=webPath + contextPath%>/manage/js/inOutManage/stockCheckOut/stockCheckOutQuery.js?v=2.0.0"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
    ...
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="serviceId" width="160" summaryType="count" headerAlign="center" header="盘亏单号"></div>
