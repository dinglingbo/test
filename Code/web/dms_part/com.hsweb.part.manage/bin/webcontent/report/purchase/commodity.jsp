<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 allowCellEdit="true" allowCellSelect="true" multiSelect="true" 
    ...
    <div property="columns">
        ...
        <div field="menulabel" width="100" headerAlign="center" allowSort="true">品牌编码</div> 
        
        <div field="menulabel" width="100" headerAlign="center" allowSort="true">品牌名称</div> 
