...
<head>
    ...
    <script src="<%=webPath + contextPath%>/manage/js/inOutManage/basic/initSettleAccountBala.js?v=2.0.4"></script>
...
<body>
    ...
    <div id="mainGrid" class="nui-treegrid" style="width:100%;height:100%;" dataField="settleAccount"  url="" 
        ...
        <div property="columns">
            ...
            <div field="initBalance" numberFormat="0.0000" width="80" headerAlign="center" header="期初金额">
