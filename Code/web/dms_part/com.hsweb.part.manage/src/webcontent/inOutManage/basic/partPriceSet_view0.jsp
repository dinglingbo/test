...
<head>
    ...
    <script src="<%=webPath + contextPath%>/manage/js/inOutManage/basic/settleAccountSet.js?v=2.0.1"></script>
    <style type="text/css">
    body {
        margin: 0;
        padding: 0;
...
<body>
    ...
    <div id="mainGrid" class="nui-treegrid" style="width:100%;height:100%;" dataField="settleAccount"  url="" 
        ...
        <div property="columns">
            ...
            <div field="operateDate" name="operateDate" width="80" dateFormat="yyyy-MM-dd hh:MM:ss"  headeralign="center" >最近修改日期</div>
