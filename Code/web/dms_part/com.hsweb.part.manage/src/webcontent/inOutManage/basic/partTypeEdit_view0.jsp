...
<head>
<title>新增分类</title>
<script src="<%=webPath + contextPath%>/manage/js/inOutManage/basic/partTypeEdit.js?v=2.0.3"></script>
<style type="text/css">
.title {
    width: 90px;
    text-align: right;
        ...
        <div id="editForm" class="form">
            ...
            <table class="tmargin">
                ...
                <tr class="htr">
                    ...
                    <td ><input id="parentId" name="parentId" width="100%" class="nui-combobox" textField="name" valueField="id"   popupHeight="80%"  dataField="" url="" valueFromSelect="true" allowinput="true"></td>
                </tr>
            </table>
