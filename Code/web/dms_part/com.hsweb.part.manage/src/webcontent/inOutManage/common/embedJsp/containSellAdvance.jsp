...
<head>
<title>销售车</title>
<script src="<%=webPath + contextPath%>/manage/js/inOutManage/common/embedJsp/containSellAdvance.js?v=2.0.0"></script>
<style type="text/css">
.table-label {
	text-align: right;
}
        ...
        <table style="width:100%;">
            <tr>
                <td style="white-space:nowrap;">
                    ...
                    <input class="nui-textbox" emptyText="车型" width="80" id="search-applyCarModel" name="applyCarModel"/>
