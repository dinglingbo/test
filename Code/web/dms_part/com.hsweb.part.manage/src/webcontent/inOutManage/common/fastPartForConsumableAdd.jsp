...
<title>领料出库</title>
    ...
    <script src="<%=webPath + contextPath%>/manage/js/inOutManage/common/fastPartForConsumableAdd.js?v=1.0.33"></script>
    <style type="text/css">
...
<div class="nui-fit">
	...
	<!-- 			<td><input class="nui-textbox" id="" name="" type="text"></td> -->
			...
			<tr id="out">
				...
				<td>出库数量:<input required="true"  vtype="int;range:1,100000000" class="nui-textbox" id="outQty" name="outQty" type="text"></td>
			</tr>
			<tr id="out">
