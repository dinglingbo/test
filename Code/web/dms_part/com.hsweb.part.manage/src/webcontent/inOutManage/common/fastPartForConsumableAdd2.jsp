...
<title>领料出库</title>
    ...
    <script src="<%=webPath + contextPath%>/manage/js/inOutManage/common/fastPartForConsumableAdd2.js?v=1.1.19"></script>
    <style type="text/css">
...
<div class="nui-fit">
	...
	<!-- 			<td><input class="nui-textbox" id="" name="" type="text"></td> -->
			...
			<tr id="return"><td>请输入数量及归库人:</td></tr>
			<tr id="return">
				<td style="padding-left: 14px;">归库人:
				...
				<td>归库数量:<input required="true" valid="int" class="nui-textbox" id="outReturnQty" name="outReturnQty" type="text"></td>
			</tr>
			<tr id="return">
				<td style="" colspan="2">归库原因:<input required="true"  class="nui-textarea" id="returnRemark" name="returnRemark" type="text" ></td>
			</tr id="return">
