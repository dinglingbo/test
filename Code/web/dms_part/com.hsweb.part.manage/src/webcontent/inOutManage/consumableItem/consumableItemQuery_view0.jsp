        ...
        <div property="columns">
            ...
            <div header="销售信息" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" field="createDate" headerAlign="center" header="出库日期" dateFormat="yyyy-MM-dd H:mm:ss"></div>
            ...
            <div header="其他" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" field="auditDate" headerAlign="center" header="出库日期" dateFormat="yyyy-MM-dd H:mm:ss"></div>
                </div>
            </div>
        </div>
    </div>
