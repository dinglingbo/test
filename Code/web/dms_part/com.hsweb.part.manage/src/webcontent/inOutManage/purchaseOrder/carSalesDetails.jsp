...
<head>
<title>厂家订货详情</title>
<script src="<%=webPath + contextPath%>/manage/js/inOutManage/purchaseOrder/carSalesDetails.js?v=1.0.3"></script>
<style type="text/css">
.title {
  width: 60px;
  text-align: right;
...
<body>
    <%@include file="/manage/inOutManage/purchaseOrder/carSalesDetail.jsp" %>
