                    ...
                    <div id="rightGrid" class="nui-datagrid" 
                        ...
                        <div property="columns">
                            <div type="indexcolumn">序号</div>
                                    ...
                                    <div field="" numberFormat="0.0000" width="60" headerAlign="center" header="运费">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div>                                    
                                    <div field="" summaryType="sum" numberFormat="0.0000" width="60" headerAlign="center" header="指导销价">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div>
                                    <div field="" numberFormat="0.0000" width="60" headerAlign="center" header="购车订金">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div> 
                                    <div field="" summaryType="sum" numberFormat="0.0000" width="60" headerAlign="center" header="销售底价">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div> 
                                    <div field=""  width="60" headerAlign="center" header="入库仓库">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div> 
                                    <div field=""  width="60" headerAlign="center" header="货位">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div>   
                                    <div field=""  width="60" headerAlign="center" header="车架号（VIN）">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div>   
                                    <div field=""  width="60" headerAlign="center" header="发动机号">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div>   
                                    <div field=""  width="60" headerAlign="center" header="合格证号">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div>
                                    <div field=""  width="60" headerAlign="center" header="商检单号">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div> 
                                    <div field=""  width="60" headerAlign="center" header="关单号">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div>  
                                    <div field=""  width="60" headerAlign="center" header="钥匙号">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div>  
                                    <div field=""  width="60" headerAlign="center" header="提单号">
                                      <input property="editor" vtype="float" class="nui-textbox"/>
                                    </div> 
									<div field=""  align="center" headerAlign="center" dateFormat="yyyy-MM-dd HH:ss" allowSort="true">出厂日期</div>    
									<div field=""  align="center" headerAlign="center" dateFormat="yyyy-MM-dd HH:ss" allowSort="true">生产日期</div>  									                                                                                                                                                                                                                                                                                                                                                                                                                         
