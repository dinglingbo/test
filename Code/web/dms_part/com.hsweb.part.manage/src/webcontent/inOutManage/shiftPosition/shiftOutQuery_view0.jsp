...
<head>
<title>移仓出库查询</title>
<script src="<%=webPath + contextPath%>/manage/js/inOutManage/shiftPosition/shiftOutQuery.js?v=2.0.0"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
    ...
    <table style="width:100%;">
        <tr>
            <td style="white-space:nowrap;">
                ...
                <input id="serviceId" width="120px" emptyText="移仓出库单号" class="nui-textbox"/>
        ...
        <div property="columns">
            ...
            <div header="移仓信息" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" field="outDate" headerAlign="center" header="移仓日期" dateFormat="yyyy-MM-dd H:mm:ss"></div>
                    ...
                    <div allowSort="true" field="storeId" width="60" headerAlign="center" header="移出仓库"></div>
                    <div allowSort="true" field="receiveStoreId" width="60" headerAlign="center" header="移入仓库"></div>
                    <div allowSort="true" field="receiveStoreShelf" width="60" headerAlign="center" header="移入仓位"></div>
                </div>
            </div>
