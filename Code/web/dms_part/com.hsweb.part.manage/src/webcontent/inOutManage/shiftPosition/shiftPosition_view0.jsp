...
<head>
<title>移仓管理</title>
<script src="<%= request.getContextPath() %>/manage/js/inOutManage/shiftPosition/shiftPosition.js?v=2.0.0"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
	        ...
	        <div title="移仓出库列表" class="nui-panel"
                ...
                <div id="leftGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="serviceId" headerAlign="center" width="160" header="移仓单号"></div>
