...
<head>
<title>盘亏出库</title>
<script src="<%=webPath + contextPath%>/manage/js/inOutManage/stockCheckOut/stockCheckOut.js?v=2.0.0"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
	        ...
	        <div title="盘亏出库列表" class="nui-panel"
                ...
                <div id="leftGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div field="serviceId" headerAlign="center" width="160" header="盘亏单号"></div>
