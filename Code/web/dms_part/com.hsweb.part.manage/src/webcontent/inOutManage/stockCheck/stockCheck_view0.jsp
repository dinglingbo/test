...
<head>
<title>盘点单</title>
<script src="<%=webPath + contextPath%>/manage/js/inOutManage/stockCheck/stockCheck.js?v=1.1.11"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
                ...
                <div id="leftGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                      <div type="indexcolumn">序号</div>
                        <div field="createDate" width="60" headerAlign="center" dateFormat="yyyy-MM-dd H:mm:ss" header="盘点日期"></div>
