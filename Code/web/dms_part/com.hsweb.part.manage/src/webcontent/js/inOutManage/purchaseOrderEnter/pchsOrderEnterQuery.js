...
var rightGridUrl = partApiUrl+"com.hsapi.part.invoice.paramcrud.queryPjPchsOrderEnterDetailChkList.biz.ext";
...
//多级表头类型
		setInitExportData( detail,rightGrid.columns,"采购入库明细表导出");
//单级表头类型  与上二选一
