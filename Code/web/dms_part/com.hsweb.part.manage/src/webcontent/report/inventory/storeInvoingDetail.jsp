...
<head>
    <title>仓库进销存明细</title>
    <script src="<%=webPath + contextPath%>/manage/js/report/storeInvoingDetail.js?v=1.0.11"></script>
    <style type="text/css">
    .title {
      width: 60px;
      text-align: right;
        ...
        <tr>
            <td style=" width:55%;">
               ...
               <span class="separator"></span>
               	仓库: <input  showNullItem="false"  id="storehouse" name="storehouse" dataField="storehouse" allowInput="false" class="nui-combobox" valueField="id" textField="name" data="storehouse">
        ...
        <div header="配件信息" headerAlign="center">
            <div property="columns">
                ...
                <div allowSort="true" field="partName" width="150" headerAlign="center" header="配件名称"></div>
   				...
   				<div allowSort="true" field="operateDate" width="150" headerAlign="center" dateFormat ="yyyy-MM-dd H:mm:ss" format="yyyy-MM-dd H:mm:ss" header="操作日期"></div>
            </div>
        </div>
