...
<script src="<%=webPath + contextPath%>/purchasePart/js/allotApply/allotApplyInQuery.js?v=1.0.0"></script>
<style type="text/css">
.title {
	width: 90px;
	text-align: right;
    ...
    <table style="width:100%;">
        <tr>
            <td style="white-space:nowrap;">
				...
				<label style="font-family:Verdana;">到货日期 从：</label>
    ...
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="其他" headerAlign="center">
                    <div property="columns">
                    <div field="orderMan" width="70" headerAlign="center" header="申请人"></div>
                    <div allowSort="true"  width="120"field="planComeDate" headerAlign="center" header="计划到货日期" dateFormat="yyyy-MM-dd HH:mm"></div>
                    <div allowSort="true"  width="120"field="comeDate" headerAlign="center" header="实际到货日期" dateFormat="yyyy-MM-dd HH:mm"></div>
                </div>
            </div>
        </div>
    </div>
