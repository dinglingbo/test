...
<!-- 
  - Author(s): chenziming
  - Date: 2018-02-07 16:35:54
  - Description:
-->
<head>
<title>jsp auto create</title>
<script src="<%=webPath + contextPath%>/purchasePart/js/purchaseReturn/purchaseOutAnalysis.js?v=1.0.2"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
        ...
        <table style="width:100%;">
            <tr>
                <td style="white-space:nowrap;">
                    ...
                    <a class="nui-button" iconCls="" plain="true" onclick="quickSearch(12)" id="type12">本季</a>
                    <a class="nui-button" iconCls="" plain="true" onclick="quickSearch(13)" id="type13">上季</a>
                    <span class="separator"></span>
