...
<head>
<title>采购退货</title>
<script src="<%=webPath + contextPath%>/purchasePart/js/purchaseReturn/purchaseReturn.js?v=1.0.2"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
                    ...
                    <div property="columns">
                        ...
                        <div header="配件信息" headerAlign="center">
                            <div property="columns">
                                ...
                                <div allowSort="true" datatype="int" field="outQty" width="40" headerAlign="center" header="数量" align="right" summaryType="sum"></div>
                            </div>
                        </div>
                        <div header="退货信息" headerAlign="center">
                            <div property="columns">
                                ...
                                <div allowSort="true" datatype="float" field="sellAmt" width="40" headerAlign="center" header="金额" align="right" summaryType="sum"></div>
                            </div>
                        </div>
