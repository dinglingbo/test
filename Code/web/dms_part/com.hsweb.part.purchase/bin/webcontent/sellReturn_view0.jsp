...
<head>
<title>销售退货</title>
<script src="<%=webPath + contextPath%>/purchasePart/js/sellMgr/sellReturn.js?v=1.0.12"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
                    ...
                    <div property="columns">
                        ...
                        <div header="金额信息" headerAlign="center">
                            <div property="columns">
                                ...
                                <div allowSort="true" datatype="float" field="suggestAmt" width="40" headerAlign="center" header="金额" summaryType="sum"></div>
                            </div>
                        </div>
