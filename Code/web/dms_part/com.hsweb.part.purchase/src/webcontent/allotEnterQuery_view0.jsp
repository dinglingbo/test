...
<head>
<title>调拨入库查询</title>
<script src="<%= request.getContextPath() %>/purchase/js/allotMgr/allotEnterQuery.js?v=1.0.0"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
    ...
    <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div header="" headerAlign="center">
                <div property="columns">
                    <div field="enterId" width="100" headerAlign="center" header="调拨单号"></div>
            ...
            <div header="数量单价" headerAlign="center">
                <div property="columns">
                    <div field="enterQty" width="40" headerAlign="center" header="入库数量"></div>
            ...
            <div header="其他" headerAlign="center">
                <div property="columns">
                    <div field="guestFullName" width="60" headerAlign="center" header="调出公司"></div>
