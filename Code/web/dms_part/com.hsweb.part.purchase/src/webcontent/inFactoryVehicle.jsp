...
<script src="<%=webPath + contextPath%>/purchasePart/js/inventoryMgr/inFactoryVehicle.js?v=1.0.49"></script>
               ...
               url="">
				...
				<div type="indexcolumn" width="40" >序号</div>
                  <div header="工单信息" headerAlign="center">
	                  ...
	                  <div field="mtAdvisor" name="mtAdvisor" width="80" headerAlign="center" header="服务顾问" allowsort="true"></div>
	                 </div>
                  </div>
