...
<head>
<title>盘亏出库</title>
<script src="<%= request.getContextPath() %>/purchasePart/js/inventoryMgr/inventoryLoss.js?v=1.0.11"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
            ...
            <div title="出库单列表" class="nui-panel"
                ...
                <div id="leftGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        <div field="outCode" headerAlign="center" header="出库单号" allowSort="true"></div>
                ...
                <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;"
                    ...
                    <div property="columns">
                        ...
                        <div header="数量金额信息" headerAlign="center">
                            <div property="columns">
                                <div field="outQty" width="40" headerAlign="center" header="数量" align="right" allowSort="true" dataType="float" summaryType="sum"></div>
                                <div field="sellUnitPrice" width="40" headerAlign="center" header="单价" align="right" allowSort="true" dataType="float"></div>
                                <div field="sellAmt" width="40" headerAlign="center" header="金额" align="right" allowSort="true" dataType="float" summaryType="sum"></div>
                            </div>
                        </div>
