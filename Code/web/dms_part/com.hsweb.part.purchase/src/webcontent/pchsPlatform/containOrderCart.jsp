...
<head>
<title>采购车/销售车</title>
<script src="<%=webPath + contextPath%>/purchasePart/js/pchsPlatform/containOrderCart.js?v=1.0.1"></script>
<style type="text/css">
.table-label {
	text-align: right;
}
        ...
        <table style="width:100%;">
            <tr>
                <td style="white-space:nowrap;">
                    ...
                    <span class="separator"></span>
                    <a class="nui-button" iconCls="" visible="true" id="pchsOrderBtn" plain="true" onclick="generatePchsOrder()"><span class="fa fa-plus fa-lg"></span>&nbsp;生成采购订单</a>
