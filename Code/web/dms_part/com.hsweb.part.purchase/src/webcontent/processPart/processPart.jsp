    	...
    	function ontopTabChanged(e){
			...
			if(!url){
				if(name == "partAssembly"){
					mainTabs.loadTab(webPath + contextPath + "/purchasePart/processPart/partAssembly.jsp", tab);
				}else if(name == "partSplit"){
					mainTabs.loadTab(webPath + contextPath + "/purchasePart/processPart/partSplit.jsp", tab);		
				}
			}
