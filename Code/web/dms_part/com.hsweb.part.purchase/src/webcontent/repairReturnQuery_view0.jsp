...
<!-- 
  - Author(s): chenziming
  - Date: 2018-03-07 18:08:59
  - Description:
-->
<head>
<title>维修退货查询</title>
<script src="<%= request.getContextPath() %>/purchasePart/js/repairMgr/repairReturnQuery.js?v=1.0.0"></script>
<style type="text/css">
.title {
	width: 60px;
	text-align: right;
        ...
        <div property="columns">
            ...
            <div header="业务信息" headerAlign="center">
                <div property="columns">
                    ...
                    <div allowSort="true" field="appCarModel" width="60" headerAlign="center" header="车型"></div>
            ...
            <div header="车辆信息" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="partCode" width="60" headerAlign="center" header="业务单号"></div>
                    <div allowSort="true" field="partName" headerAlign="center" header="车牌号"></div>
                    <div allowSort="true" field="partBrandId" width="60" headerAlign="center" header="维修顾问"></div>
                </div>
            </div>
            <div header="领料信息" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="partCode" width="60" headerAlign="center" header="领料日期" dateFormat="yyyy-MM-dd"></div>
                    <div allowSort="true" field="partName" headerAlign="center" header="领料人"></div>
                </div>
            </div>
            <div header="成本信息" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" datatype="float" field="costUnitPrice" width="60" headerAlign="center" header="成本单价"></div>
                    <div allowSort="true" datatype="float" field="costAmt" width="60" headerAlign="center" header="成本金额"></div>
                </div>
            </div>
            ...
            <div header="归库信息" headerAlign="center">
                <div property="columns">
                    <div allowSort="true" field="partCode" width="60" headerAlign="center" header="归库日期" dateFormat="yyyy-MM-dd"></div>
                    <div allowSort="true" field="partName" headerAlign="center" header="归库标志"></div>
    ...
    <div id="advancedSearchForm" class="form">
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td colspan="3">
                    <input class="nui-textbox" emptyText="" width="100%" name="outCode"/>
                </td>
            </tr>
            <tr>
                <td class="title">车牌号：</td>
                <td colspan="3">
                    <input class="nui-textbox" emptyText="" width="100%" name="carCode"/>
                </td>
            </tr>
            <tr>
