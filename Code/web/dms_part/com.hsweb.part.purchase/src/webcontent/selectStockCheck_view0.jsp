...
<head>
<title>盘点单选择</title>
<script src="<%= request.getContextPath() %>/purchasePart/js/inventoryMgr/selectStockCheck.js?v=1.0.3"></script>
<style type="text/css">
.table-label {
	text-align: right;
}
...
<div class="nui-fit" >
    <div id="partGrid" class="nui-datagrid" style="width:100%;height:100%;"
        ...
        <div property="columns">
            ...
            <div allowSort="true" field="checkDate" width="80" headerAlign="center" allowSort="true" dateFormat="yyyy-MM-dd H:mm:ss">盘点日期</div>
