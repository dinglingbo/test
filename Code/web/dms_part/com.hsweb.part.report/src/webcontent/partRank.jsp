...
<div class="nui-fit">
    ...
    <div>
        供应商<input class="nui-textbox" style="width:20%">&nbsp;&nbsp;
        采购方式<input class="nui-combobox" style="width:10%" data="data1" value="1">&nbsp;&nbsp;
        <a class="nui-button" iconcls="" id="" name="" onclick="">查询</a>
        <span>采购金额合计</span> <span style="color:rgb(102, 255, 0)">好多钱</span>
    </div>
    <div class="nui-fit">
    ...
    var data1 = [{ id: "1", text: "对外采购" }, { id: "2", text: "对内采购（调拨）" }, { id: "3", text: "所有" }];
    	nui.parse();
    </script>
</body>
</html>