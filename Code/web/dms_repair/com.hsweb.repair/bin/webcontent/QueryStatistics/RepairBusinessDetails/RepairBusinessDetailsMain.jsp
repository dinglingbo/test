...
<head>
<title>维修营业明细</title>
<script src="<%=request.getContextPath()%>/repair/js/RepairBusinessDetails/RepairBusinessDetailsMain.js?v=1.0.3"></script>
<style type="text/css">
.form_label {
	width: 72px;
	text-align: right;
    ...
    <div id="datagrid1" class="nui-datagrid" style="width: 100%; height: 100%;"
        ...
        <div property="columns">
            ...
            <div header="辅助信息" headerAlign="center">
                <div property="columns">
                    <div field="orgid" headerAlign="center" allowSort="true" visible="true" width="60px">分店名称</div>
                    <div field="serviceCode" headerAlign="center" allowSort="true" visible="true" width="100px">工单号</div>
                    <div field="cardNo" headerAlign="center" allowSort="true" visible="true" width="60px">客户卡号</div>
                    <div field="carNo" headerAlign="center" allowSort="true" visible="true" width="60px">车牌号</div>
                    <div field="mtAdvisor" headerAlign="center" allowSort="true" visible="true" width="60px">维修顾问</div>
                    <div field="serviceCard" headerAlign="center" allowSort="true" visible="true" width="60px">接车卡号</div>
                </div>
            </div>
            <div header="基本信息" headerAlign="center">
                <div property="columns">
                    ...
                    <div field="mtType" headerAlign="center" allowSort="true" visible="true" width="60px">维修类型</div>
                    <div field="insureCompCode" headerAlign="center" allowSort="true" visible="true" width="60px">投保公司</div>
                    <div field="sureMtDate" headerAlign="center" allowSort="true" visible="true" width="80px" dateFormat="yyyy-MM-dd">维修日期</div>
            ...
            <div header="维修费用" headerAlign="center">
                <div property="columns">
                    ...
                    <div field="accruedExpensesRemark" headerAlign="center" allowSort="true" visible="true" width="100px">预提说明</div>
                </div>
            </div>
            ...
            <div header="毛利数据" headerAlign="center">
                <div property="columns">
                    ...
                    <div field="grossProfitRemark" headerAlign="center" allowSort="true" visible="true" width="150px">毛利备注</div>
                </div>
            </div>
        </div>
    </div>
