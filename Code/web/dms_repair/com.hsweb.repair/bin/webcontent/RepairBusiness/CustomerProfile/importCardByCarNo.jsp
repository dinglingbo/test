...
<script src="<%=webPath + contextPath%>/repair/RepairBusiness/Reception/js/importCardByCarNo.js?v=1.1.2"></script>
<style type="text/css">
/*.a-upload {
    padding: 4px 10px;
    height: 20px;
...
<body>
	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
	                ...
	                <a style="text-decoration: none;color: #2779aa;" plain="true" href="<%=request.getContextPath() %>/repair/RepairBusiness/template/cardByCarNo.xls" download="按车牌号导入储值卡模板"><span class="fa fa-arrow-down fa-lg"></span>下载模板</a>
				</td>
	        </tr>
	    </table>
	</div>
    ...
    <div id="advancedTipWin" class="nui-window"
        title="未成功导入储值卡" style="width:400px;height:200px;"
        showModal="true"
        allowResize="false"
        allowDrag="true">
