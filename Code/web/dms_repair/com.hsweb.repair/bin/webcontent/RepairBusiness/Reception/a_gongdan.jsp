...
<body>
    ...
    <table > 
        ...
        <tr>   
            ...
            <td colspan="5" class="tbCtrl">￥0.00 = 公司费小计：￥0.00 + 材料费小计：￥0.00 +附加费小计：￥0.00</td>
           <td class="tbtext">历史欠款</td> 
            <td class="tbCtrl"><label>￥</label></td>
        </tr>
        <tr>   
            <td class="tbtext">实收总计</td> 
            <td colspan="5" class="tbCtrl">￥6.45  计次/套餐/会员卡冲销</td>

        </tr>
        <tr>   
            <td class="tbtext">未收金额</td> 
            <td colspan="5" class="tbCtrl">￥1300.00  </td>
    ...
    <div style="width:100%;margin-top: 10px;text-align: center;">
        ...
        <a class="nui-button" onclick=""   plain="false" >备注</a>
