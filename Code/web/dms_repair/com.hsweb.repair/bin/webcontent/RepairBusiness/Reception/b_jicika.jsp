    ...
    <div class="nui-fit">
       <table  style=" left:0;right:0;margin: 0 auto;"> 
          <tr>   
            ...
            <td class="tbtext">适用范围</td> 
            <td class="tbCtrl"><input  class="nui-textbox tabwidth" /></td>
        </tr>
        <tr>   
            <td class="tbtext">会员价</td> 
            <td class="tbCtrl"><input  class="nui-textbox tabwidth" /></td>
            <td class="tbtext">总价值</td> 
            <td class="tbCtrl"><input  class="nui-textbox tabwidth" /></td>

        </tr>
            <td class="tbtext">有效期</td> 
            <td class="tbCtrl" colspan="3"><input  class="nui-textbox tabwidth" /></td>
            <td class="tbtext"><div id="" name="" class="mini-checkbox" text="永久有效" ></div></td> 
    ...
    <div>
        <div id="datagrid1" class="nui-datagrid" showPager="false">
            <div property="columns">
                ...
                <div field="" width="100" headerAlign="center" align="center">次数</div>
