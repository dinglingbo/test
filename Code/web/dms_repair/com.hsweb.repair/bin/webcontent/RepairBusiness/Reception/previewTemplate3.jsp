    ...
    <div class="printny">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="160" valign="top">
                    <div class="fl">
                        <p style="font-size:30px; font-family:'黑体';" id="spstorename">结算单</p>
                       <!--  <p style="font-size:16px; padding-top:3px;">Detailed Account</p> -->
                    </div>
                </td>
                <td>
                    <div class="fr" style="text-align:center;">
                        <p style="font-size:24px;" id="comp">测试店12</p>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ybk" style="margin-top:15px;">
                <tr>
                    <td colspan="2" rowspan="2" valign="top">
                        <div class="hctop_left" style="float:none; padding:8px; width:auto"><em>顾客资料：</em><span class="font16" style="margin:0 30px 0 10px;" id="guestFullName">李XX</span><span class="font16" id="mobile">13838XXXX138</span></div>
                        <!-- <div style="padding-left:8px;">(Customer)</div> -->
                    </td>
                    <td width="36%"><div class="hctop_right"><em>工单号：</em></div><div class="hctop_right" id="serviceCode">ZHD10060119070400001</div></td>
                </tr>
                <tr>
                    <td><div class="hctop_right"><em>进厂时间：</em></div><div class="hctop_right" id="enterDate">2019-07-04 16:35</div></td>
                </tr>
                <!-- <tr>
                    <td><div class="hctop_left"><em>出车日期：</em><br />Date Of Prdctn.</div><div class="hctop_right" id="outDate"></div></td>
                </tr> -->
                <tr>
                    <td width="23%"><div class="hctop_right" style="width:85px;"><em>车牌号：</em></div><div class="hctop_right" id="carNo">湘AXXXXX</div></td>
                    <td colspan="1"><div class="hctop_right" style="width:85px;"><em>品牌车型：</em></div><div class="hctop_right" id="carModel">上海大众 波罗</div></td>
                     <td colspan="1" ><div class="hctop_right" style="width:110px"><em>车架号(VIN)：</em></div><div class="hctop_right" id="carVin">LSVFAXXXXXXXXXXXX
                     </div></td>
                    
                    
                </tr>
                <tr>
                    <td><div class="hctop_right"><em>进厂里程：</em></div><div class="hctop_right" id="enterKilometers">10000</div></td>
                    <td><div class="hctop_right"><em>进厂油量：</em></div><div class="hctop_right" id="enterOilMass">3/4</div></td>
                    <td><div class="hctop_right"><em>服务顾问：</em></div><div class="hctop_right" id="mtAdvisor">宜XX</div></td>
               </tr>
        ...
        <div class="hctable">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="showPkg">
                ...
                <tr>
                    ...
                    <td align="right"><span id="prdtSub">198.00</span>&nbsp;</td>
                </tr>
                </table>
                ...
                <tr>
                    ...
                    <td align="right"><span id="itemSub">210.00</span>&nbsp;</td>
                </tr>
                </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="showPart">
                <tr class="title">
                    <td width="40" rowspan="2" align="center" style="border-top-style:none">序号</td>
                ...
                <tr>
                    ...
                    <td align="right"><span id="partSub">665.00</span>&nbsp;</td>
                </tr>
            </table>
        </div>
        ...
        <div class="hctable">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td height="28" align="right" class="font15">&yen;<span id="prdt">198.00</span></td>
                    <td align="right" class="font15">&yen;<span id="item">210.00</span></td>
                    <td align="right" class="font15">&yen;<span id="part">665.00</span></td>
                   ...
                   <!--  <td align="right" class="font15">&yen;0.00&nbsp;</td> --> 
                    <td align="right" class="font15" colspan="2">&yen;<span id="totalAmt">1073.00</span></td>
                </tr>
                <tr>
                    <td height="28" colspan="2" align="left" class="font15">项目优惠率：<span id="itemRate">4.55</span>%</td>
                    <td colspan="2" align="left" class="font15">项目优惠金额：&yen;<span id="itemAmt">10.00</span></td>
                    <td colspan="2" align="left" class="font15" width="22%">配件优惠率：<span id="partRate">5.00</span>%</td>
                    <td  align="left" class="font15">配件优惠金额：&yen;<span id="partAmt">35.00</span></td>
                </tr>
                 <tr>
                    <td height="28" align="center"><span class="hei16">优惠金额</span></td>
                    <td colspan="8" align="right"><div id="yh" class="hei16">207.00</div></td>
                </tr>
                <tr>
                    <td height="28" align="center"><span class="hei16">结算金额</span></td>
                    <td colspan="8" align="right"><div id="cash1" class="hei16">1073.00</div></td>
                </tr>
                <tr>
                    <td height="28" align="center"><span class="hei16">金额大写</span></td>
                    <td colspan="8" align="right"><div id="money" class="hei16"></div>壹仟零柒拾叁元</td>
                </tr>
                <tr>
                    <td height="45" colspan="8" valign="top" style="padding:5px;">
                        <div style="text-align:left; min-height:20px; padding:5px; border-bottom:1px #000 solid; margin-bottom:5px;">
                            <span class="hei" style="font-size:14px">出车报告：</span><span id="drawOutReport">这是出车报告详情</span>
                        </div>
                        <div style="padding:10px;" class="hei16"></div>
                    </td>
                </tr>
                <tr>
                    <td height="60" colspan="2" class="hei16" style="padding-left:8px;"><span id="makeMan">制单：李XX</span></td>
