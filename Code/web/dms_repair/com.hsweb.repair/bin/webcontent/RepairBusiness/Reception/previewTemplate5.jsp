 ...
 <div class="popbox" style="height:420px; width:480px; margin:-210px 0 0 -240px; display:none">
    ...
    <div class="printny">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="50%">
                    <p style="font-size:36px;"><span id="spstorename">结算单</span></p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p style="font-size:13px; line-height:140%;">
                        <span class="font16" id="guestFullName"></span>李XX<span class="font16" id="mobile">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;13838XXXX138</span><br />
                        <span id="contactorAddress">江苏省徐州市鼓楼区XXX8栋</span>
                    </p>
                </td>
                <td align="center" valign="top">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="padding-bottom:10px;">
                                    <p style="font-size:18px; font-family:'黑体'; margin-bottom:10px;"><span id="comp">测试12店</span></p>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ybk">
                        ...
                        <tr>
                            ...
                            <td align="center"><span id="date">2019-07-15 12:11</span></td>
                        </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="100" rowspan="2" style="line-height:150%;">
                        <p><span class="fr"><span id="prdt">198.00</span></span>套餐</p>
                        <p><span class="fr"> <span id="item">210.00</span></span>工时</p>
                        <p><span class="fr"><span id="part">665.00</span></span>配件</p>
                    ...
                    <td width="130" rowspan="2" style="line-height:150%;">
                        <p><span class="fr"><span id="itemRate">4.55</span>%</span>项目优惠率</p>
                        <p><span class="fr"><span id="itemAmt">10.00</span></span>项目优惠金额</p>
                        <p><span class="fr"><span id="partRate">5.00</span>%</span>配件优惠率</p>
                        <p><span class="fr"><span id="partAmt">35.00</span></span>配件优惠金额</p>
                        <p><span class="fr"><span id="yh">207.00</span></span>总优惠</p>
                        <!-- <p><span class="fr">8.00</span>总费用折扣</p> -->
                    </td>
                    <td rowspan="2" align="center" >
                    <b>总计：<span id="cash1">1073.00</span></b><br>
                ...
                <tr>
                    <td valign="top">出车报告：&nbsp;<span id="drawOutReport">这是出车报告详情</span></td>
                </tr>
            </table>
        </div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:15px;">
            <tr>
                ...
                <td width="43%" rowspan="2" style="padding-left:5px;" valign="top">
                    地址：<span id="guestAddr">广东省东莞市市辖区长安镇新安街口麦 园工业区1号</span><br />
                  
                    电话：<span id="phone">131XXXXXX05</span>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="30">
                                    ...
                                    <img alt="" src="<%= request.getContextPath() %>/repair/imag/comp.png" id="showImg2"  width="24" style="margin-bottom:10px;">
                            </td>
                            <td></td>
                        </tr>
                    </table>
