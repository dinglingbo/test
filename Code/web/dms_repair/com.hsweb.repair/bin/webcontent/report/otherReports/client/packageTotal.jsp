            ...
            <div title="剩余套餐明细表">
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td>
                                    ...
                                    <input class="nui-textbox" style="widows: 100px;" emptyText="项目">
                                    <input class="nui-textbox" style="widows: 100px;" emptyText="套餐名称">
                                    <input class="nui-textbox" style="widows: 100px;" emptyText="门店">
                                    <input class="nui-combobox" style="widows: 100px;" emptyText="是否永久有效">
                    ...
                    <div class="nui-fit">
                        ...
                        <div property="columns">
                          ...
                          <div field="" name="" width="100" headerAlign="center" align="center">套餐名称</div>
                          <div field="" name="" width="100" headerAlign="center" align="center">数量</div>
                          <div field="" name="" width="100" headerAlign="center" align="center">套餐单价</div>
                          <div field="" name="" width="100" headerAlign="center" align="center">限制车牌号</div>
                          <div field="" name="" width="100" headerAlign="center" align="center">来源</div>
            ...
            <div title="剩余套餐统计表">
                    ...
                    <div class="nui-toolbar" style="padding:2px;" id="">
                        ...
                        <div class="nui-fit">
                            ...
                            <div property="columns">
                                <div field="id" name="id" visible="false" width="100" >id</div>
                              <div type="indexcolumn" width="40" headerAlign="center" align="center">类型</div>
                              <div field="" name="" width="100" headerAlign="center" align="center">名称</div>
                              <div field="" name="" width="100" headerAlign="center" align="center">数量</div>
                          </div>
                          </div>
                    ...
                    <div class="nui-toolbar" style="padding:2px;" id="">
                            <table style="width:100%;">
                                <tr>
                                    <td>
                                        ...
                                        <input class="nui-textbox" style="widows: 100px;" emptyText="车牌号">
                                        <input class="nui-combobox" style="widows: 100px;" emptyText="是否永久有效">
                                        <input class="nui-combobox" style="widows: 100px;" emptyText="客户">
                                        <input class="nui-combobox" style="widows: 100px;" emptyText="项目">
                                        <input class="nui-combobox" style="widows: 100px;" emptyText="套餐名称">
                                        <input class="nui-combobox" style="widows: 100px;" emptyText="销售人员">
                                        <input class="nui-combobox" style="widows: 100px;" emptyText="门店">
                                        最近消费时间:
                                        <input class="nui-datepicker" id="startDate3" name="startDate2" dateFormat="yyyy-MM-dd" style="width:100px" />
                                        至
                                        <input class="nui-datepicker" id="endDate3" name="endDate2" dateFormat="yyyy-MM-dd" style="width:100px" />
                        ...
                        <div class="nui-fit">
                            ...
                            <div property="columns">
                              ...
                              <div field="" name="" width="100" headerAlign="center" align="center">名称</div>
                              <div field="" name="" width="100" headerAlign="center" align="center">套餐名称</div>
                              <div field="" name="" width="100" headerAlign="center" align="center">总数量</div>
                              <div field="" name="" width="100" headerAlign="center" align="center">剩余数量</div>
                              <div field="" name="" width="100" headerAlign="center" align="center">已消费数量</div>
                              <div field="" name="" width="100" headerAlign="center" align="center">套餐单价</div>
                              <div field="" name="" width="100" headerAlign="center" align="center">有效期</div>
