...
<body>
            ...
            <table style="width:100%;">
                <tr>
                    <td>
                        ...
                        <input class="nui-textbox" style="widows: 100px;" emptyText="消费项目">
                        <input class="nui-textbox" style="widows: 100px;" emptyText="消费类型">
                        <input class="nui-textbox" style="widows: 100px;" emptyText="单据日期">
                        <input class="nui-textbox" style="widows: 100px;" emptyText="是否优惠">
                        <input class="nui-textbox" style="widows: 100px;" emptyText="卡号">
                        <a class="nui-button" plain="true" onclick="" id="query" enabled="true"><span class="fa fa-search fa-lg"></span>&nbsp;查询</a>
                        <li class="separator"></li>
                        <a class="nui-button" plain="true" onclick="" id="query" enabled="true"><span class="fa fa-search fa-lg"></span>&nbsp;查看详情</a>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="nui-fit">
            ...
            <div property="columns">
              ...
              <div field="" name="" width="100" headerAlign="center" align="center">消费流水编号</div>
              <div field="" name="" width="100" headerAlign="center" align="center">关联单据编号</div>
              <div field="" name="" width="100" headerAlign="center" align="center">客户姓名</div>
              <div field="" name="" width="100" headerAlign="center" align="center">卡号</div>
              ...
              <div field="" name="" width="100" headerAlign="center" align="center">支付方式</div>
              <div field="" name="" width="100" headerAlign="center" align="center">是否优惠</div>
              <div field="" name="" width="100" headerAlign="center" align="center">消费时间</div>
              <div field="" name="" width="100" headerAlign="center" align="center">备注</div>
              <div field="" name="" width="100" headerAlign="center" align="center">类型</div>
              <div field="" name="" width="100" headerAlign="center" align="center">状态</div>
