...
<body>
            ...
            <table style="width:100%;">
                <tr>
                    <td>
                        ...
                        <input class="nui-textbox" style="widows: 100px;" emptyText="车牌号">
                        <input class="nui-textbox" style="widows: 100px;" emptyText="客户">
                        <input class="nui-textbox" style="widows: 100px;" emptyText="工单号">
                        <input class="nui-textbox" style="widows: 100px;" emptyText="工单类型">
        ...
        <div class="nui-fit">
                ...
                <div property="columns">
                  ...
                  <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">工单号</div>
                  ...
                  <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">客户</div>
                  <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">支付人</div>
                  <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">工单类型</div>
                  <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">维修类型</div>
                  <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">工单金额</div>
                  <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">优惠项目&nbsp;
                        ...
                        <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">工时费</div>
                        <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">材料费</div>
                        ...
                        <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">成本
                                &nbsp;
                                <span class="fa fa-question-circle fa-lg iconStyle" style="margin-top: 3px;"
                                onmouseover="overShow(this,con8)" onmouseout="outHide()"></span>
                                <div property="columns">
                                        <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">配件成本</div>
                                        <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">外包成本</div>
                                    </div>
                        </div>
                        ...
                        <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">备注</div>
                        <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">技师</div>
                        <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">门店</div>
                        <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">收银员</div>
                        <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">质检时间</div>
              </div>
              </div>
              </div>
