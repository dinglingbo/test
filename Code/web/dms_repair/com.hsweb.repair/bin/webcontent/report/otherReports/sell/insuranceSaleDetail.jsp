...
<body>
            ...
            <table style="width:100%;">
                <tr>
                    <td>
                        ...
                        <input class="nui-textbox" style="widows: 100px;" emptyText="保险公司">
                        <input class="nui-textbox" style="widows: 100px;" emptyText="接待人员">
                        <input class="nui-textbox" style="widows: 100px;" emptyText="销售人员">
                        保险生效日期:
                        <input class="nui-datepicker" id="startDateRecord" name="startDate" dateFormat="yyyy-MM-dd" style="width:100px" />
                        至
                        <input class="nui-datepicker" id="endDateRecord" name="endDate" dateFormat="yyyy-MM-dd" style="width:100px" />
        ...
        <div class="nui-fit">
                ...
                <div property="columns">
                  ...
                  <div field="" name="" width="100" headerAlign="center" align="center">单据编号</div>
                  <div field="" name="" width="100" headerAlign="center" align="center">车牌号</div>
                  <div field="" name="" width="100" headerAlign="center" align="center">保险公司</div>
                  <div field="" name="" width="100" headerAlign="center" align="center">商业险</div>
                  <div field="" name="" width="100" headerAlign="center" align="center">交强险</div>
                  <div field="" name="" width="100" headerAlign="center" align="center">车船税</div>
                  <div field="" name="" width="100" headerAlign="center" align="center">总金额</div>
                  <div field="" name="" width="100" headerAlign="center" align="center">余额支付</div>
                  <div field="" name="" width="100" headerAlign="center" align="center">现金</div>
                  <div field="" name="" width="100" headerAlign="center" align="center">刷卡</div>
                  <div field="" name="" width="100" headerAlign="center" align="center">其他支付&nbsp;
                        ...
                        <div field="" name="" width="100" headerAlign="center" align="center">成本</div>
                        <div field="" name="" width="100" headerAlign="center" align="center">毛利</div>
                        <div field="" name="" width="100" headerAlign="center" align="center">生效日期</div>
                        <div field="" name="" width="100" headerAlign="center" align="center">单据日期</div>
                        <div field="" name="" width="100" headerAlign="center" align="center">接待</div>
                        <div field="" name="" width="100" headerAlign="center" align="center">销售</div>
                        <div field="" name="" width="100" headerAlign="center" align="center">结算时间</div>
