                        ...
                        <table style="width:100%;">
                            <tr>
                                <td>
                                    ...
                                    <input class="nui-combobox" style="widows: 100px;" emptyText="备注">
                                    金额范围:<input class="nui-combobox" style="widows: 50px;" >-
                                    <input class="nui-combobox" style="widows: 50px;" >
                                    单据日期:
                                    <input class="nui-datepicker" id="startDateRecord" name="startDate" dateFormat="yyyy-MM-dd"
                                        style="width:100px" />
                                    至
                                    <input class="nui-datepicker" id="endDateRecord" name="endDate" dateFormat="yyyy-MM-dd"
                                        style="width:100px" />
                    ...
                    <div class="nui-fit">
                        <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true"
                            ...
                            <div property="columns">
                                ...
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">工单编号</div>
                                ...
                                <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">配件优惠&nbsp;
                                      ...
                                      <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">接待</div>
                                      <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">操作员</div>
                                      <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">单据日期</div>
                                      <div field="carModel" name="carModel" width="100" headerAlign="center" align="center">所属门店</div>
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td>
                                    ...
                                    单据日期:
                                    <input class="nui-datepicker" id="startDate2" name="startDate" dateFormat="yyyy-MM-dd"
                                        style="width:100px" />
                                    至
                                    <input class="nui-datepicker" id="endDate2" name="endDate" dateFormat="yyyy-MM-dd"
                                    style="width:100px" />
                                    <a class="nui-button" plain="true" onclick="" id="query" enabled="true"><span class="fa fa-search fa-lg"></span>&nbsp;查询</a>
                                </td>
                            </tr>
                    ...
                    <div class="nui-fit">
                        <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true"
                            ...
                            <div property="columns">
                                ...
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">客户名称</div>
