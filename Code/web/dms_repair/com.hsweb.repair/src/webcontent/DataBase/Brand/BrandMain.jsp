			...
			<div>
				...
				<div class="nui-toolbar" 
					...
					<table style="width: 100%">
						<tr>
							<td style="width: 100%">
								<a class="nui-button" iconCls="icon-add" onclick="addModel()" plain="true">新增车型（N）</a>
								<a class="nui-button" iconCls="icon-edit" onclick="editModel()" plain="true">修改车型（M）</a> 
								<a class="nui-button" iconCls="icon-no" onclick="disableModel()" plain="true">禁用车型（C）</a>
