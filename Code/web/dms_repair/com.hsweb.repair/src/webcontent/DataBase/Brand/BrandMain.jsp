		...
		<table class="table" id="table1" style="height: 100%">
			<tr>
				<td><label style="font-family: Verdana;">快速查询：</label> <a
					...
					class="nui-button" plain="true" onclick="onSearch(2)">全部</a> <a
					class="nui-button" plain="true" onclick="onSearch(3)">同步品牌</a> <a
					class="nui-button" plain="true" onclick="onSearch(4)">同步车系</a> <a
					class="nui-button" plain="true" onclick="onSearch(5)">同步车型</a></td>
			</tr>
		</table>
