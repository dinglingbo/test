...
<script
	src="<%= request.getContextPath() %>/repair/js/DataBase/Brand/CarModelDetail.js?v=1.0.1"></script>
			...
			<table style="table-layout: fixed;" class="nui-form-table">
				<tr style="display: block; margin: 10px 0">
					...
					<td colspan="1"><input class="nui-textbox"
						name="model.carBrandName" width="280px" /></td>
				</tr>
				<tr style="display: block; margin: 10px 0">
					<td class="form_label" width="60px"><span
						style="color: #FF0000; margin-left: 15px;">厂商：</span></td>
					<td colspan="1"><input class="nui-textbox"
						name="model.carFactoryName" width="280px" /></td>
				</tr>
				<tr style="display: block; margin: 10px 0">
					<td class="form_label" width="60px"><span
						style="color: #FF0000; margin-left: 15px;">车系：</span></td>
					<td colspan="1"><input class="nui-textbox"
						name="model.carSeriesName" width="280px" /></td>
				</tr>
				<tr style="display: block; margin: 10px 0">
					<td class="form_label" width="60px"><span
						style="color: #FF0000; margin-left: 15px;">车型：</span></td>
					<td colspan="1"><input class="nui-textbox"
						name="model.carModel" width="280px" /></td>
				</tr>
			</table>
		</div>
	</fieldset>
