...
<head>
<title>维修项目</title>
<script src="<%= request.getContextPath() %>/repair/js/DataBase/Item/itemChoose.js?v=1.1.2" type="text/javascript"></script>
			...
			<div class="nui-fit">
				<div id="rightGrid"
					...
					<div property="columns" >
						...
						<div field="belonging" headerAlign="center" allowSort="true" width="60px">所属</div>
