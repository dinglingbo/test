			...
			<table class="table" id="table1" style="height: 100%;">
				...
				<tr style="display: block; margin:-4px 0 0 0">
	        	    ...
	        	    <td>
						...
						<a class="nui-button" plain="true" onclick="onSearch(0)" style="color:#0000FF"><u>按投保公司</u></a>
					</td>
				</tr>
			</table>
		</div>
			...
			<div property="columns">
				...
				<div header="维修费用" headerAlign="center">
					<div property="columns">
						...
						<div  field="" headerAlign="center" allowSort="true" visible="true" width="60px">预提费</div>
					</div>
				</div>
				...
				<div header="出单数据" headerAlign="center">
					<div property="columns">
