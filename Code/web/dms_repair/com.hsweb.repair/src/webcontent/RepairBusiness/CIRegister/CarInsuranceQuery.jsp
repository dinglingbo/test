        ...
        <table class="table" id="table1"> 
            ...
            <div class="nui-fit">
                ...
                <div property="columns">
                    ...
                    <div field="outDate" name="" width="70" headerAlign="center" header="结算日期" dateFormat="yyyy-MM-dd H:mm:ss"></div>
                    <div field="beginDate" name="" width="70" headerAlign="center" header="有效开始日期" dateFormat="yyyy-MM-dd H:mm:ss"></div>
                    <div field="endDate" name="" width="70" headerAlign="center" header="有效结束日期" dateFormat="yyyy-MM-dd H:mm:ss"></div>
