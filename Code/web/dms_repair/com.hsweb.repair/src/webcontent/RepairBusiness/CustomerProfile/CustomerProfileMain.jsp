			...
			<table class="table">
				<tr>
                    ...
                    <ul id="popupMenuStatus" class="nui-menu" style="display:none;">
                        ...
                        <li iconCls="" onclick="quickSearch(5)" id="type5">本月流失回厂</li>
                        <li iconCls="" onclick="quickSearch(6)" id="type6">上月流失回厂</li>
                    </ul>
...
<!-- 					<a class="nui-button" plain="true" iconCls="" onclick="importGuest()" id="importGuestBtn"><span class="fa fa-level-down fa-lg"></span>&nbsp;客户导入</a>
                	...
                	<a class="nui-button" iconCls="" id="carChangeBtn"	onclick="carChange()" plain="true"><span class="fa fa-edit fa-lg"></span>&nbsp;车辆变更</a>
					</td>
			</tr>
			</table>
		</div>
	...
	<div class="nui-fit">
		<div id="datagrid1" dataField="list" class="nui-datagrid" align="center"
			style="width: 100%; height: 100%;" pageSize="20"  allowcellwrap="true" onselectionchanged="selectionChanged"
			allowSortColumn="true" frozenStartColumn="0" frozenEndColumn="6" totalCount="page.count" virtualColumns="true">
			<div property="columns">
				...
				<div header="车辆信息" headerAlign="center">
					<div property="columns">
						...
						<div field="carModel" headerAlign="center"  width="120px">车型</div>
						<div field="vin" headerAlign="center" allowSort="true"
							visible="true" width="130px">车架号（VIN）</div>
				...
				<div header="客户信息" headerAlign="center">
					<div property="columns">
						...
						<div name="recorder" field="recorder" headerAlign="center"
							allowSort="true" visible="true" width="60px">建档人</div>
