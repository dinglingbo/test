...
<div class="nui-toolbar" style="padding:4px;border-bottom:0;" id="queryForm">
					...
					<a class="nui-button" plain="true" href="<%=request.getContextPath() %>/repair/RepairBusiness/template/phoneGuest.xlsx"><span class="fa fa-arrow-down fa-lg"></span>下载电销客户模板</a>
</div>
