...
<script src="<%=webPath + contextPath%>/repair/RepairBusiness/Reception/js/importTimesCard.js?v=1.0.5"></script>
<style type="text/css">
/*.a-upload {
    padding: 4px 10px;
    height: 20px;
	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
	               ...
	               <a class="nui-button" plain="true" href="<%=request.getContextPath() %>/repair/RepairBusiness/template/timesCard.xlsx" download="计次卡导入模板"><span class="fa fa-arrow-down fa-lg"></span>下载模板</a>
				</td>
	        </tr>
	    </table>
	</div>
