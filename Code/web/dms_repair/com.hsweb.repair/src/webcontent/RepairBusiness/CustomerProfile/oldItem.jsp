...
<script src="<%=webPath + contextPath%>/repair/RepairBusiness/Reception/js/oldItem.js?v=1.0.9"></script>
<style type="text/css">
	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
	               ...
	               <a class="nui-button" plain="true" href="<%=request.getContextPath() %>/repair/RepairBusiness/template/matainItem.xls"><span class="fa fa-arrow-down fa-lg"></span>下载工单项目模板</a>
				</td>
	        </tr>
	    </table>
	</div>
