...
<script src="<%=webPath + contextPath%>/repair/RepairBusiness/Reception/js/oldItem.js?v=1.1.0"></script>
<style type="text/css">
	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
	               ...
	               <a style="text-decoration: none;color: #2779aa;" plain="true" href="<%=request.getContextPath() %>/repair/RepairBusiness/template/matainItem.xls" download="工单项目导入模板"><span class="fa fa-arrow-down fa-lg"></span>下载模板</a>
				</td>
	        </tr>
	    </table>
	</div>
		...
		<div id="mainGrid" class="nui-datagrid" dataField="data" url="" showPager="false"
			...
			<div property="columns">
				<div type="indexcolumn" width="40px" header="序号"></div>
									...
									<div field="项目名称" headerAlign="center" allowSort="true" width="60px">
										*项目名称</div>
									<div field="项目单价" headerAlign="center" allowSort="true" width="60px">
										项目单价</div>
									<div field="项目小计" headerAlign="center" allowSort="true" width="100px">
										项目小计</div>
									<div field="维修员" headerAlign="center" allowSort="true" width="80px">
										维修员</div>
									<div field="销售员" headerAlign="center" allowSort="true" width="120px">
										销售员</div>
