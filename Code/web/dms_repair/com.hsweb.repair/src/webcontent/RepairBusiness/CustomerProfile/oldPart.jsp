	    ...
	    <table style="width:100%;">
	        <tr>
	            <td style="width:100%;">
	                ...
	                <a class="nui-button" plain="true" href="<%=request.getContextPath() %>/repair/RepairBusiness/template/matainPart.xls"><span class="fa fa-arrow-down fa-lg"></span>下载工单配件模板</a>
				</td>
	        </tr>
	    </table>
	</div>
