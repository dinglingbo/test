...
<div class="nui-fit">
    ...
    <div  id="contactorGrid" class="nui-datagrid"
      ...
      <div property="columns">
    	   ...
    	   <div field="name" headerAlign="center" allowSort="false" visible="true" width="100" header="姓名" align="center"></div>
           ...
           <div field="mobile" headerAlign="center" allowSort="false" visible="true" width="120" header="手机" align="center"></div>
