...
<body>
    <div class="nui-fit">
       <table style="left:0;right:0;margin: 0 auto;"> 
        <tr>   
            ...
            <td class="tbtext">预约时间</td> 
            <td class="tbCtrl"><input  class="nui-textbox tabwidth" /></td>

        </tr>
                <tr>   
            <td class="tbtext">预约内容</td> 
    ...
    <div>
        <div id="datagrid1" class="nui-datagrid" showPager="false">
            <div property="columns">
                ...
                <div field="" width="200" headerAlign="center" align="center">服务技师</div>
    ...
    <div>
        <div id="datagrid2" class="nui-datagrid" showPager="false">
            <div property="columns">
                ...
                <div field="" width="100" headerAlign="center" align="center">库存量</div>
                <div field="" width="100" headerAlign="center" align="center">自带</div>
                <div field="" width="100" headerAlign="center" align="center">删除</div>
            </div>
        </div>
    </div>
    ...
    <table > 
        <tr>   
            ...
            <td style="width: 700px" class="tbCtrl"  colspan="3"><input  class="nui-textarea tabwidth" style="height: 100px;"/></td>


        </tr>        
        <tr>   
            <td class="tbtext">订单备注</td> 
            <td style="width: 700px" class="tbCtrl" colspan="3"><input  class="nui-textarea tabwidth" style="height: 100px;"/></td>
        ...
        <tr>   
            <td class="tbtext">工时费小计</td> 
            <td  class="tbCtrl">￥0.00 + 材料费小计：￥0.00  + 附加费小计：￥0.00 </td>
     
        </tr>
                <tr>   
            <td class="tbtext">应收合计</td> 
            <td  class="tbCtrl">￥0.00 </td>
         <td class="tbtext">历史欠款</td> 
            <td  class="tbCtrl">￥0.00 </td>
