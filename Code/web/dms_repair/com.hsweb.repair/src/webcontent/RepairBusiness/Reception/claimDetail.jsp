...
<head>
    <title>理赔开单详情</title>
    <script src="<%=request.getContextPath()%>/repair/RepairBusiness/Reception/js/claimDetail.js?v=1.3.9"></script>
        ...
        <tr>            
            ...
            <td style="text-align:right;">
                ...
                <ul id="popupMenuMore" class="nui-menu" style="display:none;">
                    ...
                    <li iconCls="" onclick="outCarMainExpense()" id="billExpense">出车报告登记</li>
