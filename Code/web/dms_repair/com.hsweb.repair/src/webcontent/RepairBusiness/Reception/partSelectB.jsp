    ...
    function  savePartOut(data,childdata){
        if(data){
            ...
            for (var i = 0; i < data.length; i++) { 
                ...
                paramsData.guestName = mainRow.guestName;
                paramsData.carNo = mainRow.carNo;
                paramsData.carId = mainRow.carId;
                paramsData.vin = mainRow.vin;
