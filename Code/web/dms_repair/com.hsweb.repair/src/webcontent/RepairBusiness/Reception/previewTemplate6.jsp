            ...
            <tr>
                <td height="36" colspan="1" style="border:0px solid #DDD;padding: 8px;" rowspan="1" colspan="1" >
                   <!--  <div style="float: right; color: #000; margin-right: 12px; line-height: 36px;">
                       ...
                       套餐：<span id="prdt">360.00</span>&nbsp;&nbsp;&nbsp;&nbsp;项目：<span id="item">938.90</span>
             ...
             <tr>
                <td height="36" colspan="1" style="border:0px solid #DDD;padding: 8px;" rowspan="1" colspan="1" >
                      ...
                      <span> 优惠率：<span id="itemRate">2.60</span>%</span>
                      <span>&nbsp;&nbsp;&nbsp;&nbsp;优惠金额：<span id="itemAmt">25.10</span>元</span>
                    ...
                    <div style="float: right; color: #000; margin-right: 12px; line-height: 36px;">
                        <span style="margin-right: 15px;">
                            <font style="font-size: 13px; font-weight: bold;">
                                 优惠金额：<span id="yh">25.10</span>元
              
                &nbsp;&nbsp;&nbsp;结算金额：<span id="cash1">1298.90</span>元
                            </font>
                        </span>
                        <font style="font-size: 13px; font-weight: bold;">
                                                            大写：<span id="money" style="margin-right: 0px;">壹仟贰佰玖拾捌元玖角</span>
                        </font>
                    </div>
                </td>
            </tr>
