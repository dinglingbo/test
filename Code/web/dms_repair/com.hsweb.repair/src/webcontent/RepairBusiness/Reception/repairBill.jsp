...
<head>
    <title>综合开单详情</title>
    <script src="<%=request.getContextPath()%>/repair/js/RepairBusiness/Reception/repairBill.js?v=2.2.45"></script>
    ...
    <div style="text-align:center;" >
        <table border="0" align="center" cellpadding="0" cellspacing="0" >
            <tr>
                ...
                <td>
                     <a href="javascript:bindWechat()" id="showA"><span id="wechatTag" class="fa fa-wechat fa-lg"></span></a>&nbsp;
                    <!--  <a href="javascript:bindWechat()" id="showA1"><span id="wechatTag1" class="fa fa-wechat fa-lg"></span></a>&nbsp; -->
                ...
                <td>
                    <div >
                        <span id="carSellInfoEl" >
                            <a href="javascript:showSellPoint()" class="healthview" id="showSellEl" href="javascript:showSell()">销售机会(9)</a>&nbsp;
                        </span>
                    </div>
                </td>
            </tr>
