            ...
            <tr>
                ...
                <td align="center" valign="top">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ybk">
                        ...
                        <tr>
                            <td height="24" align="center" colspan="2">191****4243</td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:15px;">
            <tr>
                <td width="125" height="40" style="padding-left:5px; line-height:150%;">
                    <span class="hei">客户签字：</span><br />
                    Customer Signature:
                </td>
                <td><div style="width:70%; height:30px; border-bottom:1px #000 solid;"></div></td>
                <td width="90"><span class="hei">维修顾问签字：</span><br />SA Signature:</td>
                <td><div style="width:70%; height:30px; border-bottom:1px #000 solid;"></div></td>
                <td width="115"><span class="hei">收银员签字：</span><br />Cashier Signature:</td>
