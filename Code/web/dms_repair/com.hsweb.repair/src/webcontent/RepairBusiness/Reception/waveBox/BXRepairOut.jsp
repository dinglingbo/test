...
<!--         <div field="guestMobile" name="guestMobile" width="40" headerAlign="center" align="center">手机号码</div> -->
        <div field="carNo" name="carNo" width="80" headerAlign="center" align="center" visible="false">车牌号</div>
...
<script type="text/javascript">
    ...
    var gridUrl = baseUrl + "com.hsapi.repair.repairService.svr.qyeryMaintainListBX.biz.ext";
