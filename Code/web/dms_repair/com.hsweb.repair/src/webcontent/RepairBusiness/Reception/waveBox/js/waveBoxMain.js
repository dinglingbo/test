...
var mainGrid = null;
var mainGridUrl = baseUrl
		+ "com.hsapi.repair.repairService.svr.qyeryMaintainList.biz.ext";
// var itemGridUrl = baseUrl +
// "com.hsapi.repair.repairService.svr.getRpsItemQuoteByServiceId.biz.ext";
// var partGridUrl = baseUrl +
// "com.hsapi.repair.repairService.svr.getRpsPartByServiceId.biz.ext";
var getdRpsPackageUrl = baseUrl
		+ "com.hsapi.repair.repairService.svr.getRpsPackagePItemPPart.biz.ext";
var getRpsItemUrl = baseUrl
		+ "com.hsapi.repair.repairService.svr.getRpsItemPPart.biz.ext";
var getRpsPartUrl = baseUrl
		+ "com.hsapi.repair.repairService.svr.getRpsMainPart.biz.ext";
...
function advancedSearch() {
	 ...
	 * document.getElementById("advancedMore").style.display='none'; }else{
...
function newCheckMainMore() {
	...
	item.text = "查车单";
	item.url = webPath + contextPath
			+ "/repair/RepairBusiness/Reception/checkMain.jsp?cNo=" + cNo;
