...
<!-- 
  ...
  - Date: 2019-02-28 22:49:49
  - Description:
-->
<head>
<title>波箱开单查询</title>
    <meta http-equiv="content-type" content="text/html; charset=UTF-8" />
    <script src="<%=webPath + contextPath%>/repair/RepairBusiness/Reception/waveBox/js/selectBX.js?v=1.0.4"></script>
    <style type="text/css">
               ...
               <div property="columns">
                  ...
                  <div header="客户信息" headerAlign="center">
	                  <div property="columns" >
		                  ...
		                  <div field="boxNo" name="boxNo" width="80" headerAlign="center" header="变速箱号"></div>
                  ...
                  <div header="结算信息" headerAlign="center">
                   ...
                   <div header="其他" headerAlign="center">
	                  <div property="columns" >
		                  <div field="boxModel" name="boxModel" width="140" headerAlign="center" header="变速箱型号"></div>
