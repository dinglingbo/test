...
<title>Title</title>
    ...
    <script src="<%=webPath + contextPath%>/repair/RepairBusiness/Reception/waveBox/js/waveBoxDetail.js?v=1.21ian"></script>
</head>
<style type="text/css"> 
    body {  
        margin: 0; 
...
.titleText{
        ...
        <body>
         <input name="serviceTypeId"
                    ...
                    nullItemText="请选择..." width="100%"visible="false" />
    ...
    <table class="table" id="table1" border="0" style="width:100%;border-spacing:0px 0px;">
        <tr >            
            ...
            <td style="text-align:right;">
				...
				<a class="nui-button" plain="true"  id="attach" onclick="attach()"><span class="fa fa-gift fa-lg"></span>&nbsp;附件登记</a>
				<a class="nui-button" plain="true"  id="fault" onclick="fault()"><span class="fa fa-gift fa-lg"></span>&nbsp;故障现象</a>
...
<div id="billForm" class="form">
        ...
        <table   style="width: 100%;border-spacing: 0px 5px;"> 
            <tr>   
                ...
                <td class=""><input  class="nui-textbox" name="engineModel" id="engineModel" width="100%"/></td>  
                <td class="title required" style="width:100px">
                      <label>波箱厂牌：</label>
                 </td>
                <td class="" colspan="1"><input  class="nui-combobox" name="carBrandId" id="carBrandId"  valueField="id"
                               textField="name"width="100%"/></td>
    			<td class="title required" style="width:100px">变速箱号：</td> 
                <td class=""><input  class="nui-textbox" name="engineNo" id="engineNo" width="100%"/></td>  
                 <td class="title required"  style="width:100px">
                      <label>驱动形式：</label>
                 </td>
                <td class="" colspan="1">
            ...
            <tr> 
                ...
                <td class="" colspan="2"><input  class="nui-textbox" name="remark" width="100%"/></td>
            </tr>
        </table>
    </div>
