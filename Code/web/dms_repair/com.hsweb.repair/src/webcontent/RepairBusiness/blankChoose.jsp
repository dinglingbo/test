...
<head>
    <title>钣喷项目</title>
    <script src="<%=request.getContextPath()%>/repair/js/DataBase/Item/blankChoose.js?v=1.0.0"></script>
	    ...
	    <div property="columns">
		   ...
		   <div field="code" name="code" headerAlign="code" allowSort="false" visible="false" width="120px">编码</div>
	            <div field="itemprice" allowSort="true" align="left"
					...
					原价 <input class="nui-textbox" name="sellPrice" property="editor" onvaluechanged ="onValueChangedSellPrice"/>
				</div>
	            <!-- <div field="itemdiscountprice" headerAlign="center" allowSort="false" visible="true"  datatype="float" align="center" name="itemdiscountprice">
	            ...
	            <div field="itemdiscountprice" allowSort="true" align="left"
					headerAlign="center" width="">
					折后价 <input class="nui-textbox" name="itemdiscountprice" property="editor" onvaluechanged ="onValueChangedSellPrice"/>
				</div>
	            <div field="qty" headerAlign="center" allowSort="false" visible="true"  datatype="float" align="center" name="itemItemTime">动作
	                <input property="editor" vtype="float" class="nui-textbox" onvaluechanged="onValueChangedComQty" selectOnFocus="true" width="60%"/>
              ...
              width="100%"  onvaluechanged="onSearch" textField="text" valueField="billTypeId" value="5"/> -->
	           ...
	           <div type="checkboxcolumn" trueValue="1" falseValue="0" field="isOutBill" name="isOutBill" value="1" width="50" headerAlign="center" header="是否喷漆" allowsort="true"></div>
