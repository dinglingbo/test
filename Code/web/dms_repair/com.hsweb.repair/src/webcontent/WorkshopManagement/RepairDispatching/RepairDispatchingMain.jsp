...
<!-- 
  ...
  - Date: 2018-02-08 14:13:04
  - Description:
-->
<head>
<title>维修派工</title>
<script src="<%=request.getContextPath()%>/repair/js/RepairBusiness/WorkshopManagement/RepairDispatching/RepairDispatchingMain.js?v=1.0.0"></script>
<style type="text/css">
					...
					<div class="nui-toolbar" style="border-bottom: 0; ">
						<table>
							<tr>
								<td>
									<label>快速筛选：</label>
									<div id="ck1" name="product" class="nui-checkbox" readOnly="false" text="只筛选未派工维修项目" trueValue="1" falseValue="0"></div>
								</td>
								<td>
									<div class="nui-radiobuttonlist" valueField="id" repeatItems="4" textField="text"
										 repeatLayout="inline-table" style="position: relative;top:-1.5px;" value="all"
										 id="itemKind"
										 data="[{ id:'040701', text: '机电项目' },{ id:'040702', text: '钣金项目' },{ id:'040703',text: '喷漆项目' },{ id:'all', text: '所有项目' }]">
									</div>
								</td>
							</tr>
							<tr>
