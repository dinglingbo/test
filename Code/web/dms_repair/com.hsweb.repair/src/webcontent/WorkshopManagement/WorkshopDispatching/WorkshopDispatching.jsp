	...
	<div class="nui-splitter" style="width: 100%; height: 100%;" allowResize="false">
		...
		<div showCollapseButton="false">
	        <div id="mainTabs" class="nui-tabs" activeIndex="0" style="width:100%; height: 87.5%;" plain="false" onactivechanged="">
					...
					<div class="nui-fit">
						...
						<div>
							<table>
								<tr style="display: block; margin:0">
									<td>
										<div  class="nui-radiobuttonlist" valueField="id" repeatItems="4" textField="text"  repeatLayout="table"
											  data="[{ id: 0, text: '机电项目' },{ id: 1, text: '钣金项目' },{ id: 2, text: '喷漆项目' },{ id: 3, text: '所有项目' }]">
										</div>
									</td>
									<td>
										<label>维修班组：</label>
									...
									<td>
										<input class="nui-combobox" textField="" url="" valueField="" id="combo" allowInput="false"/>
									</td>
									<td>
										<label>承修人：</label>
									</td>
								...
								<tr style="display: block; margin:0">
									<td>
										<a class="nui-button" iconCls="icon-user" onclick="save()" plain="true">派工处理</a>
										<a class="nui-button" iconCls="icon-cancel" onclick="ok()" plain="true">取消派工</a>
				...
				<div title="审核领料单" >
					<div class="nui-fit">
						<div id="datagrid1" dataField="rpbclass" class="nui-datagrid" style="width: 100%; height: 94%;"url=""
							pageSize="20" showPageInfo="false" multiSelect="true" showPageIndex="false" showPageSize="false"
							showReloadButton="false" showPagerButtonIcon="false" selectOnRightClick="true"
							totalCount="total" allowSortColumn="true" virtualScroll="true" virtualColumns="true">
