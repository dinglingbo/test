		    ...
		    <div property="columns">
		    	...
		    	<div header="&nbsp" headerAlign="center">
		    		<div property="columns">
		    			...
		    			<div field="" width="200px" headerAlign="center" allowSort="true">回访内容</div>
		    			...
		    			<div field="" width="90px" headerAlign="center" allowSort="true">回访日期</div>
		    		</div>
		    	</div>
		   </div>
		</div>
