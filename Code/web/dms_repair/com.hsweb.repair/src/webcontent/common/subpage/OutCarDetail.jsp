...
<body style="margin: 0; height: 100%; width: 100%; overflow: hidden">
	...
	<div class="nui-toolbar" id="div_1"
		...
		<table style="width: 100%">
			<tr>
				<td style="width: 100%">
					<a class="nui-button"  plain="true" iconCls="icon-add" onclick="addClass()">新增（A）</a> 
					...
					<span style="widht:0;height:100%;border:0.6px solid #AAAAAA;" ></span>
					<a class="nui-button" plain="true" iconCls="icon-ok" onclick="onChoic()">选择（T）</a>
				</td>
