        ...
        <div title="联系人信息" class="nui-window" id = "contactview" style="width: 100%">
                <div class="form" id="contactInfoForm">
                	...
                	<td align="center" colspan="4" style="margin:20;padding:20;width:auto;">
                		...
                		<a class="nui-button" onclick="addContactList()"  > <span class="fa fa-save fa-lg"></span>&nbsp;保存联系人 </a>
                    </td>
                </tr>
                    </table>
            ...
            <table class="nui-form-table" style="width:100%;">
                ...
                <tr>
                	<td align="center" colspan="4" style="margin:20;padding:20;width:auto;">
                		...
                		<a class="nui-button" onclick="addCarList()"  > <span class="fa fa-save fa-lg"></span>&nbsp;保存车辆 </a>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <div class="nui-tabs" activeIndex="0"
                 ...
                 <div title="车辆信息">
                    <div class="nui-toolbar" style="border-bottom: 0; padding: 0px; height:33px" id = "toolbar1">
                        <table style="width: 100%;">
                            <tr >
                                <td style="width: 75%;text-align:right;"><a class="nui-button"
                                    onclick="addCar()"  id = "addp"> <span class="fa fa-plus fa-lg"></span>&nbsp;添加车辆 </a></td>
                                 <td style="width: 15%;"><a class="nui-button"
                                    onclick="eaidCar()"  id = "addi"> <span class="fa fa-edit fa-lg"></span>&nbsp;修改车辆 </a></td>
                                
                            </tr>
                        </table>
                    </div>
                    <div class="nui-fit" >
                        <div id="cardatagrid" class="nui-datagrid" style="width: 100%;height:100%"
                            ...
                            <div property="columns">
                               ...
                               <!--  <div field="prdtId" class="nui-hidden" allowSort="true"
                                ...
                                <div field="carModel" allowSort="true" align="left"
                                    headerAlign="center" width="" dataType="int">
                                  车型信息 
                                </div>
                                <div field="engineNo" allowSort="true" align="left"
                                    headerAlign="center" width="">发动机号</div>
                                <div field="annualVerificationDueDate" allowSort="true" align="left"
                                    headerAlign="center" width="">
                                    年审到期
                                </div>
                                <div field="insureCompCode" allowSort="true" align="left"
                                    headerAlign="center" width="">
                                    保险公司
                                </div>
                                <div field="annualInspectionNo" allowSort="true" align="left"
                                    headerAlign="center" width="">
                                    商业险单号 
                                </div>
                                <div field="annualInspectionDate" allowSort="true" align="left" 
                                    headerAlign="center" width="">
                                    商业险到期
                                </div>
                                <div field="produceDate" allowSort="true" align="left"  
                                    headerAlign="center" width="">
                                    生产日期
                                </div>
                                 <div field="produceDate" allowSort="true" align="left" 
                                 ...
                                 <div field="firstRegDate" allowSort="true" align="left" 
                                    headerAlign="center" width="">
                                    上牌日期
                                </div>
                                <div field="issuingDate" allowSort="true" align="left" 
                                    headerAlign="center" width="">
                                    发证日期
                                </div>
                            </div>
                ...
                <div title="联系人信息">
                        <div class="nui-toolbar" style="border-bottom: 0; padding: 0px; height:33px" id = "toolbar1">
                            <table style="width: 100%;">
                                <tr >
                                    <td style="width: 65%;text-align:right;"><a class="nui-button"
                                        onclick="addContact()"  id = "addp"> <span class="fa fa-plus fa-lg"></span>&nbsp;添加联系人 </a></td>
                                     <td style="width: 15%;"><a class="nui-button"
                                        onclick="eaidContact()"  id = "addi"> <span class="fa fa-edit fa-lg"></span>&nbsp;修改联系人 </a></td>
                                </tr>
                            </table>
                        </div>
                        <div class="nui-fit" >
                            <div id="contactdatagrid" class="nui-datagrid" style="width: 100%;height:100%"
                                ...
                                <div property="columns">
                                   ...
                                   <!--  <div field="prdtId" class="nui-hidden" allowSort="true"
                                    ...
                                    <div field="mobile" allowSort="true" align="left"
                                        headerAlign="center" width="" dataType="int">
                                      手机
                                    </div>
                                    <div field="identity" allowSort="true" align="left"
                                        headerAlign="center" width="">身份</div>
                                    <div field="source" allowSort="true" align="left"
                                        headerAlign="center" width="">
                                        来源
                                    </div>
                                    <div field="drivingLicenceDueDate" allowSort="true" align="left"
                                        headerAlign="center" width="">
                                        驾审到期
                                    </div>
                                    <div field="birthdayType" allowSort="true" align="left"
                                        headerAlign="center" width="">
                                        生日类型 
                                    </div>
                                    <div field="birthday" allowSort="true" align="left" 
                                        headerAlign="center" width="">
                                        生日
                                    </div>
                                    <div field="idNo" allowSort="true" align="left"  
                                        headerAlign="center" width="">
                                        身份证号码
                                    </div>
