...
<div id="dgGrid" class="nui-datagrid" style="width:100%;height:100%;"
	...
	<div property="columns">
		...
		<div allowSort="true" field="name"  summaryType="count" headerAlign="center" header="意向等级">
				<input property="editor" class="nui-textbox"/>
		</div>
		<div allowSort="true" field="name"  summaryType="count" headerAlign="center" header="回访间隔天数">
				<input property="editor" class="nui-textbox"/>
		</div>
