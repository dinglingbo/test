 ...
 <div class="nui-fit">
    ...
    <div  id="guestGrid" class="nui-datagrid"
      ...
      <div property="columns">
    	   ...
    	   <div field="fullName" headerAlign="center" allowSort="false" visible="true" width="100" header="意向等级" align="center"></div>
    	   <div field="mobile" headerAlign="center" allowSort="false" visible="true" width="120" header="回访天数" align="center"></div>
     </div>
    </div>
   </div>
</div>  
