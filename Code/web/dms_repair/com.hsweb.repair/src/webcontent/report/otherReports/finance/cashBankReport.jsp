                                ...
                                <table style="width:100%;">
                                    <tr>
                                        <td>
                                            ...
                                            单据日期:
                                            <input class="nui-datepicker" id="startDate2" name="startDate" dateFormat="yyyy-MM-dd" style="width:100px" />
                                            至
                                            <input class="nui-datepicker" id="endDate2" name="endDate" dateFormat="yyyy-MM-dd" style="width:100px" />
                            ...
                            <div class="nui-fit">
                                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true" showPager="true"
                                    ...
                                    <div property="columns">
                                        ...
                                        <div field="" name="" width="100" headerAlign="center" align="center">结算账户</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">账户类型</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">期初</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">收入</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">支出</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">收支合计</div>
                                    ...
                                    <table style="width:100%;">
                                        <tr>
                                            <td>
                                                ...
                                                至
                                                <input class="nui-datepicker" id="endDate" name="endDate" dateFormat="yyyy-MM-dd" style="width:100px" />
                                                <input class="nui-textbox" style="widows: 100px;" emptyText="结算账户">
                                                <input class="nui-textbox" style="widows: 100px;" emptyText="类型">
                                                <input class="nui-textbox" style="widows: 100px;" emptyText="业务类型">
                                                <input class="nui-textbox" style="widows: 100px;" emptyText="操作员">
                                                <a class="nui-button" plain="true" onclick="" id="query" enabled="true"><span class="fa fa-search fa-lg"></span>&nbsp;查询</a>
                                                <!-- <li class="separator"></li> -->
                                            </td>
                                        </tr>
                                ...
                                <div class="nui-fit">
                                    <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true" showPager="true"
                                        ...
                                        <div property="columns">
                                            ...
                                            <div field="" name="" width="100" headerAlign="center" align="center">结算账号</div>
                                            ...
                                            <div field="" name="" width="100" headerAlign="center" align="center">相关单据</div>
