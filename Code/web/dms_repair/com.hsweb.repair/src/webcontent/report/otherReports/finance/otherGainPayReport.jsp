                                ...
                                <table style="width:100%;">
                                    <tr>
                                        <td>
                                            ...
                                            <input class="nui-textbox" style="widows: 100px;" emptyText="收入对象">
                                            <input class="nui-textbox" style="widows: 100px;" emptyText="结算账户">
                                            <input class="nui-textbox" style="widows: 100px;" emptyText="收入类型">
                                            <input class="nui-textbox" style="widows: 100px;" emptyText="类型">
                                            <input class="nui-textbox" style="widows: 100px;" emptyText="备注">
                            ...
                            <div class="nui-fit">
                                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true" showPager="true"
                                    ...
                                    <div property="columns">
                                        ...
                                        <div field="" name="" width="100" headerAlign="center" align="center">收入类型</div>
                                    ...
                                    <table style="width:100%;">
                                        <tr>
                                            <td>
                                                ...
                                                至
                                                <input class="nui-datepicker" id="endDate" name="endDate" dateFormat="yyyy-MM-dd" style="width:100px" />
                                                <input class="nui-textbox" style="widows: 100px;" emptyText="支出对象">
                                                <input class="nui-textbox" style="widows: 100px;" emptyText="结算账户">
                                                <input class="nui-textbox" style="widows: 100px;" emptyText="支出类型">
                                                <input class="nui-textbox" style="widows: 100px;" emptyText="备注">
                                                <a class="nui-button" plain="true" onclick="" id="query" enabled="true"><span class="fa fa-search fa-lg"></span>&nbsp;查询</a>
                                                <!-- <li class="separator"></li> -->
                                            </td>
                                ...
                                <div class="nui-fit">
                                    <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true" showPager="true"
                                        ...
                                        <div property="columns">
                                            ...
                                            <div field="id" name="id" visible="false" width="100">id</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">单据编号</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">支出对象</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">结算账户</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">金额（￥）</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">支出类型</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">单据日期</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">备注</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">操作员</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">添加时间</div>
