                                ...
                                <table style="width:100%;">
                                    <tr>
                                        <td>
                                            ...
                                            <input class="nui-textbox" style="widows: 100px;" emptyText="显示设置">
                            ...
                            <div class="nui-fit">
                                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true" showPager="true"
                                    ...
                                    <div property="columns">
                                        ...
                                        <div field="" name="" width="100" headerAlign="center" align="center">客户类型</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">客户</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">手机</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">期初&nbsp;
                                        ...
                                        <div field="" name="" width="100" headerAlign="center" align="center">付款&nbsp;
                                                <span class="fa fa-question-circle fa-lg iconStyle" style="margin-top: 3px;"
                                                onmouseover="overShow(this,con8)" onmouseout="outHide()"></span></div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">结余&nbsp;
                                                <span class="fa fa-question-circle fa-lg iconStyle" style="margin-top: 3px;"
                                                onmouseover="overShow(this,con8)" onmouseout="outHide()"></span></div>
                                    </div>
                                </div>
                                ...
                                <div class="nui-fit">
                                    <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true" showPager="true"
                                        ...
                                        <div property="columns">
                                            ...
                                            <div field="" name="" width="100" headerAlign="center" align="center">应收</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">预收</div>
