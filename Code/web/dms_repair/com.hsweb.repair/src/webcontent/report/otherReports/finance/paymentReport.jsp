...
<head>
  ...
  <script src="<%=request.getContextPath()%>/repair/js/report/storeReport/paymentReport.js?v=1.0.4"></script>
    <style type="text/css">
    body { 
        margin: 0;
        padding: 0;
...
<body>
    ...
    <div id="form1" class="mini-toolbar" style="padding:10px;">
     ...
     <a class="nui-button" iconcls=""  name="" plain="true" onclick="load(1)"><span class="fa fa-navicon fa-lg"></span>&nbsp;按收支类型汇总</a>
     <a class="nui-button" iconcls=""  name="" plain="true" onclick="load(2)"><span class="fa fa-navicon fa-lg"></span>&nbsp;按客户汇总</a>
 ...
 <div class="nui-fit">
    ...
    showSummaryRow="true">
        ...
        <div type="indexcolumn">序号</div>
              ...
              <div field="trueCharOffAmt" name="trueCharOffAmt" width="60" headerAlign="center" header="金额" summaryType="sum" allowsort="true" dataType="float" ></div> 
