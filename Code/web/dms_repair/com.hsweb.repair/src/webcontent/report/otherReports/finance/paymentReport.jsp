...
<head>
  ...
  <script src="<%=request.getContextPath()%>/repair/js/report/storeReport/paymentReport.js?v=1.0.2"></script>
    <style type="text/css">
    body { 
        margin: 0;
        padding: 0;
 ...
 <div class="nui-fit">
    ...
    showSummaryRow="true">
        ...
        <div type="indexcolumn">序号</div>
              ...
              <div field="trueCharOffAmt" name="trueCharOffAmt" width="60" headerAlign="center" header="金额" summaryType="sum" allowsort="true" ></div> 
