                                ...
                                <table style="width:100%;">
                                    <tr>
                                        <td>
                                            ...
                                            <input class="nui-textbox" style="widows: 100px;" emptyText="施工门店">
                                            <input class="nui-textbox" style="widows: 100px;" emptyText="源门店">
                                            <input class="nui-textbox" style="widows: 100px;" emptyText="类型">
                            ...
                            <div class="nui-fit">
                                <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true" showPager="true"
                                    ...
                                    <div property="columns">
                                        ...
                                        <div field="" name="" width="100" headerAlign="center" align="center">施工门店</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">单据</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">日期</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">客户</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">车牌</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">金额（￥）</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">项目/商品</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">类型</div>
                                        <div field="" name="" width="100" headerAlign="center" align="center">源分店</div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table style="width:100%;">
                                        <tr>
                                            <td>
                                                ...
                                                至
                                                <input class="nui-datepicker" id="endDate" name="endDate" dateFormat="yyyy-MM-dd" style="width:100px" />
                                                <input class="nui-textbox" style="widows: 100px;" emptyText="分店">
                                                <a class="nui-button" plain="true" onclick="" id="query" enabled="true"><span class="fa fa-search fa-lg"></span>&nbsp;查询</a>
                                                <!-- <li class="separator"></li> -->
                                            </td>
                                        </tr>
                                ...
                                <div class="nui-fit">
                                    <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true" showPager="true"
                                        ...
                                        <div property="columns">
                                            <div type="indexcolumn" width="40" headerAlign="center" align="center">序号</div>
                                            <div field="id" name="id" visible="false" width="100">id</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">源分店名称</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">余额</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">套餐</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">收款</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">付款</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">核销</div>
                                            <div field="" name="" width="100" headerAlign="center" align="center">小计</div>
                                        </div>
                                    </div>
                                </div>
                    </div>
