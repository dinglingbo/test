...
<head>
    ...
    <script src="<%=request.getContextPath()%>/repair/js/report/storeReport/technicianCommissionDetail.js?v=1.0.11"></script>
            		...
            		<div type="indexcolumn" header="序号" width="40px"></div>
						<div header="提成信息" headerAlign="center"> 
		                    <div property="columns" >	
					          ...
					          <div field="deductWorkerValue" name="deductWorkerValue" headeralign="center" width="80" align="center" summaryType="sum" dataType="float" allowsort="true" >技师提成</div>
					        </div>
				        </div>
