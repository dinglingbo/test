                    ...
                    <div class="nui-fit">
                        <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true"
                            ...
                            <div property="columns">
                                ...
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">套餐名称</div>
            ...
            <div title="套餐销售趋势">
                <div class="nui-fit">
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td>
                                    ...
                                    <input class="nui-datepicker" id="endDate" name="endDate" dateFormat="yyyy-MM-dd"
                                        style="width:100px" />
                                        <input class="nui-textbox" style="widows: 100px;" emptyText="套餐">
                    ...
                    <div style="border-bottom:1px solid #ccc;margin-top: 20px;">
                        <span class="titleText"> 套餐销售趋势</span>
                    </div>
                    <div class="nui-fit">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input class="nui-datepicker" id="endDate" name="endDate" dateFormat="yyyy-MM-dd"
                                        style="width:100px" />
                                    <input class="nui-textbox" style="widows: 100px;" emptyText="客户">
                                    <input class="nui-textbox" style="widows: 100px;" emptyText="单据编号">
                                    <input class="nui-combobox" style="widows: 100px;" emptyText="套餐">
                                    <input class="nui-combobox" style="widows: 100px;" emptyText="销售人员">
                                    <input class="nui-combobox" style="widows: 100px;" emptyText="状态">
                                    <a class="nui-button" plain="true" onclick="" id="query" enabled="true"><span class="fa fa-search fa-lg"></span>&nbsp;查询</a>
                                    <li class="separator"></li>
                                    <a class="nui-button" plain="true" onclick="" id="query" enabled="true"><span class="fa fa-close fa-lg"></span>&nbsp;撤销</a>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="nui-fit">
                        <div id="mainGrid" class="nui-datagrid" style="width:100%;height:100%;" selectOnLoad="true"
                            ...
                            <div property="columns">
                                ...
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">套餐名称</div>
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">姓名</div>
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">手机号</div>
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">金额</div>
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">实付</div>
                                ...
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">状态</div>
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">车牌号</div>
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">操作员</div>
                                <div field="carNo" name="carNo" width="100" headerAlign="center" align="center">销售时间</div>
