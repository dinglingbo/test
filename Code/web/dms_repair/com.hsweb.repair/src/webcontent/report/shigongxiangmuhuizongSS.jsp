    ...
    <div class="nui-fit">
        <div id="grid" class="nui-datagrid" datafield="" allowcelledit="true" url="" allowcellwrap="true" style="width:100%;height:100%;">
            <div property="columns">
                <div field="" name="" headeralign="center" align="center">项目台次</div>
                <div field="" id="" name="" headeralign="center" align="center">工时数</div>
                <div field="" id="" name="" headeralign="center" align="center">工时收入</div>
                <div field="" id="" name="" headeralign="center" align="center">项目成本</div>
                <div field="" id="" name="" headeralign="center" align="center">增项台次</div>
                <div field="" id="" name="" headeralign="center" align="center">增项工时数</div>
                <div field="" id="" name="" headeralign="center" align="center">增项工时收入</div>
                <div field="" id="" name="" headeralign="center" align="center">增项台次占比</div>
                <div field="" id="" name="" headeralign="center" align="center">增项工时数占比</div>
                <div field="" id="" name="" headeralign="center" align="center">增项工时收入占比</div>
                <div field="" id="" name="" headeralign="center" align="center">返工台次</div>
                <div field="" id="" name="" headeralign="center" align="center">返工台次占比</div>
                <div field="" id="" name="" headeralign="center" align="center">收现金额</div>
            </div>
        </div>
    </div>
</div>
