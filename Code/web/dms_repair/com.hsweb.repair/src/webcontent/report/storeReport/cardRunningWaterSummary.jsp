...
<link href="<%=webPath + contextPath%>/frm/js/finance/HeaderFilter.css" rel="stylesheet" type="text/css" />
 ...
 <div id="form1" class="mini-toolbar" style="padding:10px;">
    ...
    <div style="height: 150px;" class="parent">
        ...
        <span class="titleText"> 储值卡明细</span>
    </div>
    <div class="nui-fit">
                <div id="grid1" class="nui-datagrid" style="width: 100%; height: 100%;" pageSize="500" dataField="data"  sizeList=[500,1000,2000]
                    ...
                    <div property="columns"> 
                        ...
                        <div field="cardName" name="cardName" headerAlign="center"   visible="true" width="100">卡名称 </div>
                      <!--   <div field="qcAmt"  name="qcAmt" headerAlign="center"   visible="true" width="100">期初</div> -->
                        <div field="amt" name="amt" headerAlign="center"  visible="true" width="80" summaryType="sum" >金额</div>
                        <!-- <div field="balaAmt" name="balaAmt" headerAlign="center"  visible="true" width="100">期末</div> -->                                
