...
<script src="<%=webPath + contextPath%>/common/js/repairUtil.js?v=2.1.3" type="text/javascript"></script>
<script src="<%=webPath + contextPath%>/common/js/repairSvrUtil.js?v=3.0.19" type="text/javascript"></script>
