...
<script src="<%=webPath + contextPath%>/common/js/repairUtil.js?v=1.0.11" type="text/javascript"></script>
<script src="<%=webPath + contextPath%>/common/js/repairSvrUtil.js?v=1.0.6" type="text/javascript"></script>
<style type="text/css">
	html,
	body {
		margin: 0;
