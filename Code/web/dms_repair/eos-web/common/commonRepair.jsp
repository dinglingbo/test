...
<script src="<%=webPath + contextPath%>/common/js/repairUtil.js?v=3.2.5" type="text/javascript"></script>
<script src="<%=webPath + contextPath%>/common/js/repairSvrUtil.js?v=8.1.18" type="text/javascript"></script>
<style type="text/css">
	html,
	body {
		margin: 0;
