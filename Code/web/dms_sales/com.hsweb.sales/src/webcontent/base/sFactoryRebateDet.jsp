...
<head>
    ...
    <script src="<%=webPath + contextPath%>/sales/base/js/sFactoryRebateDet.js?v=1.2.3"></script>
    <style>
        html,
        body {
            margin: 0px;
            ...
            <tr style="height: 35px;">
                ...
                <td class="td_ctrl">
                    ...
                    <input id="guestId" name="guestId" class="nui-buttonedit" emptyText="请选择供应商..." style="width: 100%"
                        onbuttonclick="selectSupplier('guestId',1)" selectOnFocus="true" />
                </td>
                <td class="td_title" style="text-align: right">经办人：
                </td>
                <td class="td_ctrl">
                    <input class="nui-combobox" id="operator" name="operator" style="width: 100%;" valueField="empId"
                        textField="empName" />
                </td>
            </tr>
            <tr style="height: 35px;">
            ...
            <div showCollapseButton="true">
                ...
                <div id="rightGrid" class="nui-datagrid" style="width:100%;height:100%;" dataField="list"
                    ...
                    <div property="columns">
                        ...
                        <div field="rebateAmt" headerAlign="center" allowSort="true" width="100px">返利金额
