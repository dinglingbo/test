...
-->
    ...
    <head>
        ...
        <script src="<%=webPath + contextPath%>/sales/base/js/sFactoryRebateDet.js?v=1.1.4"></script>
            <style>
                html,
                body { 
                    margin: 0px; 
    ...
    <body>
        <div class="nui-toolbar">
                <a class="nui-button" iconCls="" plain="true" onclick="save()" id="deletBtn"><span class="fa fa-save fa-lg"></span>&nbsp;保存</a>
                <a class="nui-button" iconCls="" plain="true" onclick="del()" id="deletBtn"><span class="fa fa-remove fa-lg"></span>&nbsp;取消</a>
            </div>
            <div class="nui-toolbar" style="border:0px;" id="form1">
                <input id="id" class="nui-textbox" enabled="false" visible="false"/>
            <table cellpadding="0" cellspacing="0" style="padding:5px 20px;">
                <tr style="height: 35px;">
                    <td class="td_title">单据编号：
                    </td>
                    <td class="td_ctrl">
                        <input id="serviceCode"  style="width: 100%"  class="nui-textbox" enabled="false"/>
                    </td>
                    ...
                    <td class="td_ctrl">
                        <input id="guestId" name="guestId" class="nui-combobox" style="width: 100%"></input>
                    </td>
                    <td class="td_title" style="text-align: right">经办人：
                        </td>
                        <td  class="td_ctrl">
                            <input class="nui-combobox" id="operator" name="operator" style="width: 100%;" 
                 ...
                 <tr style="height: 35px;">
                    ...
                    <td >
                        <input id="rebateId" name="rebateId" class="nui-combobox" style="width: 100%;" 
                        dataField="list" valueField="id" textField="name"/>
                    </td>
