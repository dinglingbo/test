...
<head>
<title>整车验车</title>
<script src="<%=webPath + contextPath%>/sales/inventory/js/carSalesPutStorage.js?v=1.1.0"></script>
...
<!--                     <div field="engineNo" name="engineNo" width="150" headerAlign="center" header="发动机号"></div>  -->
                    ...
                    <div field="unitPrice" name="unitPrice" width="60" headerAlign="center" header="单价"></div>
                    <div field="amt" name="amt" width="60" headerAlign="center" header="金额"></div> 
                    <div field="logisticCompName" name="logisticCompName" width="220" headerAlign="center" header="物流公司"></div>   
                    <div field="receiveCost" name="receiveCost" width="60" headerAlign="center" header="运输成本"></div> 
                    <div field="carStatus" name="carStatus" width="60" headerAlign="center" header="车辆状态"></div>                                                                                                          
                    <div field="enterDate" allowSort="true"  width="130" headerAlign="center" header="入库日期" dateFormat="yyyy-MM-dd HH:mm"></div>
                    <div field="remark" allowSort="true"  width="80" headerAlign="center" header="车况备注"></div>
                    <div field="recordDate" allowSort="true"  width="130" headerAlign="center" header="创建日期" dateFormat="yyyy-MM-dd HH:mm" ></div>  
<!--                     <div field="recorder" width="90" name="creator" headerAlign="center" header="创建人"></div>
                    <div field="modifier" width="90" name="creator" headerAlign="center" header="修改人"></div>
                    <div field="modifyDate" allowSort="true"  width="130" headerAlign="center" header="修改日期" dateFormat="yyyy-MM-dd HH:mm" ></div> -->  
