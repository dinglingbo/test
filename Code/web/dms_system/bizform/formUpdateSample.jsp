        ...
        <div title="<%=I18nUtil.getMessage(request, "bps.bizform.Contacts") %>">
          ...
          <div id="grid_0" class="nui-datagrid" style="width:100%;height:150px;" showPager="false" sortMode="client" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true" >
            <div property="columns">
              ...
              <div field="contactName" allowSort="true" align="left" headerAlign="center" width=""><%=I18nUtil.getMessage(request, "bps.bizform.bps.bizform.Name") %><input class="nui-textbox" name="contactName" property="editor"/>
              </div>
		...
		*/
		function initData(e){
			nui.ajax({
				...
				data:{"ooperator":{"operatorId":204}},
				type: "POST",
				cache: false,
				success: function(e){
					if(!e.exception){
						var data = nui.decode(e);
						data.ooperator.__type = "sdo:com.primeton.nuisample.data.OOperator";
						form.setData(data);
						var contacts = data.ooperator.oContacts;
						nui.get("grid_0").setData(contacts);
					}
				},
				fail: function(e){
