...
<head>
    ...
    <script src="<%=webPath + contextPath%>/common/js/employeeQueryPart.js?v=1.0.11" type="text/javascript"></script>    
        <style type="text/css">
            ...
            <div size="210" showCollapseButton="false">
                <div class="nui-toolbar" style="border-bottom: 0; padding: 0px;">
					<table style="width: 100%">
						<tr>
							<td style="width: 100%">
								<a class="nui-button" plain="true" iconCls="" onclick="addDept"><span class="fa fa-plus fa-lg"></span>&nbsp;新增</a>
								<a class="nui-button" plain="true" iconCls="" onclick="editDept"><span class="fa fa-edit fa-lg"></span>&nbsp;修改</a>
                                <a class="nui-button" plain="true" iconCls="" onclick="saveDept"><span class="fa fa-save fa-lg"></span>&nbsp;保存</a>
							</td>
						</tr>
					</table>
				</div>
                <div class="nui-fit">
                    <div id="deptGrid" 
						dataField="rs" 
						class="nui-datagrid" showPager="false" allowCellEdit="false" allowCellSelect="true"
						style="width: 100%; height: 100%;" onrowdblclick="search()" >
						<div property="columns">
							<div id="id" field="id" headerAlign="center" allowSort="true"  width="60px" visible="false">id</div>
							<div id="deptName" field="deptName" header="部门名称" headerAlign="center" editNextOnEnterKey="true"  editNextRowCell="true" allowSort="true" visible="true" width="60px">
							<input  property="editor" class="nui-textbox"/></div>						
						</div>
					</div>
                </div>
            </div>
				...
				<div class="nui-fit">
					<div id="datagrid1" 
						...
						<div property="columns">
							...
							<div id="isArtificer" field="isArtificer" headerAlign="center" allowSort="true" visible="false" width="40px">服务技师</div>
							<div id="isMtadvisor" field="isMtadvisor" headerAlign="center" allowSort="true" visible="false" width="40px">服务顾问</div>
							<div id="isStockman" field="isStockman" headerAlign="center" allowSort="true" visible="false" width="40px">允许领料</div>
							<div id="isCanfreeCarnovin" field="isCanfreeCarnovin" headerAlign="center" allowSort="false" visible="true" width="40px">车牌号车架号是否允许自由输入</div>
							<div id="isCanSettle" field="isCanSettle" headerAlign="center" allowSort="true" visible="false" width="40px">工单是否允许直接结算</div>
							<div id="isPchsStock" field="isPchsStock" headerAlign="center" allowSort="true" visible="false" width="40px">采购/仓库</div>
							...
							<div id="imCode" field="imCode" headerAlign="center" allowSort="true" visible="false" width="50px">是否开通IM</div>
