  ...
  */
  ...
  if (!$narjContainer) {
      $narjContainer = createElement('div', ['naranja-notification-box'])
        $narjContainer.addEventListener("mouseover", function(){
            document.querySelector('.naranja-notification-box').style.overflow="auto";
        });
        $narjContainer.addEventListener("mouseout", function(){
            document.querySelector('.naranja-notification-box').style.overflow="hidden";
        });
    ...
    createTitle: function () {
      ...
      createText: function () {
        ...
        for (i = 0; i < textList.length; i++) { 
            ...
            ppp.innerHTML = textList[i];
            $textContainerMain.appendChild(ppp)
        }
