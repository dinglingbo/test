...
<head> 
    ...
    <script src="<%=webPath + contextPath%>/common/js/partEmployeeEdit.js?v=1.0.15" type="text/javascript"></script>
</head>
<body>
    <div class="nui-fit"> 
        <div class="form" style="width:90%;height:90%;left:0;right:0;margin: 0 auto;" id="basicInfoForm">
            ...
            <input class="mini-hidden" id="kingCode" name="kingCode" />
            <fieldset id="fd1" style="width:620px;">
              ...
              <tr>
                ...
                <td >部门：<span></span></td>
                <td ><input name="deptId" id="deptId" class="nui-combobox" textField="deptName" valueField="id"
                          emptyText="请选择..." allowInput="false" showNullItem="false" valueFromSelect="true"
                          onvaluechanged="ondeptchanged" nullItemText="请选择..." /></td>    
            </tr>
            <tr>
