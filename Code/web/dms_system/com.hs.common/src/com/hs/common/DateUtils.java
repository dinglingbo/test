...
public class DateUtils {
		  ...
		  @Bizlet("")
	      public static java.util.Date addDateWithMonth(Date d, int ms) {
		  ...
		  @Bizlet("")
	      //获取上月的开始时间
		  public static Date getBeginDayOfPrevMonth() throws ParseException{
				  Date date = new Date();
		          if (date == null) {
		              return null;
		          }
		  ...
		  @Bizlet("")
	      //获取上月的结束时间
	       public static Date getEndDayOfPrevMonth() throws ParseException {
			  	  Calendar cal = Calendar.getInstance();
			  	  cal.setTime(getBeginDayOfPrevMonth()); 
	    ...
	    //获取某年某月的第一天日期
		  ...
		  @Bizlet("")
		     //获取某个日期的开始时间
		     public static java.util.Date getDayStartDate(Date d) {
		         Calendar calendar = Calendar.getInstance();
		         if(null != d) calendar.setTime(d);
		         calendar.set(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH),    calendar.get(Calendar.DAY_OF_MONTH), 0, 0, 0);
		         calendar.set(Calendar.MILLISECOND, 0);
			  ...
			  @Bizlet("")
		     //获取某个日期的结束时间
		     public static java.util.Date getDayEndDate(Date d) {
		         Calendar calendar = Calendar.getInstance();
		         if(null != d) calendar.setTime(d);
		         calendar.set(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH),    calendar.get(Calendar.DAY_OF_MONTH), 23, 59, 59);
		         calendar.set(Calendar.MILLISECOND, 999);
