...
public class SimpleHttpClientDemo {
     ...
     */
    public static String send(String url, Map<String, String> map,Map<String, String> header,
			String encoding) throws KeyManagementException, NoSuchAlgorithmException, ClientProtocolException, IOException {
        String body = "";
        //采用绕过验证的方式处理https请求
	...
	public static void main(String[] args) throws IOException,
		...
		String xx = send(url,header,createMap,
				 "utf-8");
