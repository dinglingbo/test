...
<head>
  ...
  <meta http-equiv="content-type" content="text/html; charset=UTF-8" />
    <script src="<%=webPath + contextPath%>/common/Index/TextIndex.js?v=1.6.14"></script>
  <script src="<%= request.getContextPath() %>/common/nui/nui.js" type="text/javascript"></script>
  <link href="<%=request.getContextPath()%>/common/nui/themes/blue2010/skin.css" rel="stylesheet" type="text/css" />
  <link href="<%=request.getContextPath()%>/common/Index/TextIndex.css?v=1.0.7" rel="stylesheet" type="text/css" />
                            ...
                            <table id="table1" style="margin-left:0px;">
                            	...
                            	<tr>  
                                   <td class="tabletext"><i class="fa fa-cube fa-lg-custom fa-fw"></i>预约到店提醒：</td>
                                	<td class="tablenum"><a id="queryAppointment" href="javascript:bookingMgr()" style="color: #61acc9;"><span></span></a></td>
