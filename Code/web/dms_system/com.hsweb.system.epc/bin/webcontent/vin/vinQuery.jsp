...
<title>车架号查询</title>
    ...
    <script src="<%=contextPath%>/epc/common/llqCommon.js?v=1.0.5" type="text/javascript"></script>
    <script src="<%=contextPath%>/epc/vin/js/vinQuery.js?v=1.0.6" type="text/javascript"></script>
