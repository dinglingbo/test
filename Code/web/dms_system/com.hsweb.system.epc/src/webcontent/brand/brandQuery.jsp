...
<title>车型查询</title>
    ...
    <script src="<%=contextPath%>/epc/brand/js/brandQuery.js?v=1.0.4" type="text/javascript"></script>
    <script src="<%=contextPath%>/epc/brand/js/brandInfos.js?v=1.0.2" type="text/javascript"></script>
</head>
<body>
    <div class="nui-fit"> 
