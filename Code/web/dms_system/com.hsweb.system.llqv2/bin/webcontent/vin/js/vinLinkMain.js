...
function query_vin(type){
    ...
    switch (type){
        case 0:
            document.getElementById("mainFrame0").src=webPath + contextPath + "/com.hsweb.system.llqv2.vinQuery.flow.ext?token=214e2f71-4237-4601-9a1a-538bf982b995";
            break;
        case 1:
            document.getElementById("mainFrame1").src=webPath + contextPath + "/com.hsweb.system.llqv2.brandQuery.flow.ext?token=214e2f71-4237-4601-9a1a-538bf982b995&brand=" + brand;
            break;
        case 2:
            document.getElementById("mainFrame2").src=webPath + contextPath + "/com.hsweb.system.llqv2.partQuery.flow.ext?token=214e2f71-4237-4601-9a1a-538bf982b995";
            break;
        /* default:
