...
<head>
    ...
    <%@include file="/common/sysCommon.jsp"%>
	 <script src="<%= request.getContextPath() %>/tenant/js/productManager.js?v=1.0.3" type="text/javascript"></script>
    <style type="text/css">
    body {
     margin: 0;
     padding: 0;
...
<span style="display:inline-block;">
    <a class="nui-button" plain="true" onclick="ViewType(1)"><i class="fa fa-plus"></i>&nbsp;新增</a>
    <a class="nui-button" plain="true" onclick="ViewType(2)"><i class="fa fa-pencil"></i>&nbsp;修改</a>
    <a class="nui-button" plain="true" onclick="remove()"><i class="fa fa-trash-o"></i>&nbsp;删除</a>
    <span class="separator"></span>
...
<div class="nui-fit">
    ...
    <div property="columns">
        ...
        <div field="remark" width="80" headerAlign="center" align="center" id="remark">接口地址</div>
        <div field="isCycle" width="90" headerAlign="center" align="center" id="isCycle">有效期</div>
<!--         <div field="orderNumber" width="80" headerAlign="center" align="center" id="orderNumber">排序号</div> -->
        ...
        <div field="salesPrice2" width="80" headerAlign="center" align="center" id="salesPrice2">销售价</div>
        <div field="status" width="80" headerAlign="center" align="center" id="status">产品状态</div>
        <div field="type" width="80" headerAlign="center" align="center" id="type">产品描述</div>
        <div field="type" width="80" headerAlign="center" align="center" id="type">单次扣减链车币</div>
