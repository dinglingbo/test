...
<title>车架号查询</title>
    ...
    <script src="<%=contextPath%>/llq/common/llqCommon.js?v=1.1" type="text/javascript"></script>
    <script src="<%=contextPath%>/llq/vin/js/vinQuery.js?v=1.3" type="text/javascript"></script>    
</head>
<body>
    <div class="nui-fit">
