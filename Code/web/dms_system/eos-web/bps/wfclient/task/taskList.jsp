...
<body style="width: 98%;"  class="body-font" > 
	...
	<div id="taskListId" class="nui-datagrid bpsDatagrid" style="margin-top:15px;width: 100%" showPager="true"
		url="org.gocom.bps.wfclient.task.business.task.queryTaskList.biz.ext" allowAlternating="true"
