...
<meta name="format-detection" content="telephone=no, address=no, email=no" />
 ...
 <%
   ...
   if(isOpenSecurity){
   		...
   		if(!isAllInHttps){
   			url = "https://" + ip + ":" + https_port + contextPath + "/coframe/auth/cd/" + loginUrl;
   			sweepCodeUrl = "https://" + ip + ":" + https_port + contextPath + "/coframe/auth/cd/" + sweepCodeFlow;
   			regUrl = "https://" + ip + ":" + https_port + contextPath + "/coframe/auth/cd/" + regUrl;
...
//	String apiPath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort(); 
	...
	String privacyUrl = request.getContextPath() + "/coframe/auth/cd/privacyUrl.jsp";
	String protocolUrl = request.getContextPath() + "/coframe/auth/cd/protocolUrl.jsp";
 %> 
<style type="text/css">
html{
