    ...
    <%@page import="com.primeton.cap.AppUserManager"%>
        ...
        <head>
            ...
            <%@include file="/common/sysCommon.jsp" %>
                ...
                <link href="<%=request.getContextPath()%>/coframe/auth/cw/css/kefu.css" rel="stylesheet" type="text/css" />
                ...
                <link href="<%=request.getContextPath()%>/common/nui/res/third-party/scrollbar/jquery.mCustomScrollbar.css" rel="stylesheet"
                    type="text/css" />
                <link href="<%=request.getContextPath()%>/coframe/auth/cw/feedback/feedback.css" rel="stylesheet" type="text/css" />
                ...
                <script src="<%=request.getContextPath()%>/coframe/auth/cw/feedback/html2canvas.min.js" type="text/javascript"></script>
...
<%--                  <div id="tu" style="overflow-y:auto;overflow-x:auto; width:800px; height:50px;background-color: #055594;">
            ...
            <div class="container">
                <div class="navbar" id="skin" style="margin-left: -80px;    background-color: #0067b8;">
                    <div class="navbar-brand" id="systemName">车维SaaS平台</div>
...
<!--                         <li class="dropdown">
            ...
            <script src="<%=request.getContextPath()%>/coframe/auth/cw/feedback/drawDom.js?v=1.0.1" type="text/javascript"></script>
...
/*                                 document.getElementById("skin").style.backgroundColor = "#0067b8";
            ...
            function changeOrgs(orgid) {
                if (orgid != currOrgId) {
                    $("#toggleRole")[0].action = "com.hsapi.system.auth.login.cw.flow";
...
/*                             html += '		      <li><span class="fa fa-wechat"></span>&nbsp;&nbsp;&nbsp;' + data.rs[0].wechat + '</li>'; */
 	...
 	function cancellation(){
 		window.location="<%=request.getContextPath()%>/coframe/auth/cw/logout.jsp";
 	}     
 	        var scriptList=[
