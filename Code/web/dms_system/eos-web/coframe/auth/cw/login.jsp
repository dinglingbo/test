...
<meta charset="utf-8">
<meta name="keywords" content="车维SaaS平台"/>
<meta name="description" content="车维SaaS平台"/>
<meta name="author" content="shenzhi"/>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
<meta name="apple-mobile-web-app-title" content="车维SaaS平台"/>
...
<meta name="format-detection" content="telephone=no, address=no, email=no" />
 ...
 <%
   ...
   String loginUrl = "org.gocom.components.coframe.auth.login.cw.flow";
   String sweepCodeFlow = "com.hsapi.system.auth.login.qrcw.flow";
   loginUrl = "com.hsapi.system.auth.login.cw.flow";
   ...
   if(isOpenSecurity){
   		...
   		if(!isAllInHttps){
   			url = "https://" + ip + ":" + https_port + contextPath + "/coframe/auth/cw/" + loginUrl;
   			sweepCodeUrl = "https://" + ip + ":" + https_port + contextPath + "/coframe/auth/cw/" + sweepCodeFlow;
   			regUrl = "https://" + ip + ":" + https_port + contextPath + "/coframe/auth/cw/" + regUrl;
...
//	String apiPath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort(); 
	...
	String privacyUrl = request.getContextPath() + "/coframe/auth/cw/privacyUrl.jsp";
	String protocolUrl = request.getContextPath() + "/coframe/auth/cw/protocolUrl.jsp";
 %> 
<style type="text/css">
html{
...
<div class="login_box">
	...
	<div class="login" id="sweepCodeBox">
		...
		<div id="qrcode" ></div>
		<div class="you" >打开车维SaaS平台手机APP扫描二维码</div>
	</div>
</form>	
