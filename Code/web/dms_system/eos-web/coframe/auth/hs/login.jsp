...
<meta charset="utf-8">
<meta name="keywords" content="华胜SaaS平台"/>
<meta name="description" content="华胜SaaS平台"/>
<meta name="author" content="shenzhi"/>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
<meta name="apple-mobile-web-app-title" content="华胜SaaS平台"/>
...
//	String apiPath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort(); 
	...
	String privacyUrl = request.getContextPath() + "/coframe/auth/hs/privacyUrl.jsp";
	String protocolUrl = request.getContextPath() + "/coframe/auth/hs/protocolUrl.jsp";
 %> 
<style type="text/css">
html{
...
<div class="login_box">
	...
	<div class="login" id="sweepCodeBox">
		...
		<div id="qrcode" ></div>
		<div class="you" >打开华胜SaaS平台手机APP扫描二维码</div>
	</div>
</form>	
