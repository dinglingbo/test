...
<!-- 
  ...
  - Date: 2018-11-17 10:30:27
  - Description:
-->
<head>
<title>链车云修SAAS系统隐私政策</title>
...
<div class="content-panel">
	<h1>链车云修SAAS系统隐私政策</h1>
	<section>	
		<h2>引言</h2>
		<p>链车云修SAAS系统重视用户的隐私。您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。本《隐私政策》与您所使用的链车云修SAAS系统服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。
			您使用或继续使用我们的服务，即意味着同意我们按照本《隐私政策》收集、使用、储存和分享您的相关信息。
			如对本《隐私政策》或相关事宜有任何问题，请通过13260632181与我们联系。
		</p>
		<h2>我们可能收集的信息</h2>
		<p>我们提供服务时，可能会收集、储存和使用下列与您有关的信息。如果您不提供相关信息，可能无法注册成为我们的用户或无法享受我们提供的某些服务，或者无法达到相关服务拟达到的效果。</p>
		<h2>您提供的信息</h2>
		<p>•	您在注册账户或使用我们的服务时，向我们提供的相关个人信息或企业信息，例如姓名、身份证件号码、个人生物识别信息、电话号码、企业用户名称、企业用户联系人、企业用户联系方式等；</p>
		<p>•	您通过我们的服务向其他方提供的共享信息，以及您使用我们的服务时所储存的信息。</p>
		<h2>其他方式分享的您的信息</h2>
		<p>•	其他方使用我们的服务时所提供有关您的共享信息。</p>
		<h2>我们获取的您的信息</h2>
		<p>您使用服务时我们可能收集如下信息：</p>
		<p>•	日志信息，指您使用我们的服务时，系统可能通过cookies、web、app或其他方式自动采集的技术信息，包括：</p>
		...
		<p>•	客户端信息，包括但不限于您的IP地址、操作系统版本信息、登录记录、指令信息等；</p>
		<p>•	其他根据服务的需要而收集的您的信息，包括但不限于您对服务的意见、建议、您曾经使用或经常使用的服务、功能、使用场景和使用习惯等信息。</p>
		<h2>我们可能如何使用信息</h2>
		...
		<p>我们将尽一切可能采取适当的技术手段，保证您可以访问、更新和更正自己的注册信息或使用我们的服务时提供的其他个人信息。在访问、更新、更正和删除前述信息时，我们可能会要求您进行身份验证，以保障账户安全。如果您希望删除或更正您的信息，请通过相关网页所载的联系方式与我们联系。</p>
		<h2>我们可能分享的信息</h2>
		...
		<p>履行我们在《用户使用协议》或本《隐私政策》中的义务和行使我们的权利；</p>
		<p>理解、维护和改善我们的服务。</p>
		...
		<p>我们使用各种安全技术和程序，以防信息的丢失、不当使用、未经授权阅览或披露。例如，在某些服务中，我们将利用数据传输加密（例如SSL）、数据存储加密来保护您提供的个人信息。但请您理解，由于技术的限制以及可能存在的各种恶意手段，在互联网行业，即便竭尽所能加强安全措施，也不可能始终保证信息百分之百的安全。您需要了解，您接入我们的服务所用的系统和通讯网络，有可能因我们可控范围外的因素而出现问题。</p>
		<h2>您分享的敏感个人信息</h2>
		...
		<h2>我们可能如何收集信息</h2>
		<p>我们或我们的第三方合作伙伴，可能通过cookies和数据统计工具收集和使用您的信息，并将该等信息储存为日志信息。</p>
		<p>我们使用自己的cookies和数据统计工具，目的是为您提供更个性化的用户体验和服务，并用于以下用途:</p>
		<p>•	记住您的身份。例如：cookies和数据统计工具有助于我们辨认您作为我们的注册用户的身份，或保存您向我们提供的有关您的喜好或其他信息；</p>
		<p>•	分析您使用我们服务的情况。例如，我们可利用cookies和数据统计工具来了解您使用我们的服务进行什么活动，或哪些网页或服务最受您的欢迎；</p>
		<p>•	广告优化。Cookies和数据统计工具有助于我们根据您的信息，向您提供与您相关的广告而非进行普遍的广告投放。</p>
		<p>我们为上述目的使用cookies和数据统计工具的同时，可能将通过cookies和数据统计工具收集的非个人身份信息，经统计加工后提供给广告商或其他合作伙伴，用于分析用户如何使用我们的服务，并用于广告服务。</p>
		<p>我们的产品和服务上可能会有广告商或其他合作方放置的cookies和数据统计工具。这些cookies和数据统计工具可能会收集与您相关的非个人身份信息，以用于分析用户如何使用该等服务、向您发送您可能感兴趣的广告，或用于评估广告服务的效果。这些第三方cookies和数据统计工具收集和使用该等信息，不受本《隐私政策》约束，而是受相关使用者的隐私政策约束，我们不对第三方的cookies或数据统计工具承担责任。</p>
		<p>您可以通过浏览器设置拒绝或管理cookies或数据统计工具。但请注意，如果停用cookies或数据统计工具，您有可能无法享受最佳的服务体验，某些服务也可能无法正常使用。同时，您还会收到同样数量的广告，但这些广告与您的相关性会降低。</p>
		...
		<p>除本《隐私政策》另有规定外，本《隐私条款》所用词语将与《用户使用协议》所定义的词语具有相同的涵义。</p>
