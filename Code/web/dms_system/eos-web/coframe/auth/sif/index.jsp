    ...
    <%@page import="com.primeton.cap.AppUserManager"%>
        ...
        <head>
            ...
            <%@include file="/common/sysCommon.jsp" %>
                ...
                <link href="<%=request.getContextPath()%>/coframe/auth/sif/css/kefu.css" rel="stylesheet" type="text/css" />
                ...
                <link href="<%=request.getContextPath()%>/common/nui/res/third-party/scrollbar/jquery.mCustomScrollbar.css" rel="stylesheet"
                    type="text/css" />
                <link href="<%=request.getContextPath()%>/coframe/auth/sif/feedback/feedback.css" rel="stylesheet" type="text/css" />
                ...
                <script src="<%=request.getContextPath()%>/coframe/auth/sif/feedback/html2canvas.min.js" type="text/javascript"></script>
...
<!--                         <li class="dropdown">
            ...
            <script src="<%=request.getContextPath()%>/coframe/auth/sif/feedback/drawDom.js?v=1.0.1" type="text/javascript"></script>
...
/*                                 document.getElementById("skin").style.backgroundColor = "#0067b8";
            ...
            function changeOrgs(orgid) {
                if (orgid != currOrgId) {
                    $("#toggleRole")[0].action = "com.hsapi.system.auth.login.sif.flow";
...
/*                             html += '		      <li><span class="fa fa-wechat"></span>&nbsp;&nbsp;&nbsp;' + data.rs[0].wechat + '</li>'; */
 	...
 	function cancellation(){
 		window.location="<%=request.getContextPath()%>/coframe/auth/sif/logout.jsp";
 	}     
 	        var scriptList=[
