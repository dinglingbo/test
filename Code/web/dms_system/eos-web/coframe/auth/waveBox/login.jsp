...
<meta name="format-detection" content="telephone=no, address=no, email=no" />
 ...
 <%
   ...
   String loginUrl = "org.gocom.components.coframe.auth.login.waveBox.flow";
   String sweepCodeFlow = "com.hsapi.system.auth.login.qrWaveBox.flow";
   loginUrl = "com.hsapi.system.auth.login.waveBox.flow";
   ...
   if(isOpenSecurity){
   		...
   		if(!isAllInHttps){
   			url = "https://" + ip + ":" + https_port + contextPath + "/coframe/auth/waveBox/" + loginUrl;
	     		...
	     		Integer resultCode = (Integer)result;
	     		 if(resultCode == 0){
			     	...
			     	out.println("showError('密码已过期！')");
	      			...
	      			out.println("showError("+resultCode+")");
	     		 }
	     	}else{
