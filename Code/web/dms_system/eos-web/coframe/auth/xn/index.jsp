    ...
    <%@page import="com.primeton.cap.AppUserManager"%>
        ...
        <head>
            ...
            <%@include file="/common/sysCommon.jsp" %>
                <title>晓鸟SaaS平台</title>

                <script src="<%= request.getContextPath() %>/common/nui/nui.js" type="text/javascript"></script>
                <script src="<%=request.getContextPath()%>/common/nui/boot.js" type="text/javascript"></script>
                <link href="<%=request.getContextPath()%>/coframe/auth/hs/css/kefu.css" rel="stylesheet" type="text/css" />
                ...
                <link href="<%=request.getContextPath()%>/common/nui/res/third-party/scrollbar/jquery.mCustomScrollbar.css" rel="stylesheet"
                    type="text/css" />
                <link href="<%=request.getContextPath()%>/coframe/auth/hs/feedback/feedback.css" rel="stylesheet" type="text/css" />
                ...
                <script src="<%=request.getContextPath()%>/coframe/auth/hs/feedback/html2canvas.min.js" type="text/javascript"></script>
...
<%--                  <div id="tu" style="overflow-y:auto;overflow-x:auto; width:800px; height:50px;background-color: #055594;">
            ...
            <div class="container">
                <div class="navbar" id="skin" style="margin-left: -80px;    background-color: #0067b8;">
                    <div class="navbar-brand" id="systemName">晓鸟SaaS平台</div>
...
<!--                         <li class="dropdown">
            ...
            <script src="<%=request.getContextPath()%>/coframe/auth/hs/feedback/drawDom.js?v=1.0.1" type="text/javascript"></script>
