						...
						<div style="border:1px solid #dddddd;width:100%;height:100%;valign:top" >
						    ...
						    <table class="EOS_table" width="100%">
								...
								<tr>
									...
									<b:write property="procList/updateTime" formatPattern="yyyy-MM-dd HH:mm:ss"/>
									<td><input style="width:260px" type="text" disabled="disabled" name="updateTime" value="<b:write property="procList/updateTime" formatPattern="yyyy-MM-dd HH:mm:ss"/>"/></td>
								</tr>
								<tr>
