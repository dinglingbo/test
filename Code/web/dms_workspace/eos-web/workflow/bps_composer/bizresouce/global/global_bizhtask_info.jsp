...
<body>
<form name="dataform1" action="com.primeton.bps.web.composer.bizresouce.GlobalBizHTaskMgr.flow" target="_self" method="post">
	...
	<h:hidden property="bizviewobj/catalogUUID" value="0" />
...
<table border="0" cellpadding="0" cellspacing="0" class="workarea" width="100%">
	<tr>
		...
		<l:empty property="bizviewobj/humantaskUUID"><h3><b:message key="global_bizhtask_info_jsp.add_manual_task"/></h3></l:empty><!-- 新增人工任务 -->
		<l:notEmpty property="bizviewobj/humantaskUUID"><h3><b:message key="global_bizhtask_info_jsp.edit_manual_task"/></h3></l:notEmpty><!-- 修改人工任务 -->
    	</td>
  	</tr>
  	<tr> 
    	<td width="100%">
			...
			<tr>
				...
				<td><h:text property="bizviewobj/humantaskName" style="width:50%" onblur="checkInput(this)" validateAttr="allowNull=false;maxLength=20;type=bpscommname"/></td>
			</tr>
			<tr>
				...
				<td>
					<l:equal property="productInfo/productName" targetValue="Primeton Platform" scope="session">
						<h:select name="bizviewobj/humantaskType" style="width:50%" property="bizviewobj/humantaskType" onchange="changeTaskType(this)">
			...
			<tr>
				...
				<td>
					<h:text property="bizviewobj/humantaskImpl" style="width:50%" onblur="checkInput(this)" validateAttr="maxLength=128;" value="<%=defaultForm%>"/><!-- <默认表单> -->
			...
			<tr>
				...
				<td><h:textarea property="bizviewobj/mark" style="width:50%" rows="5" validateAttr="maxLength=170" onblur="checkInput(this)"/></td>
			</tr>
