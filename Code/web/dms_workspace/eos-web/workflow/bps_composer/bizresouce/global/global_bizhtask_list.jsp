...
-->
<head>
<title><b:message key="global_bizhtask_list_jsp.manual_task_mgr"/></title><!-- 全局人工任务管理 -->
</head>
<body>
  <h:form name="viewlist1" action="com.primeton.bps.web.composer.bizresouce.GlobalBizHTaskMgr.flow" method="post">
...
<table border="0" cellpadding="0" cellspacing="0" class="workarea" width="100%">
  ...
  <script>
    ...
    function delRecord() {
	  ...
	  argument[0]='<b:message key="global_bizhtask_list_jsp.confirm_del_tip1"/>'+nameStr+']('+i+'<b:message key="global_bizhtask_list_jsp.confirm_del_tip3"/>';//确定要删除人工任务吗？
    ...
    function showReference() {
      ...
      var strUrl = "com.primeton.bps.web.composer.bizresouce.GlobalBizHTaskMgr.flow?_eosFlowAction=showReference&resUUID="+params[0];
