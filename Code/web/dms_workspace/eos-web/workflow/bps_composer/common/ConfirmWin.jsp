				...
				<tr>
					<td align="center"> 
					 ...
					 <div style="margin-top:10px; margin-left:5px;">
					 	<button id="btnOK" name="btnOK" class="button" id="submit" onclick="closeConfirm('Y')"><b:message key="confirm_win_jsp.btn_ok"/></button>&nbsp;&nbsp;
						<button id="btnCancel" name="btnCancel" class="button" id="cancel" onclick="closeConfirm('N');"><b:message key="confirm_win_jsp.btn_cancel"/></button>
					 </div>
					</td>
				</tr>
		 </table>
