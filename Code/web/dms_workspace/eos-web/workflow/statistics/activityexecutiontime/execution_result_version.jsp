				...
				<l:iterate id="item" property="resultList">
					<tr id="itemRow" name="itemRow" class="EOS_table_row">
						<td nowrap="nowrap">
						  ...
						  <a href="#" onclick="return doQuery('queryByMonth',{activityID:'<b:write iterateId="item" property="activityID" />',activityName:'<b:write iterateId="item" property="activityName" />'});"><b:write iterateId="item" property="activityName" maxLength="40" /></a>
						</td>
						<td nowrap="nowrap">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
			<tr>
				...
				<td align="right" nowrap="nowrap">
					<b:set name="action" value="com.primeton.bps.web.statistics.queryActivityExecutionTime.flow?_eosFlowAction=queryByVersion" />
