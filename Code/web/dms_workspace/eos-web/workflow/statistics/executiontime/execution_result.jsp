...
<table class="workarea" width="100%">
	<tr>
		<td class="EOS_panel_head" valign="middle"><span id="path" style="float:right"></span><b:message key="executiontime_result_jsp.tbHeader1"/></td><!-- 实例执行时效统计分析 -->
	</tr>
	<tr>
			...
			<l:present property="resultList">
				<l:iterate id="item" property="resultList">
					<tr id="itemRow" name="itemRow" class="EOS_table_row">
						<td nowrap="nowrap">
						  <span title='<b:write iterateId="item" property="cataName" />'>
						  <l:equal iterateId="item" property="isLeaf" targetValue="false">
						    <a href="#" onclick="return doQuery('query',{cataID:'<b:write iterateId="item" property="cataID" />', cataName:'<b:write iterateId="item" property="cataName" />'});"><b:write iterateId="item" property="cataName" maxLength="50" /></a>
						  </l:equal>
						  <l:equal iterateId="item" property="isLeaf" targetValue="true">
						    <a href="#" onclick="return doQuery('queryByProcess',{cataID:'<b:write iterateId="item" property="cataID" />', cataName:'<b:write iterateId="item" property="cataName" />'});"><b:write iterateId="item" property="cataName" maxLength="50" /></a>
						  </l:equal>
						</td>
						<td nowrap="nowrap">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
			<tr>
				...
				<td align="right" nowrap="nowrap">
					<b:set name="action" value="com.primeton.bps.web.statistics.queryExecutionTime.flow?_eosFlowAction=query" />
...
<table class="workarea" width="100%">
	<tr>
		<td class="EOS_panel_head" valign="middle"><b:message key="executiontime_result_jsp.chartHeader1"/></td><!-- 实例执行时效统计分析图表 -->
	</tr>
	<tr>
		<td width="100%">
			<div id="chart"></div>
