...
<html>
<head>
<title>实例执行时效统计</title>
<script language="javascript">
	var action='com.primeton.bps.web.statistics.queryExecutionTime.flow';
...
<body onLoad="initiFrame()" topmargin="3" bottommargin="0" rightmargin="5" leftmargin="5" style="background:#EAF0F1;overflow: auto;">
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr height="80px;">
      <td valign="top">
		<h:form name="queryForm" action="com.primeton.bps.web.statistics.queryExecutionTime.flow" method="post" target="queryResult">
          ...
          <tr>
            <td>
              ...
              <table width="100%" class="form_table">
                <tr>
                  <td width="15%" class="form_label"><b:message key="executiontime_query_jsp.catalogName"/></td><!-- 业务目录 -->
                  <td width="35%" >
