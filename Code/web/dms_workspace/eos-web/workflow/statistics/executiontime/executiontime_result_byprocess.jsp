...
<table class="workarea" width="100%">
	<tr>
		<td class="EOS_panel_head" valign="middle"><span id="path" style="float:right"></span>
		   <b:message key="executiontime_result_jsp.tbHeader2"/></td><!-- 流程实效按月趋势分析 -->
	</tr>
	<tr>
		...
		<table border="0" class="EOS_table" width="100%">
			<%-- 条件 --%>
			<tr>
				<th colspan="5" width="20%" nowrap="nowrap"><b:write property="caption" /></th>
			</tr>
			<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
			<tr>
				...
				<td align="right" nowrap="nowrap">
					<b:set name="action" value="com.primeton.bps.web.statistics.queryExecutionTime.flow?_eosFlowAction=queryByProcess" />
...
<table class="workarea" width="100%">
	<tr>
		<td class="EOS_panel_head" valign="middle"><b:message key="executiontime_result_jsp.chartHeader2"/></td>
	</tr>
	<tr>
		<td width="100%">
						<div id="chart"></div>
