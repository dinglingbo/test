...
<table class="workarea" width="100%">
	<tr>
		<td class="EOS_panel_head" valign="middle"><span id="path" style="float:right"></span><b:message key="process_result_jsp.tbHeader1"/></td><%-- 实例规模统计结果 --%>
	</tr>
	<tr>
		...
		<table border="0" class="EOS_table" width="100%">
			<%-- 条件 --%>
			<tr>
				<th colspan="6" width="20%" nowrap="nowrap"><b:write property="caption" /></th>
			</tr>
			
			<tr>
			    <th width="40%" id="processN" nowrap="nowrap"><b:message key="process_result_jsp.processDisplayName"/></th><!-- 流程显示名称 -->
				...
				<l:iterate id="item" property="resultList">
					<tr id="itemRow" name="itemRow" class="EOS_table_row">
					    <td>
					       ...
					       <l:equal iterateId="item" property="isProcess" targetValue="Y">
						     <a href="#" onclick="return doQuery('queryProcessByID',{catalogID:'<b:write iterateId="item" property="processID"/>',catalogName:'<b:write iterateId="item" property="processName"/>'});"><b:write iterateId="item" property="processName" maxLength="40" /></a>
						   </l:equal>
						   <l:notEqual iterateId="item" property="isProcess" targetValue="Y">
						     <a href="#" onclick="return doQuery('query',{catalogID:'<b:write iterateId="item" property="processID" />',catalogName:'<b:write iterateId="item" property="processName" />'});"><b:write iterateId="item" property="processName" maxLength="40" /></a>
						   </l:notEqual>
					    </td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
			<tr>
				<td align="right" nowrap="nowrap">
					<b:set name="action" value="com.primeton.bps.web.statistics.queryProcessInstance.flow?_eosFlowAction=query" />
...
<table class="workarea" width="100%">
	<tr>
		<td class="EOS_panel_head" valign="middle"><b:message key="process_result_jsp.chart1Header"/></td><%-- 实例规模统计图表 --%>
	</tr>
	<tr>
		<td width="100%" valign="top">
			<div id="chart"></div>
