...
<table class="workarea" width="100%">
	<tr>
		<td class="EOS_panel_head" valign="middle"><b:message key="pullback_frame_jsp.tbHeader1"/><span id="path" style="float:right;"></td>
	</tr>
	<tr>
				...
				<l:iterate id="item" property="resultList">
					<tr id="itemRow" name="itemRow" class="EOS_table_row">
						<td nowrap="nowrap">
						  ...
						  <b:write iterateId="item" property="activityName" maxLength="30" />
						</td>
