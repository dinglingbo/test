...
<script language="javascript">
	var action='com.primeton.bps.web.statistics.queryPullBack.flow';
...
<body onLoad="initiFrame()" topmargin="3" bottommargin="0" rightmargin="5" leftmargin="5" style="background:#EAF0F1;overflow: auto;">
  <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
    <tr height="80px">
      <td valign="top">
		<h:form name="queryForm" action="com.primeton.bps.web.statistics.queryPullBack.flow" method="post" target="queryResult">
		
        <table class="workarea" width="100%">
          <tr>
            <td class="EOS_panel_head" valign="middle"><b:message key="common_words.queryCondition"/></td><%-- 查询条件 --%>
          </tr>
          <tr>
            <td>
              <%-- 分页条件 --%>
              ...
              <table width="100%" class="form_table">
                <tr>
                  <td width="15%" class="form_label"><b:message key="pullback_frame_jsp.processName"/></td>
                  <td width="35%" >
						<input type="text" class="textbox" id="processName" name="processName" size="32" readonly="true" value='<b:write property="processName"/>'/>&nbsp;					
