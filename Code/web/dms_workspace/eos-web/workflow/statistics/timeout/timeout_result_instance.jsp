...
<table class="workarea" width="100%">
	<tr>
		<td class="EOS_panel_head" valign="middle"><span id="path" style="float:right"></span>
		  <b:message key="timeout_result_jsp.tbHeader2"/></td> <!-- 超时实例的详细信息 -->
	</tr>
	<tr>
		...
		<table border="0" class="EOS_table" width="100%">
			<%-- 条件 --%>
			<tr>
			    <th nowrap="nowrap" colspan="5"><b:write property="caption" /></th>
			</tr>
			<tr>
			    <th width="26%" nowrap="nowrap" rowspan="1"><b:message key="timeout_result_jsp.processDefineName"/></th><!-- 流程定义名称 -->
				<th colspan="1" nowrap="nowrap"><b:message key="timeout_result_jsp.processInstanceName"/></th><!-- 流程实例名称 -->
				<th colspan="1" nowrap="nowrap"><b:message key="timeout_result_jsp.creator"/></th><!-- 发起人 -->
				<th colspan="1" nowrap="nowrap"><b:message key="timeout_result_jsp.createTime"/></th><!-- 发起时间 -->
				<th colspan="1" nowrap="nowrap"><b:message key="timeout_result_jsp.timeout"/></th><!-- 超时时长(分钟) -->
			</tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
			<tr>
				...
				<td align="right" nowrap="nowrap">
					<b:set name="action" value="com.primeton.bps.web.statistics.queryTimeout.flow?_eosFlowAction=queryOuttimeInstance" />
