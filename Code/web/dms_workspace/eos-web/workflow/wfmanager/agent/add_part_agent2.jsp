        ...
        <tr>
          <td>
            <table border="0" class="EOS_panel_body" width="100%">
              <tr>
                <td class="EOS_panel_head"><b:message key="add_part_agent2_jsp.agent_relation"/></td><%-- 代理关系 --%>
              </tr>
              <tr>
                <td width="100%">
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="form_table">
                            <tr>
                              <td  nowrap class="EOS_table_row">
                                <b:message key="mod_full_agent_jsp.client"/>
                              </td><%-- 委托人: --%>
                              <td  nowrap>
                              ...
                              <td nowrap class="EOS_table_row">
                                 <b:message key="mod_full_agent_jsp.efficient_time"/>
                              </td><%-- 生效时间: --%>
                              <td nowrap>
                                 <b:write  property="StartTime" formatPattern="yyyy-MM-dd HH:mm:ss"/>
                            ...
                            <tr>
                              <td class="EOS_table_row">
                                 <b:message key="mod_full_agent_jsp.agent"/>
                              </td><%-- 代理人: --%>
                              <td>
                              ...
                              <td class="EOS_table_row">
                                  <b:message key="mod_full_agent_jsp.end_time"/>
                              </td><%-- 终止时间: --%>
                              <td>
                                  <b:write  property="EndTime" formatPattern="yyyy-MM-dd HH:mm:ss"/>
                                  <input type="hidden" name="EndTime" value='<b:write  property="EndTime" formatPattern="yyyy-MM-dd HH:mm:ss"/>'>
                              </td>
                            </tr>
							<tr>
							  <td class="EOS_table_row">
							      <b:message key="mod_full_agent_jsp.agent_style"/>
							  </td><%-- 代理方式: --%>
                              <td>
                                  <b:message key="add_part_agent1_jsp.part_agent"/>
                              </td><%-- 部分代理 --%>
							...
							<tr>
							  <td class="EOS_table_row" nowrap="nowrap">
							      <b:message key="mod_full_agent_jsp.agent_reason"/>
							  </td><%-- 代理原因: --%>
						    ...
						    <tr class="EOS_table_row" onmouseover="this.className='EOS_table_selectRow'" onmouseout="this.className='EOS_table_row'">
		                          ...
		                          <td>
			                          	<l:equal iterateId="list" property="itemType" targetValue="PROCESS">
			                             	<d:select  name="AccessType" dictTypeId="WFDICT_ProOperateType"/>
			                          	</l:equal>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
                    <tr>
                      <td class="form_bottom">
					       ...
					       <input type="button" id="submitBtn" name="Button2" value="<b:message key="mod_full_agent_jsp.submit"/>" class="button" onClick="doCreatPartAgent();"><%-- 提交 --%>
...
<!-- 
    function doPartAgentBack(){
	    document.forms['partform2'].action ='com.primeton.workflow.manager.agent.addPartAgent.flow';
	    document.forms['partform2']._eosFlowAction.value = "action6";
	    document.forms['partform2'].submit();
	}
	
    function doCreatPartAgent(){
