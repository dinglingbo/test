                                              ...
                                              <l:iterate id="workitem" property="exeWIList">
                                                <tr class="EOS_table_row">
                                                    <td><b:write property="workItemName" iterateId="workitem"/></td>
                      								...
                      								<td><b:write property="createTime" iterateId="workitem" formatPattern="yyyy-MM-dd HH:mm:ss" srcFormatPattern="yyyy-MM-dd HH:mm:ss.S"/></td>
                                            ...
                                            <% int flag5 = 0; %>
                                              <l:iterate id="processDef" property="defList">
                                                <tr class="EOS_table_row">
                      								...
                      								<td><b:write property="createTime" iterateId="processDef" formatPattern="yyyy-MM-dd HH:mm:ss" srcFormatPattern="yyyyMMddHHmmss"/></td>
                    							</tr>
                                          	<% flag5++; %>
                                          	<% 	flag++;  %>
                                              </l:iterate>
