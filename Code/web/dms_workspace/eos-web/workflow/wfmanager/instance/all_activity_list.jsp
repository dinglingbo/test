			   ...
			   <td width="100%"  height="440"  valign="top">
				...
				<l:iterate id="list" property="activityInstList">
					...
					<%--	<td><d:write iterateId="list" dictTypeId="WFDICT_YN" property="isTimeOut"/>						
						...
						<td  nowrap="nowrap"><b:write iterateId="list" property="startTime" formatPattern="yyyy-MM-dd HH:mm:ss" srcFormatPattern="yyyyMMddHHmmss"/></td>
						<td  nowrap="nowrap"><b:write iterateId="list" property="endTime" formatPattern="yyyy-MM-dd HH:mm:ss" srcFormatPattern="yyyyMMddHHmmss"/></td>
					</tr>
						<%flag++;  %>
				</l:iterate>
