    ...
    <td width="100%" >
    	<table width="100%" border="0"  class="EOS_table">
	        ...
	        <tr>
	          ...
	          <td nowrap="nowrap"><b:write property="processInst/createTime"  formatPattern="yyyy-MM-dd HH:mm:ss" srcFormatPattern="yyyyMMddHHmmss"/></td>
	          <td class="EOS_table_row" nowrap="nowrap"><b:message key="processinst_detail_jsp.start_time"/></td><%-- 启动时间 --%>
	          <td nowrap="nowrap"><b:write property="processInst/startTime"  formatPattern="yyyy-MM-dd HH:mm:ss" srcFormatPattern="yyyyMMddHHmmss"/></td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	          ...
	          <td nowrap="nowrap" colspan="3"><b:write property="processInst/endTime"  formatPattern="yyyy-MM-dd HH:mm:ss" srcFormatPattern="yyyyMMddHHmmss"/></td>
	        </tr>
	      </table>
    </td>
  </tr>  
