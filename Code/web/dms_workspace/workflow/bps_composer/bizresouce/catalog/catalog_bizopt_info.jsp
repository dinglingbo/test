...
<form name="dataform1" action="com.primeton.bps.web.composer.bizresouce.CatalogBizOptMgr.flow" target="_self" method="post" >
	<input type="hidden" name="_eosFlowAction" value="save" />
	<h:hidden property="bizoptviewobj/busioptUUID" />
	<h:hidden property="permType" />
	<h:hidden name="bizoptviewobj/catalogUUID" property="queryViewObject/catalogUUID"/>
...
<table border="0" cellpadding="0" cellspacing="0" class="workarea" width="100%">
	<tr>
		<td class="workarea_title" valign="middle"  colspan="2">
  	...
  	<tr> 
    	<td width="100%">
			...
			<tr>
				...
				<td>
					<h:text property="bizoptviewobj/busioptName" size="70" onblur="checkInput(this)" validateAttr="allowNull=false;maxLength=20;type=bpscommname"/>
				</td>
			</tr>
			<tr>
				...
				<td>
					<l:equal property="productInfo/productName" targetValue="Primeton Platform" scope="session">
						<h:select name="bizoptviewobj/busioptType" style="width:380" property="bizoptviewobj/busioptType">
							<h:option label="<%=pojo%>" value="pojo"/><!-- Java方法 -->
							<h:option label="<%=service%>" value="service-component"/><!-- 服务 -->
							<h:option label="<%=logicFlow%>" value="logic-flow"/><!-- 逻辑流 -->
							<h:option label="<%=bizlet%>" value="bizlet"/><!-- 运算逻辑 -->
						</h:select>
					</l:equal>
			...
			<tr>
				...
				<td><h:text property="bizoptviewobj/busioptImpl" size="70" onblur="checkInput(this)" validateAttr="maxLength=128;type=bpscommimpl" value="<%=nullStr%>"/>
				</td>
			</tr>
			<tr> 
	...
	<tr> 
    	<td style="padding:7px">
    			<r:datacell width="600" height="190" id="datacell"  pageSize="100"
	            ...
	            <r:field fieldName="typeClass" label="<%=dataType%>" width="80" defaultValue="primitive" sortAt="none"><!-- 数据类型 -->
	            	<h:select validateAttr="allowNull=false;">
						<h:option label="<%=simpleType%>" value="primitive"/><!-- 简单 -->
					</h:select>
	            </r:field>
	            <r:field fieldName="typeValue" label="<%=paraType%>" width="100" sortAt="none" defaultValue="java.lang.String" ><!-- 参数类型 -->
	            	<h:select validateAttr="allowNull=false;">
	            ...
	            <r:field fieldName="description" label="<%=desc%>" width="180" defaultValue="" sortAt="none">
	...
	<tr> 
    	<td width="100%">
			...
			<tr>
				...
				<td><h:textarea property="bizoptviewobj/mark" style="width:390" rows="5" validateAttr="maxLength=170" onblur="checkInput(this)"/></td>
			</tr>
			<tr>
