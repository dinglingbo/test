...
-->
<head>
<title><b:message key="bizresource_pickup_jsp.biz_res_ext"/></title><!-- 提取业务资源 -->
<% 
...
<script>
	...
	function save(){
		hiddenResponseMessage($id("ResponseMessage"));
      	var myAjax= new Ajax("com.primeton.bps.web.composer.bizresource.bizrescommoperation.pickupResource.biz");
	...
	function showDetail(uuid,type){
		$id("tab").src="com.primeton.bps.web.composer.bizresouce.BizResCommOpertion.flow?_eosFlowAction=pickup_detail&resUUID="+uuid+"&resType="+type;
	}
</script>
</head>
<body>
...
<table border="0" cellpadding="0" cellspacing="0" class="workarea" width="100%">
	<tr>
		<td class="workarea_title" valign="middle"><h3><b:message key="bizresource_pickup_jsp.biz_res_ext"/></h3></td><!-- 提取业务资源 -->
	</tr>
  <tr valign="top"> 
	<td width="100%" height="265px">
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			<tr height="100%">
				<td width="30%">
					...
					<w:checkGroup id="group1">
		            	...
		            	<tr class="<l:output evenOutput='EOS_table_row' />">
		              		...
		              		<td>
		              			<a href="javascript:showDetail('<b:write iterateId="id1" property="id"/>','<b:write property="resType"/>')"><b:write iterateId="id1" property="name"/></a>
		              		</td>
		            	</tr>
		          		</l:iterate>
		          	</w:checkGroup>
				...
				<td>
					<div style="border:1px solid #dddddd;width:100%;height:100%" >
				   		<iframe id="tab" style="width:100%;height:100%" frameBorder="0" scrolling="no" src="com.primeton.bps.web.composer.bizresouce.BizResCommOpertion.flow?_eosFlowAction=pickup_detail&resUUID=<b:write property='resList[1]/id'/>&resType=<b:write property='resType'/>"></iframe>
					</div>
				</td>
			</tr>
		</table>
