...
<table class="workarea" width="100%">
	<tr>
		<td class="EOS_panel_head" valign="middle"><span id="path" style="float:right"></span><b:message key="activityexecutiontime_result_jsp.tbHeader2"/></td><!-- 活动执行时效按月趋势分析 -->
	</tr>
	<tr>
		<td width="100%" valign="top">
		<form name="resultForm" action="" method="post">
             <h:hidden property="activityID"/>
             <h:hidden property="activityName"/>
		...
		<table border="0" class="EOS_table" width="100%">
			...
			<tr>
				<th width="20%" nowrap="nowrap" rowspan="2"><b:message key="executiontime_result_jsp.month"/></th><!-- 月份 -->
				<th width="80%" nowrap="nowrap" colspan="3"><b:message key="executiontime_result_jsp.time"/></th><!-- 时间 -->
			</tr>
			<tr>
				<th width="30%" nowrap="nowrap"><b:message key="executiontime_result_jsp.avgTime"/></th><!-- 平均执行时间 -->
				<th width="30%" nowrap="nowrap"><b:message key="executiontime_result_jsp.minTime"/></th><!-- 最短执行时间 -->
				<th width="30%" nowrap="nowrap"><b:message key="executiontime_result_jsp.maxTime"/></th><!-- 最长执行时间 -->

			</tr>
			<l:present property="resultList">
				<l:iterate id="item" property="resultList">
					<tr id="itemRow" name="itemRow" class="EOS_table_row">
						<td nowrap="nowrap"><b:write iterateId="item" property="activityName" /></td>
						<td nowrap="nowrap">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
			<tr>
				...
				<td align="right" nowrap="nowrap">
					<b:set name="action" value="com.primeton.bps.web.statistics.queryActivityExecutionTime.flow?_eosFlowAction=queryByMonth" />
...
<table class="workarea" width="100%">
	<tr>
		<td class="EOS_panel_head" valign="middle"><b:message key="activityexecutiontime_result_jsp.chartHeader2"/></td>
	</tr>
	<tr>
		<td width="100%">
			<div id="chart"></div>
