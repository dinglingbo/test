...
<table class="workarea" width="100%">
	<tr>
		<td class="EOS_panel_head" valign="middle"><span id="path" style="float:right"></span><b:message key="workload_result_jsp.workload_statistics_by_month"/></td><%-- 工作量按月统计 --%>
	</tr>
	<tr>
		...
		<table border="0" class="EOS_table" width="100%">
			...
			<tr>
				<th width="30%" nowrap="nowrap"><b:message key="workload_result_jsp.month"/></th><%-- 月份 --%>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" height="30">
			<tr>
				...
				<td align="right" nowrap="nowrap">
					<b:set name="action" value="com.primeton.bps.web.statistics.queryWorkload.flow?_eosFlowAction=queryByMonth" />
