...
public class AESCrypt {
	...
	public AESCrypt(String keyString) throws NoSuchAlgorithmException,
			UnsupportedEncodingException, NoSuchPaddingException, NoSuchProviderException {
		super();
		...
		//AES算法 填充方式PKCS7Padding(java只提供PKCS5Padding) 所需BouncyCastle组件jar包(local_polic.jar,US_export_policy.jar),必须放在$JAVA_HOME\jre\lib\ext目录下(/data/vplatform/vapp/jdk/jre/lib/security)。
		//jar包对应jdk版本下载
