...
import com.chedao.websocket.webserver.sys.service.FilesInfoService;
...
import com.chedao.websocket.webserver.util.Pager;
...
public class ImController extends BaseController {
	...
	public Object userMessageCount(HttpServletResponse response, HttpServletRequest request,
		...
		List<MessageInfoEntity> list = userMessageServiceImpl.getOfflineMessageList(map);
